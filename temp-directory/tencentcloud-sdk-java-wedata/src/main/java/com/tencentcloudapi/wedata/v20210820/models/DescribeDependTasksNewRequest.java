...
public class DescribeDependTasksNewRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDependTasksNewRequest() {
    }
     ...
     */
    public DescribeDependTasksNewRequest(DescribeDependTasksNewRequest source) {
