...
public class DescribeCatalogSignComponentsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setSignComponents(CatalogComponents [] SignComponents) {
     ...
     */
    public DescribeCatalogSignComponentsResponse(DescribeCatalogSignComponentsResponse source) {
        if (source.SignComponents != null) {
            this.SignComponents = new CatalogComponents[source.SignComponents.length];
            for (int i = 0; i < source.SignComponents.length; i++) {
                this.SignComponents[i] = new CatalogComponents(source.SignComponents[i]);
            }
        }
