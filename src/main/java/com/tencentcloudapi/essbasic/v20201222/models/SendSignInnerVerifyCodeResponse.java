...
public class SendSignInnerVerifyCodeResponse extends AbstractModel{
    ...
    */
    ...
    public SendSignInnerVerifyCodeResponse() {
    }
     ...
     */
    public SendSignInnerVerifyCodeResponse(SendSignInnerVerifyCodeResponse source) {
