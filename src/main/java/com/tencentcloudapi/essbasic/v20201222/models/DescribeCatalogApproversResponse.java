...
public class DescribeCatalogApproversResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setApprovers(CatalogApprovers [] Approvers) {
     ...
     */
    public DescribeCatalogApproversResponse(DescribeCatalogApproversResponse source) {
        if (source.Approvers != null) {
            this.Approvers = new CatalogApprovers[source.Approvers.length];
            for (int i = 0; i < source.Approvers.length; i++) {
                this.Approvers[i] = new CatalogApprovers(source.Approvers[i]);
            }
        }
