...
public class CheckBankCardVerificationRequest extends AbstractModel{
    ...
    */
    ...
    public CheckBankCardVerificationRequest() {
    }
     ...
     */
    public CheckBankCardVerificationRequest(CheckBankCardVerificationRequest source) {
