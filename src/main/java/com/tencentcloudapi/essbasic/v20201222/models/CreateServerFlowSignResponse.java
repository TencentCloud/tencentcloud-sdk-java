...
public class CreateServerFlowSignResponse extends AbstractModel{
...
1：成功
    ...
    public CreateServerFlowSignResponse() {
    }
     ...
     */
    public CreateServerFlowSignResponse(CreateServerFlowSignResponse source) {
