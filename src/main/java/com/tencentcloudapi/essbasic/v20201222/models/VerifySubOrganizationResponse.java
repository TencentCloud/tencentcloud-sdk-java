...
public class VerifySubOrganizationResponse extends AbstractModel{
    ...
    */
    ...
    public VerifySubOrganizationResponse() {
    }
     ...
     */
    public VerifySubOrganizationResponse(VerifySubOrganizationResponse source) {
