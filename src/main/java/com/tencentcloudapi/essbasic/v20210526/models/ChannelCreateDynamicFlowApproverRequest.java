...
public class ChannelCreateDynamicFlowApproverRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>动态合同信息</p> 
     * @return FillDynamicFlowList <p>动态合同信息</p>
     */
     ...
     */
    public void setFillDynamicFlowList(DynamicFlowInfo [] FillDynamicFlowList) {
        this.FillDynamicFlowList = FillDynamicFlowList;
    }
     ...
     */
    public ChannelCreateDynamicFlowApproverRequest(ChannelCreateDynamicFlowApproverRequest source) {
        if (source.FillDynamicFlowList != null) {
            this.FillDynamicFlowList = new DynamicFlowInfo[source.FillDynamicFlowList.length];
            for (int i = 0; i < source.FillDynamicFlowList.length; i++) {
                this.FillDynamicFlowList[i] = new DynamicFlowInfo(source.FillDynamicFlowList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "FillDynamicFlowList.", this.FillDynamicFlowList);
