...
public class ModifyPartnerAutoSignAuthUrlResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyPartnerAutoSignAuthUrlResponse() {
    }
     ...
     */
    public ModifyPartnerAutoSignAuthUrlResponse(ModifyPartnerAutoSignAuthUrlResponse source) {
        if (source.Url != null) {
