...
public class DescribeFileConvertTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>转换任务Id，通过接口<a href="https://qian.tencent.com/developers/partnerApis/files/CreateFileConvertTask" target="_blank">创建文件转换任务接口</a>得到的转换任务id</p> 
     * @return TaskId <p>转换任务Id，通过接口<a href="https://qian.tencent.com/developers/partnerApis/files/CreateFileConvertTask" target="_blank">创建文件转换任务接口</a>得到的转换任务id</p>
     */
    ...
    /**
     * Set <p>转换任务Id，通过接口<a href="https://qian.tencent.com/developers/partnerApis/files/CreateFileConvertTask" target="_blank">创建文件转换任务接口</a>得到的转换任务id</p>
    ...
    public DescribeFileConvertTaskRequest() {
    }
     ...
     */
    public DescribeFileConvertTaskRequest(DescribeFileConvertTaskRequest source) {
