...
值为unix时间戳,单位为秒。
    ...
    */
    ...
    /**
     * Get 续期成功后自动签许可到期时间。当且仅当已通过许可开通自动签时有值。
...
值为unix时间戳,单位为秒。
    ...
    /**
     * Set 续期成功后自动签许可到期时间。当且仅当已通过许可开通自动签时有值。
...
值为unix时间戳,单位为秒。
     ...
     */
    public ChannelRenewAutoSignLicenseResponse(ChannelRenewAutoSignLicenseResponse source) {
