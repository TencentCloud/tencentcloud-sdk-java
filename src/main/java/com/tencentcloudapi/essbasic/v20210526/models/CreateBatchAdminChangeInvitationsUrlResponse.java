...
public class CreateBatchAdminChangeInvitationsUrlResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>链接过期时间，为 7 天后，创建时间，格式为Unix标准时间戳（秒）。</p><p>单位：格式为Unix标准时间戳（秒）</p> 
    ...
    /**
     * Set <p>链接过期时间，为 7 天后，创建时间，格式为Unix标准时间戳（秒）。</p><p>单位：格式为Unix标准时间戳（秒）</p>
    ...
    public CreateBatchAdminChangeInvitationsUrlResponse() {
    }
     ...
     */
    public CreateBatchAdminChangeInvitationsUrlResponse(CreateBatchAdminChangeInvitationsUrlResponse source) {
        if (source.Url != null) {
