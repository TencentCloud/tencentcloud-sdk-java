...
public class DescribeDomainTagsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeDomainTagsResponse() {
    }
     ...
     */
    public DescribeDomainTagsResponse(DescribeDomainTagsResponse source) {
        if (source.Data != null) {
