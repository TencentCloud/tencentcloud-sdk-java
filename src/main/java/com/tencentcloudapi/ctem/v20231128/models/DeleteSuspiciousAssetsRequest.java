...
public class DeleteSuspiciousAssetsRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteSuspiciousAssetsRequest() {
    }
     ...
     */
    public DeleteSuspiciousAssetsRequest(DeleteSuspiciousAssetsRequest source) {
        if (source.Ids != null) {
