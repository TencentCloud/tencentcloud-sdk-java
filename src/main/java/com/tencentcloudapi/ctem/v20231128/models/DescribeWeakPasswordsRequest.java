...
public class DescribeWeakPasswordsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeWeakPasswordsRequest() {
    }
     ...
     */
    public DescribeWeakPasswordsRequest(DescribeWeakPasswordsRequest source) {
