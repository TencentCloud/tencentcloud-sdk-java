...
public class DescribeSuspiciousAssetsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSuspiciousAssetsRequest() {
    }
     ...
     */
    public DescribeSuspiciousAssetsRequest(DescribeSuspiciousAssetsRequest source) {
