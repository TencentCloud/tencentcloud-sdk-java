...
public class DescribeLeakageEmailsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeLeakageEmailsRequest() {
    }
     ...
     */
    public DescribeLeakageEmailsRequest(DescribeLeakageEmailsRequest source) {
