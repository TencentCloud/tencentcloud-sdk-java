...
public class DescribeSensitiveInfosRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSensitiveInfosRequest() {
    }
     ...
     */
    public DescribeSensitiveInfosRequest(DescribeSensitiveInfosRequest source) {
