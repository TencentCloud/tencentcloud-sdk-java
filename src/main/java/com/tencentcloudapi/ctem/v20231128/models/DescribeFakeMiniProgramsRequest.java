...
public class DescribeFakeMiniProgramsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeFakeMiniProgramsRequest() {
    }
     ...
     */
    public DescribeFakeMiniProgramsRequest(DescribeFakeMiniProgramsRequest source) {
