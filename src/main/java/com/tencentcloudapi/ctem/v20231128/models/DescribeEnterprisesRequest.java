...
public class DescribeEnterprisesRequest extends AbstractModel {
    ...
    * 是否展示统计数据
    */
    @SerializedName("IsShowStatistics")
    @Expose
     ...
     */
    public void setIsShowStatistics(Boolean IsShowStatistics) {
        this.IsShowStatistics = IsShowStatistics;
    }

    public DescribeEnterprisesRequest() {
    }
     ...
     */
    public DescribeEnterprisesRequest(DescribeEnterprisesRequest source) {
        ...
        if (source.IsShowStatistics != null) {
            this.IsShowStatistics = new Boolean(source.IsShowStatistics);
        }
    }
