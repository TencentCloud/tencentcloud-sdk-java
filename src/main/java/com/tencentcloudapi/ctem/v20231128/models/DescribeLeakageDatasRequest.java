...
public class DescribeLeakageDatasRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeLeakageDatasRequest() {
    }
     ...
     */
    public DescribeLeakageDatasRequest(DescribeLeakageDatasRequest source) {
