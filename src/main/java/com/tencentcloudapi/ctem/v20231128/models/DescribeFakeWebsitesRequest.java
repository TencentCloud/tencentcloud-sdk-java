...
public class DescribeFakeWebsitesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeFakeWebsitesRequest() {
    }
     ...
     */
    public DescribeFakeWebsitesRequest(DescribeFakeWebsitesRequest source) {
