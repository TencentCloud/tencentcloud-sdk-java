...
public class DescribeHttpsRequest extends AbstractModel {
    ...
    */
     ...
     */
    public void setIsShowChange(Boolean IsShowChange) {
     ...
     */
    public Boolean getHasExpirationRisk() {
        return this.HasExpirationRisk;
    }
     ...
     */
    public void setHasExpirationRisk(Boolean HasExpirationRisk) {
    ...
    public DescribeHttpsRequest(DescribeHttpsRequest source) {
        ...
        if (source.IsShowChange != null) {
            this.IsShowChange = new Boolean(source.IsShowChange);
        }
