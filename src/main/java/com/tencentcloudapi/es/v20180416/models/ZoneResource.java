...
public class ZoneResource extends AbstractModel {
    ...
    */
    ...
    @Expose
    private NodeTypeResource [] NodeTypeList;
    ...
    */
     ...
     */
    public NodeTypeResource [] getNodeTypeList() {
     ...
     */
    public void setNodeTypeList(NodeTypeResource [] NodeTypeList) {
    ...
    public ZoneResource(ZoneResource source) {
        ...
        if (source.NodeTypeList != null) {
            this.NodeTypeList = new NodeTypeResource[source.NodeTypeList.length];
            for (int i = 0; i < source.NodeTypeList.length; i++) {
                this.NodeTypeList[i] = new NodeTypeResource(source.NodeTypeList[i]);
            }
        }
