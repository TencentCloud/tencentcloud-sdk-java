...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setIndexMetaFields(ServerlessIndexMetaField [] IndexMetaFields) {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeServerlessInstancesResponse(DescribeServerlessInstancesResponse source) {
        if (source.IndexMetaFields != null) {
            this.IndexMetaFields = new ServerlessIndexMetaField[source.IndexMetaFields.length];
            for (int i = 0; i < source.IndexMetaFields.length; i++) {
                this.IndexMetaFields[i] = new ServerlessIndexMetaField(source.IndexMetaFields[i]);
            }
        }
