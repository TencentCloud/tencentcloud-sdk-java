...
public class DescribeUserCosSnapshotListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeUserCosSnapshotListResponse(DescribeUserCosSnapshotListResponse source) {
        if (source.CosSnapshotInfoList != null) {
            this.CosSnapshotInfoList = new CosSnapShotInfo[source.CosSnapshotInfoList.length];
            for (int i = 0; i < source.CosSnapshotInfoList.length; i++) {
                this.CosSnapshotInfoList[i] = new CosSnapShotInfo(source.CosSnapshotInfoList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "CosSnapshotInfoList.", this.CosSnapshotInfoList);
