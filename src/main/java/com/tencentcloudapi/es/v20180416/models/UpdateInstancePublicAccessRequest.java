...
public class UpdateInstancePublicAccessRequest extends AbstractModel {
...
专用主节点磁盘大小（单位GB系统默认配置为50GB,暂不支持自定义）
    ...
    public UpdateInstancePublicAccessRequest() {
    }
     ...
     */
    public UpdateInstancePublicAccessRequest(UpdateInstancePublicAccessRequest source) {
        ...
        if (source.KibanaAlteringPublicAccess != null) {
            this.KibanaAlteringPublicAccess = new String[source.KibanaAlteringPublicAccess.length];
            for (int i = 0; i < source.KibanaAlteringPublicAccess.length; i++) {
                this.KibanaAlteringPublicAccess[i] = new String(source.KibanaAlteringPublicAccess[i]);
            }
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArraySimple(map, prefix + "KibanaAlteringPublicAccess.", this.KibanaAlteringPublicAccess);
