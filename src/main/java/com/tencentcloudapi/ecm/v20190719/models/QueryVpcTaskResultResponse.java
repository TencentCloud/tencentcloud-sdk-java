...
public class QueryVpcTaskResultResponse extends AbstractModel{
    ...
    */
    ...
    public QueryVpcTaskResultResponse() {
    }
     ...
     */
    public QueryVpcTaskResultResponse(QueryVpcTaskResultResponse source) {
