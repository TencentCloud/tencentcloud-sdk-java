...
public class AssociateSecurityGroupsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 要绑定的安全组ID，类似esg-efil73jd，只支持绑定单个安全组。 
    ...
    /**
     * Set 要绑定的安全组ID，类似esg-efil73jd，只支持绑定单个安全组。
    ...
    /**
     * Get 被绑定的实例ID，类似ein-lesecurk，支持指定多个实例，每次请求批量实例的上限为100。 
    ...
    /**
     * Set 被绑定的实例ID，类似ein-lesecurk，支持指定多个实例，每次请求批量实例的上限为100。
