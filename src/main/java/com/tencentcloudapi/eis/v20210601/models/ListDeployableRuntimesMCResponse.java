...
public class ListDeployableRuntimesMCResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setRuntimes(AbstractRuntimeMC [] Runtimes) {
     ...
     */
    public ListDeployableRuntimesMCResponse(ListDeployableRuntimesMCResponse source) {
        if (source.Runtimes != null) {
            this.Runtimes = new AbstractRuntimeMC[source.Runtimes.length];
            for (int i = 0; i < source.Runtimes.length; i++) {
                this.Runtimes[i] = new AbstractRuntimeMC(source.Runtimes[i]);
            }
        }
