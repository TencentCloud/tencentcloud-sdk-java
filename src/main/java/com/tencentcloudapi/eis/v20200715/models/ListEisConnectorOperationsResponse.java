...
public class ListEisConnectorOperationsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setOperations(EisConnectionOperation [] Operations) {
     ...
     */
    public ListEisConnectorOperationsResponse(ListEisConnectorOperationsResponse source) {
        if (source.Operations != null) {
            this.Operations = new EisConnectionOperation[source.Operations.length];
            for (int i = 0; i < source.Operations.length; i++) {
                this.Operations[i] = new EisConnectionOperation(source.Operations[i]);
            }
        }
