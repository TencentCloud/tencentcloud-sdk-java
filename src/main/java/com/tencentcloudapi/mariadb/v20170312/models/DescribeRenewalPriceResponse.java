...
public class DescribeRenewalPriceResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeRenewalPriceResponse() {
    }
     ...
     */
    public DescribeRenewalPriceResponse(DescribeRenewalPriceResponse source) {
