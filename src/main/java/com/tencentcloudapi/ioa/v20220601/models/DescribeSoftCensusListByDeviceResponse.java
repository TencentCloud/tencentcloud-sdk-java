...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeSoftCensusListByDeviceResponse(DescribeSoftCensusListByDeviceResponse source) {
        if (source.Data != null) {
            this.Data = new DescribeSoftCensusListByDevicePageData(source.Data);
        }
