...
public class DescribeSoftwareInformationPageData extends AbstractModel {
    ...
    */
     ...
     */
    public void setItems(SoftwareInformationData [] Items) {
        this.Items = Items;
    }
     ...
     */
    public DescribeSoftwareInformationPageData(DescribeSoftwareInformationPageData source) {
        if (source.Items != null) {
            this.Items = new SoftwareInformationData[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new SoftwareInformationData(source.Items[i]);
            }
        }
        if (source.Page != null) {
