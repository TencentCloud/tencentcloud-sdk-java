...
public class DescribeModelResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setModelSet(ModelVersionDetail [] ModelSet) {
    ...
    public DescribeModelResponse(DescribeModelResponse source) {
        if (source.ModelSet != null) {
            this.ModelSet = new ModelVersionDetail[source.ModelSet.length];
            for (int i = 0; i < source.ModelSet.length; i++) {
                this.ModelSet[i] = new ModelVersionDetail(source.ModelSet[i]);
            }
        }
