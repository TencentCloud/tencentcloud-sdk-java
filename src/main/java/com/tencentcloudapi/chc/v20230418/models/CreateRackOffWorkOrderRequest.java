...
public class CreateRackOffWorkOrderRequest extends AbstractModel {
    ...
    */
    ...
    public CreateRackOffWorkOrderRequest() {
    }
     ...
     */
    public CreateRackOffWorkOrderRequest(CreateRackOffWorkOrderRequest source) {
