...
public class DescribeIdcUnitDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeIdcUnitDetailRequest() {
    }
     ...
     */
    public DescribeIdcUnitDetailRequest(DescribeIdcUnitDetailRequest source) {
