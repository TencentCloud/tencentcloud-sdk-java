...
public class CreateServerModelResponse extends AbstractModel {
    ...
    */
    ...
    public CreateServerModelResponse() {
    }
     ...
     */
    public CreateServerModelResponse(CreateServerModelResponse source) {
