...
public class WorkflowRunDetail extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public WorkflowRunDetail(WorkflowRunDetail source) {
        ...
        if (source.DialogJson != null) {
            this.DialogJson = new String(source.DialogJson);
        }
        if (source.Query != null) {
            this.Query = new String(source.Query);
        }
        if (source.MainModelName != null) {
            this.MainModelName = new String(source.MainModelName);
        }
