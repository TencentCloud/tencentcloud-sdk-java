...
public class DeleteSharedKnowledgeResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteSharedKnowledgeResponse() {
    }
     ...
     */
    public DeleteSharedKnowledgeResponse(DeleteSharedKnowledgeResponse source) {
