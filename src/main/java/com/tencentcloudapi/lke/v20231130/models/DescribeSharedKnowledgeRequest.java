...
public class DescribeSharedKnowledgeRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSharedKnowledgeRequest() {
    }
     ...
     */
    public DescribeSharedKnowledgeRequest(DescribeSharedKnowledgeRequest source) {
