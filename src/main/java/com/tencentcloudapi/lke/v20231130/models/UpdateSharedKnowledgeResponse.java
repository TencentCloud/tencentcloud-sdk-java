...
public class UpdateSharedKnowledgeResponse extends AbstractModel {
    ...
    */
    ...
    public UpdateSharedKnowledgeResponse() {
    }
     ...
     */
    public UpdateSharedKnowledgeResponse(UpdateSharedKnowledgeResponse source) {
