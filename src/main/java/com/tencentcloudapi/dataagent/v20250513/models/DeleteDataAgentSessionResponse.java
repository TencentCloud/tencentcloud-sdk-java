...
public class DeleteDataAgentSessionResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteDataAgentSessionResponse() {
    }
     ...
     */
    public DeleteDataAgentSessionResponse(DeleteDataAgentSessionResponse source) {
