...
public class DeleteChunkRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DeleteChunkRequest(DeleteChunkRequest source) {
        ...
        if (source.ChunkIds != null) {
            this.ChunkIds = new String[source.ChunkIds.length];
            for (int i = 0; i < source.ChunkIds.length; i++) {
