...
public class GetJobsByKnowledgeBaseIdRequest extends AbstractModel {
    ...
    */
    ...
    public GetJobsByKnowledgeBaseIdRequest() {
    }
     ...
     */
    public GetJobsByKnowledgeBaseIdRequest(GetJobsByKnowledgeBaseIdRequest source) {
