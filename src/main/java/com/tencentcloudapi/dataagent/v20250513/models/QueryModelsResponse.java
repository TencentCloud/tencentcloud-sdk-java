...
public class QueryModelsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public QueryModelsResponse(QueryModelsResponse source) {
        if (source.Models != null) {
            this.Models = new ModelList[source.Models.length];
            for (int i = 0; i < source.Models.length; i++) {
                this.Models[i] = new ModelList(source.Models[i]);
            }
        }
