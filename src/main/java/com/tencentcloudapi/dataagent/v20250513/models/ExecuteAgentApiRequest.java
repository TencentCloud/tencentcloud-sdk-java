...
public class ExecuteAgentApiRequest extends AbstractModel {
    ...
    */
     ...
     */
    public ExecuteAgentApiRequest(ExecuteAgentApiRequest source) {
        if (source.RequestPath != null) {
            this.RequestPath = new String(source.RequestPath);
        }
        if (source.RequestData != null) {
            this.RequestData = new String(source.RequestData);
        }
