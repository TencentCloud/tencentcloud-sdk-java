...
public class TccCatalogConfig extends AbstractModel {
    ...
    */
     ...
     */
    public void setConnection(TccConnectionConfig Connection) {
     ...
     */
    public TccCatalogConfig(TccCatalogConfig source) {
        if (source.Id != null) {
        ...
        if (source.Connection != null) {
            this.Connection = new TccConnectionConfig(source.Connection);
        }
