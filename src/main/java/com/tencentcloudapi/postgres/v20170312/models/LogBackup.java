...
public class LogBackup extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。 
    ...
    /**
     * Set 备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
    ...
    /**
     * Get 备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。 
    ...
    /**
     * Set 备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
