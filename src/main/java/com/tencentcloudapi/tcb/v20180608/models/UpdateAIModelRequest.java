...
public class UpdateAIModelRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>模型地址</p><p>枚举值：</p><ul><li>http://default.tcb： 默认模型地址，custom模型切换为builtin模型时使用</li></ul> 
    ...
    /**
     * Set <p>模型地址</p><p>枚举值：</p><ul><li>http://default.tcb： 默认模型地址，custom模型切换为builtin模型时使用</li></ul>
    ...
    /**
     * Get <p>模型名列表</p><p>Models 列表更新采用全量替换</p> 
    ...
    /**
     * Set <p>模型名列表</p><p>Models 列表更新采用全量替换</p>
     ...
     */
    public UpdateAIModelRequest(UpdateAIModelRequest source) {
