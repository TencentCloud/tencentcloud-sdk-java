...
public class DeleteCloudAppVersionRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteCloudAppVersionRequest() {
    }
     ...
     */
    public DeleteCloudAppVersionRequest(DeleteCloudAppVersionRequest source) {
