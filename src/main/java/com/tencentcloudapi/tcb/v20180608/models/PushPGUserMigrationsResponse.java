...
public class PushPGUserMigrationsResponse extends AbstractModel {
    ...
    */
    ...
    public PushPGUserMigrationsResponse() {
    }
     ...
     */
    public PushPGUserMigrationsResponse(PushPGUserMigrationsResponse source) {
