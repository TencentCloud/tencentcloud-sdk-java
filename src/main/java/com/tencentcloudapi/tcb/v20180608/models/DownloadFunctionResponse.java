...
public class DownloadFunctionResponse extends AbstractModel {
    ...
    */
    ...
    public DownloadFunctionResponse() {
    }
     ...
     */
    public DownloadFunctionResponse(DownloadFunctionResponse source) {
