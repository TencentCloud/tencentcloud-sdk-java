...
public class TurnOffStandaloneGatewayRequest extends AbstractModel{
    ...
    */
    ...
    public TurnOffStandaloneGatewayRequest() {
    }
     ...
     */
    public TurnOffStandaloneGatewayRequest(TurnOffStandaloneGatewayRequest source) {
