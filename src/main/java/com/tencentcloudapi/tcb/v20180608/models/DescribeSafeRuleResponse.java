...
public class DescribeSafeRuleResponse extends AbstractModel {
...
<li> CUSTOM：自定义安全规则</li>
    ...
    public DescribeSafeRuleResponse() {
    }
     ...
     */
    public DescribeSafeRuleResponse(DescribeSafeRuleResponse source) {
        if (source.Rule != null) {
