...
public class ModifyHTTPServiceRouteRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyHTTPServiceRouteRequest() {
    }
     ...
     */
    public ModifyHTTPServiceRouteRequest(ModifyHTTPServiceRouteRequest source) {
