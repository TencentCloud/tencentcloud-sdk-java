...
public class VerifyHTTPServiceRouteRequest extends AbstractModel {
    ...
    */
    ...
    public VerifyHTTPServiceRouteRequest() {
    }
     ...
     */
    public VerifyHTTPServiceRouteRequest(VerifyHTTPServiceRouteRequest source) {
