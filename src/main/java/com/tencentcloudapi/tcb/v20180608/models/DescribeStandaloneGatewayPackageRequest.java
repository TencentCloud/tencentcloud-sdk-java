...
public class DescribeStandaloneGatewayPackageRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 套餐版本，包含starter、basic、advanced、enterprise 
    ...
    /**
     * Set 套餐版本，包含starter、basic、advanced、enterprise
     ...
     */
    public DescribeStandaloneGatewayPackageRequest(DescribeStandaloneGatewayPackageRequest source) {
