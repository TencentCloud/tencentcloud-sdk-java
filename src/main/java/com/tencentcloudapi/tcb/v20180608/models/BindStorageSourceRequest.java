...
public class BindStorageSourceRequest extends AbstractModel {
    ...
    */
    ...
    public BindStorageSourceRequest() {
    }
     ...
     */
    public BindStorageSourceRequest(BindStorageSourceRequest source) {
