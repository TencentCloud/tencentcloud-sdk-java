...
public class SimpleCondition extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>匹配方式: eq 等于;ne 不等于;regex 正则;</p>
注意：此字段可能返回 null，表示取不到有效值。 
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set <p>匹配方式: eq 等于;ne 不等于;regex 正则;</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public SimpleCondition(SimpleCondition source) {
        if (source.Key != null) {
