...
public class DeleteParamTemplateRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 参数模板 ID。请登录 [Redis 控制台的参数模板](https://console.cloud.tencent.com/redis/templates)页面获取模板 ID。 
    ...
    /**
     * Set 参数模板 ID。请登录 [Redis 控制台的参数模板](https://console.cloud.tencent.com/redis/templates)页面获取模板 ID。
