...
public class UploadDocRealtimeResponse extends SSEResponseModel {
    ...
    */
    ...
    public UploadDocRealtimeResponse() {
    }
     ...
     */
    public UploadDocRealtimeResponse(UploadDocRealtimeResponse source) {
