...
public class DescribeTRTCSegmentModerationUsageRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 媒体类型，枚举值：audio（音频）、picture（图片） 
    ...
    /**
     * Set 媒体类型，枚举值：audio（音频）、picture（图片）
    ...
    /**
     * Get 使用场景（业务类型），枚举值：0 = AI 内容理解（审核场景）、1 = 音视频切片（云端切片场景） 
    ...
    /**
     * Set 使用场景（业务类型），枚举值：0 = AI 内容理解（审核场景）、1 = 音视频切片（云端切片场景）
    ...
    public DescribeTRTCSegmentModerationUsageRequest() {
    }
     ...
     */
    public DescribeTRTCSegmentModerationUsageRequest(DescribeTRTCSegmentModerationUsageRequest source) {
        ...
        if (source.Business != null) {
            this.Business = new Long(source.Business);
        }
