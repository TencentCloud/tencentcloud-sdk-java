...
public class RegisterVoicePrintResponse extends AbstractModel {
    ...
    */
    ...
    public RegisterVoicePrintResponse() {
    }
     ...
     */
    public RegisterVoicePrintResponse(RegisterVoicePrintResponse source) {
