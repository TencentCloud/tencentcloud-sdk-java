...
public class DescribeCloudSliceTaskRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCloudSliceTaskRequest() {
    }
     ...
     */
    public DescribeCloudSliceTaskRequest(DescribeCloudSliceTaskRequest source) {
