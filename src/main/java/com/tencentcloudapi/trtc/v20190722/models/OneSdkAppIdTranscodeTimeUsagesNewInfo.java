...
public class OneSdkAppIdTranscodeTimeUsagesNewInfo extends AbstractModel{
    ...
    */
     ...
     */
    public void setSdkAppIdTranscodeTimeUsages(SdkAppIdTrtcMcuTranscodeTimeNewUsage [] SdkAppIdTranscodeTimeUsages) {
     ...
     */
    public OneSdkAppIdTranscodeTimeUsagesNewInfo(OneSdkAppIdTranscodeTimeUsagesNewInfo source) {
        if (source.SdkAppIdTranscodeTimeUsages != null) {
            this.SdkAppIdTranscodeTimeUsages = new SdkAppIdTrtcMcuTranscodeTimeNewUsage[source.SdkAppIdTranscodeTimeUsages.length];
            for (int i = 0; i < source.SdkAppIdTranscodeTimeUsages.length; i++) {
                this.SdkAppIdTranscodeTimeUsages[i] = new SdkAppIdTrtcMcuTranscodeTimeNewUsage(source.SdkAppIdTranscodeTimeUsages[i]);
            }
        }
