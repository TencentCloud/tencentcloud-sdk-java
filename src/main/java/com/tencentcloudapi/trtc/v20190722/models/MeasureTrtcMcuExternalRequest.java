...
public class MeasureTrtcMcuExternalRequest extends AbstractModel{
...
单次查询统计区间最多不能超过2天。
    ...
    public MeasureTrtcMcuExternalRequest() {
    }
     ...
     */
    public MeasureTrtcMcuExternalRequest(MeasureTrtcMcuExternalRequest source) {
