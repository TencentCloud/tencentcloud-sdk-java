...
public class McuLayoutParams extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。 
     * @return PureAudioHoldPlaceMode 纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。
     */
    ...
    /**
     * Set 纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。
