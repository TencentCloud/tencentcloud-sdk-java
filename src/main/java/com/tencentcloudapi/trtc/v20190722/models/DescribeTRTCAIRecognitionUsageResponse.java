...
public class DescribeTRTCAIRecognitionUsageResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTRTCAIRecognitionUsageResponse() {
    }
     ...
     */
    public DescribeTRTCAIRecognitionUsageResponse(DescribeTRTCAIRecognitionUsageResponse source) {
        ...
        if (source.TotalUsage != null) {
            this.TotalUsage = new Float[source.TotalUsage.length];
            for (int i = 0; i < source.TotalUsage.length; i++) {
                this.TotalUsage[i] = new Float(source.TotalUsage[i]);
            }
        }
