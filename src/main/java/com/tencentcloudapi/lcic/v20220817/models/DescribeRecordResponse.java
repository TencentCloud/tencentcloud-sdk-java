...
public class DescribeRecordResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setRecordInfo(CustomRecordInfo [] RecordInfo) {
    ...
    public DescribeRecordResponse(DescribeRecordResponse source) {
        ...
        if (source.RecordInfo != null) {
            this.RecordInfo = new CustomRecordInfo[source.RecordInfo.length];
            for (int i = 0; i < source.RecordInfo.length; i++) {
                this.RecordInfo[i] = new CustomRecordInfo(source.RecordInfo[i]);
            }
        }
