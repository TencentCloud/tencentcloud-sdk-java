...
public class DescribeLiveRelayConfigRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeLiveRelayConfigRequest() {
    }
     ...
     */
    public DescribeLiveRelayConfigRequest(DescribeLiveRelayConfigRequest source) {
