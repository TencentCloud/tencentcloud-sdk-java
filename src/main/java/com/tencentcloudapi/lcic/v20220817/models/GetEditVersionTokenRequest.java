...
public class GetEditVersionTokenRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>实时互动-教育版的SdkAppId。</p> 
     * @return SdkAppId <p>实时互动-教育版的SdkAppId。</p>
     */
    ...
    /**
     * Get <p>token过期时间，0代表无过期时间，单位毫秒。</p> 
     * @return ExpireSeconds <p>token过期时间，0代表无过期时间，单位毫秒。</p>
     */
    ...
    /**
     * Set <p>token过期时间，0代表无过期时间，单位毫秒。</p>
    ...
    public GetEditVersionTokenRequest() {
    }
     ...
     */
    public GetEditVersionTokenRequest(GetEditVersionTokenRequest source) {
