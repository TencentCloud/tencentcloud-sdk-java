...
public class SecurityGroupRiskPolicy extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。 
    ...
    /**
     * Set 端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。
    ...
    /**
     * Get 规则方向，Egress出站规则，Ingress入站规则 
    ...
    /**
     * Set 规则方向，Egress出站规则，Ingress入站规则
    ...
    public SecurityGroupRiskPolicy() {
    }
     ...
     */
    public SecurityGroupRiskPolicy(SecurityGroupRiskPolicy source) {
