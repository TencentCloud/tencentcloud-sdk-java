...
public class DescribeNatAclRulesResponse extends AbstractModel {
    ...
    */
     ...
     * @return Rules 规则列表
     */
    public NatAclRuleResp [] getRules() {
        return this.Rules;
    }
     ...
     * @param Rules 规则列表
     */
    public void setRules(NatAclRuleResp [] Rules) {
        this.Rules = Rules;
    }
    ...
    public DescribeNatAclRulesResponse() {
    }
     ...
     */
    public DescribeNatAclRulesResponse(DescribeNatAclRulesResponse source) {
        if (source.Rules != null) {
            this.Rules = new NatAclRuleResp[source.Rules.length];
            for (int i = 0; i < source.Rules.length; i++) {
                this.Rules[i] = new NatAclRuleResp(source.Rules[i]);
            }
        }
