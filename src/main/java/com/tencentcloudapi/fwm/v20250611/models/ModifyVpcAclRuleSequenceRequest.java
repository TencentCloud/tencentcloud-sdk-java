...
public class ModifyVpcAclRuleSequenceRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyVpcAclRuleSequenceRequest() {
    }
     ...
     */
    public ModifyVpcAclRuleSequenceRequest(ModifyVpcAclRuleSequenceRequest source) {
