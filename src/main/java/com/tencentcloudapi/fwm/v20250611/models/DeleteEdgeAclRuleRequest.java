...
public class DeleteEdgeAclRuleRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteEdgeAclRuleRequest() {
    }
     ...
     */
    public DeleteEdgeAclRuleRequest(DeleteEdgeAclRuleRequest source) {
