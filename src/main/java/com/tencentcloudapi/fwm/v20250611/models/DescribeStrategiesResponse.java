...
public class DescribeStrategiesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private StrategyResp [] Strategies;
    ...
    */
     ...
     */
    public StrategyResp [] getStrategies() {
     ...
     */
    public void setStrategies(StrategyResp [] Strategies) {
    ...
    public DescribeStrategiesResponse(DescribeStrategiesResponse source) {
        ...
        if (source.Strategies != null) {
            this.Strategies = new StrategyResp[source.Strategies.length];
            for (int i = 0; i < source.Strategies.length; i++) {
                this.Strategies[i] = new StrategyResp(source.Strategies[i]);
            }
        }
