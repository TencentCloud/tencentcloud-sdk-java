...
public class CreateEdgeAclRuleRequest extends AbstractModel {
    ...
    */
    ...
    public CreateEdgeAclRuleRequest() {
    }
     ...
     */
    public CreateEdgeAclRuleRequest(CreateEdgeAclRuleRequest source) {
