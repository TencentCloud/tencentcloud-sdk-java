...
public class DescribeSecurityGroupRulesRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeSecurityGroupRulesRequest(DescribeSecurityGroupRulesRequest source) {
