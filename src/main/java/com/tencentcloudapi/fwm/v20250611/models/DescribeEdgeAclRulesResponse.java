...
public class DescribeEdgeAclRulesResponse extends AbstractModel {
    ...
    */
     ...
     * @return Rules 规则列表
     */
    public EdgeAclRuleResp [] getRules() {
        return this.Rules;
    }
     ...
     * @param Rules 规则列表
     */
    public void setRules(EdgeAclRuleResp [] Rules) {
        this.Rules = Rules;
    }
    ...
    public DescribeEdgeAclRulesResponse() {
    }
     ...
     */
    public DescribeEdgeAclRulesResponse(DescribeEdgeAclRulesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Rules != null) {
            this.Rules = new EdgeAclRuleResp[source.Rules.length];
            for (int i = 0; i < source.Rules.length; i++) {
                this.Rules[i] = new EdgeAclRuleResp(source.Rules[i]);
            }
        }
