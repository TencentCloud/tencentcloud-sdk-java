...
public class DescribeStrategiesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeStrategiesRequest() {
    }
     ...
     */
    public DescribeStrategiesRequest(DescribeStrategiesRequest source) {
