...
public class DescribeSnapshotConfigResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeSnapshotConfigResponse() {
    }
     ...
     */
    public DescribeSnapshotConfigResponse(DescribeSnapshotConfigResponse source) {
