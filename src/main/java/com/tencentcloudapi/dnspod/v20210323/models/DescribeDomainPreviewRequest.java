...
public class DescribeDomainPreviewRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDomainPreviewRequest() {
    }
     ...
     */
    public DescribeDomainPreviewRequest(DescribeDomainPreviewRequest source) {
