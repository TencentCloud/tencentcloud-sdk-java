...
public class DescribeSnapshotListRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeSnapshotListRequest() {
    }
     ...
     */
    public DescribeSnapshotListRequest(DescribeSnapshotListRequest source) {
