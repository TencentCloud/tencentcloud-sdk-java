...
public class DescribeSnapshotConfigRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeSnapshotConfigRequest() {
    }
     ...
     */
    public DescribeSnapshotConfigRequest(DescribeSnapshotConfigRequest source) {
