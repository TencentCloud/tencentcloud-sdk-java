...
public class TriggerAIWorkbenchSREDigitalTwinTaskResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private TriggerDigitalTwinTaskResp Data;
    ...
    */
    ...
    /**
     * Get 数字分身任务信息 
     * @return Data 数字分身任务信息
     */
    public TriggerDigitalTwinTaskResp getData() {
        return this.Data;
    }
     ...
     * @param Data 数字分身任务信息
     */
    public void setData(TriggerDigitalTwinTaskResp Data) {
        this.Data = Data;
    }
    ...
    public TriggerAIWorkbenchSREDigitalTwinTaskResponse() {
    }
     ...
     */
    public TriggerAIWorkbenchSREDigitalTwinTaskResponse(TriggerAIWorkbenchSREDigitalTwinTaskResponse source) {
        ...
        if (source.Data != null) {
            this.Data = new TriggerDigitalTwinTaskResp(source.Data);
        }
