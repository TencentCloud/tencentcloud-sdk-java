...
public class DescribeExtMetricRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeExtMetricRequest() {
    }
     ...
     */
    public DescribeExtMetricRequest(DescribeExtMetricRequest source) {
