...
public class FeiShuRobotNoticeTmplMatcher extends AbstractModel {
...
Trigger 告警触发; Recovery 告警恢复
    ...
    */
    ...
    @Expose
    private FeiShuRobotNoticeTmpl Template;
...
Trigger 告警触发; Recovery 告警恢复
     ...
     */
    public FeiShuRobotNoticeTmpl getTemplate() {
     ...
     * @param Template 模板配置
     */
    public void setTemplate(FeiShuRobotNoticeTmpl Template) {
        this.Template = Template;
    }

    public FeiShuRobotNoticeTmplMatcher() {
    }
     ...
     */
    public FeiShuRobotNoticeTmplMatcher(FeiShuRobotNoticeTmplMatcher source) {
        ...
        if (source.Template != null) {
            this.Template = new FeiShuRobotNoticeTmpl(source.Template);
        }
    }
