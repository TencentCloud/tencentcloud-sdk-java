...
public class DingDingRobotNoticeTmplMatcher extends AbstractModel {
...
Trigger 告警触发; Recovery 告警恢复
    ...
    */
    ...
    @Expose
    private DingDingRobotNoticeTmpl Template;
...
Trigger 告警触发; Recovery 告警恢复
     ...
     */
    public DingDingRobotNoticeTmpl getTemplate() {
     ...
     * @param Template 模板配置
     */
    public void setTemplate(DingDingRobotNoticeTmpl Template) {
        this.Template = Template;
    }

    public DingDingRobotNoticeTmplMatcher() {
    }
     ...
     */
    public DingDingRobotNoticeTmplMatcher(DingDingRobotNoticeTmplMatcher source) {
        ...
        if (source.Template != null) {
            this.Template = new DingDingRobotNoticeTmpl(source.Template);
        }
    }
