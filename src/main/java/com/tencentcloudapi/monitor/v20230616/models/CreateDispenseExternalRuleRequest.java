...
public class CreateDispenseExternalRuleRequest extends AbstractModel {
    ...
    */
    ...
    public CreateDispenseExternalRuleRequest() {
    }
     ...
     */
    public CreateDispenseExternalRuleRequest(CreateDispenseExternalRuleRequest source) {
        if (source.Name != null) {
