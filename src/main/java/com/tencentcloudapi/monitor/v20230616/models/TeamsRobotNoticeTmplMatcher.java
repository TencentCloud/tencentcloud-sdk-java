...
public class TeamsRobotNoticeTmplMatcher extends AbstractModel {
...
Trigger 告警触发; Recovery 告警恢复
    ...
    */
    ...
    @Expose
    private TeamsRobotNoticeTmpl Template;
...
Trigger 告警触发; Recovery 告警恢复
     ...
     */
    public TeamsRobotNoticeTmpl getTemplate() {
     ...
     * @param Template 模板配置
     */
    public void setTemplate(TeamsRobotNoticeTmpl Template) {
        this.Template = Template;
    }

    public TeamsRobotNoticeTmplMatcher() {
    }
     ...
     */
    public TeamsRobotNoticeTmplMatcher(TeamsRobotNoticeTmplMatcher source) {
        ...
        if (source.Template != null) {
            this.Template = new TeamsRobotNoticeTmpl(source.Template);
        }
    }
