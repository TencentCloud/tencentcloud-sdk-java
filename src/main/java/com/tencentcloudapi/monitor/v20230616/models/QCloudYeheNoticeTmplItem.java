...
public class QCloudYeheNoticeTmplItem extends AbstractModel {
    ...
    */
    ...
    public QCloudYeheNoticeTmplItem() {
    }
     ...
     */
    public QCloudYeheNoticeTmplItem(QCloudYeheNoticeTmplItem source) {
