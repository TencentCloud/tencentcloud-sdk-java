...
public class GoogleChatRobotNoticeTmplMatcher extends AbstractModel {
...
Trigger 告警触发; Recovery 告警恢复
    ...
    */
    ...
    @Expose
    private GoogleChatRobotNoticeTmpl Template;
...
Trigger 告警触发; Recovery 告警恢复
     ...
     */
    public GoogleChatRobotNoticeTmpl getTemplate() {
     ...
     * @param Template 模板配置
     */
    public void setTemplate(GoogleChatRobotNoticeTmpl Template) {
        this.Template = Template;
    }

    public GoogleChatRobotNoticeTmplMatcher() {
    }
     ...
     */
    public GoogleChatRobotNoticeTmplMatcher(GoogleChatRobotNoticeTmplMatcher source) {
        ...
        if (source.Template != null) {
            this.Template = new GoogleChatRobotNoticeTmpl(source.Template);
        }
    }
