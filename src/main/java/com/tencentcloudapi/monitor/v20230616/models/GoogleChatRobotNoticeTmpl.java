...
public class GoogleChatRobotNoticeTmpl extends AbstractModel {
    ...
    */
    ...
    public GoogleChatRobotNoticeTmpl() {
    }
     ...
     */
    public GoogleChatRobotNoticeTmpl(GoogleChatRobotNoticeTmpl source) {
