...
public class QCloudYeheNoticeTmplMatcher extends AbstractModel {
...
Trigger 告警触发; Recovery 告警恢复
    ...
    */
    ...
    @Expose
    private QCloudYeheNoticeTmpl Template;
...
Trigger 告警触发; Recovery 告警恢复
     ...
     */
    public QCloudYeheNoticeTmpl getTemplate() {
     ...
     * @param Template 模板配置
     */
    public void setTemplate(QCloudYeheNoticeTmpl Template) {
        this.Template = Template;
    }

    public QCloudYeheNoticeTmplMatcher() {
    }
     ...
     */
    public QCloudYeheNoticeTmplMatcher(QCloudYeheNoticeTmplMatcher source) {
        ...
        if (source.Template != null) {
            this.Template = new QCloudYeheNoticeTmpl(source.Template);
        }
    }
