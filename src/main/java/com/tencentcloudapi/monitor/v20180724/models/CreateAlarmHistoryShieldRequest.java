...
public class CreateAlarmHistoryShieldRequest extends AbstractModel {
    ...
    */
    ...
    public CreateAlarmHistoryShieldRequest() {
    }
     ...
     */
    public CreateAlarmHistoryShieldRequest(CreateAlarmHistoryShieldRequest source) {
