...
public class DescribeGrafanaEnvironmentsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Grafana 实例 ID，例如：Grafana 实例 ID，例如：grafana-abcdefghGrafana 实例 ID，例如：grafana-abcdefgh 
    ...
    /**
     * Set Grafana 实例 ID，例如：Grafana 实例 ID，例如：grafana-abcdefghGrafana 实例 ID，例如：grafana-abcdefgh
