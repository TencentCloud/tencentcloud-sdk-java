...
public class UpdateServiceDiscoveryResponse extends AbstractModel{
    ...
    */
    ...
    public UpdateServiceDiscoveryResponse() {
    }
     ...
     */
    public UpdateServiceDiscoveryResponse(UpdateServiceDiscoveryResponse source) {
