...
修改全局告警通知渠道
     ...
     * @return ModifyPrometheusInstanceAccessPointsResponse
     * @throws TencentCloudSDKException
     */
    public ModifyPrometheusInstanceAccessPointsResponse ModifyPrometheusInstanceAccessPoints(ModifyPrometheusInstanceAccessPointsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyPrometheusInstanceAccessPoints", ModifyPrometheusInstanceAccessPointsResponse.class);
    }
