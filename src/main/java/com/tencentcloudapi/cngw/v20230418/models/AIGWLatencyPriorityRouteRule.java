...
public class AIGWLatencyPriorityRouteRule extends AbstractModel {
    ...
    */
    ...
    public AIGWLatencyPriorityRouteRule() {
    }
     ...
     */
    public AIGWLatencyPriorityRouteRule(AIGWLatencyPriorityRouteRule source) {
