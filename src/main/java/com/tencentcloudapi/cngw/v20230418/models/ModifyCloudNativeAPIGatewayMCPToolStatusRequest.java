...
public class ModifyCloudNativeAPIGatewayMCPToolStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>mcp tool 状态</p><p>枚举值：</p><ul><li>Enable： 启用</li><li>Disable： 禁用</li></ul> 
    ...
    /**
     * Set <p>mcp tool 状态</p><p>枚举值：</p><ul><li>Enable： 启用</li><li>Disable： 禁用</li></ul>
    ...
    public ModifyCloudNativeAPIGatewayMCPToolStatusRequest() {
    }
     ...
     */
    public ModifyCloudNativeAPIGatewayMCPToolStatusRequest(ModifyCloudNativeAPIGatewayMCPToolStatusRequest source) {
