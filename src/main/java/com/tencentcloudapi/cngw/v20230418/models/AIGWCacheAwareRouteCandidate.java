...
public class AIGWCacheAwareRouteCandidate extends AbstractModel {
    ...
    */
    ...
    public AIGWCacheAwareRouteCandidate() {
    }
     ...
     */
    public AIGWCacheAwareRouteCandidate(AIGWCacheAwareRouteCandidate source) {
