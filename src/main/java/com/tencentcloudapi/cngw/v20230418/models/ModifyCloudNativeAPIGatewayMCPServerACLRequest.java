...
public class ModifyCloudNativeAPIGatewayMCPServerACLRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>ACL类型</p><p>枚举值：</p><ul><li>None： 不开启</li><li>Allow： 白名单</li><li>Deny： 黑名单</li></ul><p>默认值：None</p> 
    ...
    /**
     * Set <p>ACL类型</p><p>枚举值：</p><ul><li>None： 不开启</li><li>Allow： 白名单</li><li>Deny： 黑名单</li></ul><p>默认值：None</p>
    ...
    public ModifyCloudNativeAPIGatewayMCPServerACLRequest() {
    }
     ...
     */
    public ModifyCloudNativeAPIGatewayMCPServerACLRequest(ModifyCloudNativeAPIGatewayMCPServerACLRequest source) {
