...
public class SetParameters extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>自定义变量名称。自定义变量必须先被定义才可进行运算。</p> 
    ...
    /**
     * Set <p>自定义变量名称。自定义变量必须先被定义才可进行运算。</p>
    ...
    /**
     * Get <p>自定义变量赋值。支持使用常量字符串、变量以及公式，不支持中文。长度不能超过 1000 个字符。</p> 
    ...
    /**
     * Set <p>自定义变量赋值。支持使用常量字符串、变量以及公式，不支持中文。长度不能超过 1000 个字符。</p>
     ...
     */
    public SetParameters(SetParameters source) {
        if (source.Name != null) {
