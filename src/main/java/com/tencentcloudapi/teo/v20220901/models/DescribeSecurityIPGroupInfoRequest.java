...
public class DescribeSecurityIPGroupInfoRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 单次返回的最大条目数。默认值为 20 ，最大查询条目为 1000 。 
    ...
    /**
     * Set 单次返回的最大条目数。默认值为 20 ，最大查询条目为 1000 。
