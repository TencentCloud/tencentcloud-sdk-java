...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    @SerializedName("CustomActionParameters")
    @Expose
    private CustomActionParameters CustomActionParameters;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p> 
     * @return CustomActionParameters <p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
     */
    public CustomActionParameters getCustomActionParameters() {
        return this.CustomActionParameters;
    }

    /**
     * Set <p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
     ...
     */
    public void setCustomActionParameters(CustomActionParameters CustomActionParameters) {
    ...
    public RuleEngineAction(RuleEngineAction source) {
        ...
        if (source.CustomActionParameters != null) {
            this.CustomActionParameters = new CustomActionParameters(source.CustomActionParameters);
        }
    }
