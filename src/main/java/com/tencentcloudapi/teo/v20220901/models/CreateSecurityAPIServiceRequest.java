...
public class CreateSecurityAPIServiceRequest extends AbstractModel {
    ...
    */
    ...
    public CreateSecurityAPIServiceRequest() {
    }
     ...
     */
    public CreateSecurityAPIServiceRequest(CreateSecurityAPIServiceRequest source) {
