...
public class DescribeTopicStatsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p> 
    ...
    /**
     * Set <p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
    ...
    public DescribeTopicStatsRequest() {
    }
     ...
     */
    public DescribeTopicStatsRequest(DescribeTopicStatsRequest source) {
