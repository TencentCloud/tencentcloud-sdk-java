...
public class VerifyMessageConsumptionRequest extends AbstractModel {
    ...
    */
    ...
    public VerifyMessageConsumptionRequest() {
    }
     ...
     */
    public VerifyMessageConsumptionRequest(VerifyMessageConsumptionRequest source) {
