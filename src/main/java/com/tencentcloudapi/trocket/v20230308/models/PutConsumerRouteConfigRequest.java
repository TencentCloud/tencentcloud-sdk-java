...
public class PutConsumerRouteConfigRequest extends AbstractModel {
    ...
    */
    ...
    public PutConsumerRouteConfigRequest() {
    }
     ...
     */
    public PutConsumerRouteConfigRequest(PutConsumerRouteConfigRequest source) {
