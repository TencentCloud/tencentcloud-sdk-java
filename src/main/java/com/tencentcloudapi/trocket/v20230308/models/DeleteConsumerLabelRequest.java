...
public class DeleteConsumerLabelRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteConsumerLabelRequest() {
    }
     ...
     */
    public DeleteConsumerLabelRequest(DeleteConsumerLabelRequest source) {
