...
public class CreateConsumerLabelRequest extends AbstractModel {
    ...
    */
    ...
    public CreateConsumerLabelRequest() {
    }
     ...
     */
    public CreateConsumerLabelRequest(CreateConsumerLabelRequest source) {
