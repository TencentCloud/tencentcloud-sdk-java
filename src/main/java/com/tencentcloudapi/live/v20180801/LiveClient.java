...
注意：如果在推流前设置延播，需要提前5分钟设置，目前该接口只支持流粒度。
     ...
     * @return CloseSourceStreamResponse
     * @throws TencentCloudSDKException
     */
    public CloseSourceStreamResponse CloseSourceStream(CloseSourceStreamRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CloseSourceStream", CloseSourceStreamResponse.class);
    }
...
5. 避免 创建录制任务 与 推流 操作同时进行，可能导致因录制任务未生效而引起任务延迟启动问题，两者操作间隔建议大于3秒。
     ...
     * @return CreateSceneVideoTaskResponse
     * @throws TencentCloudSDKException
     */
    public CreateSceneVideoTaskResponse CreateSceneVideoTask(CreateSceneVideoTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateSceneVideoTask", CreateSceneVideoTaskResponse.class);
    }
...
日志数据打包存在一定延迟，24小时候数据包趋于完整。
     ...
     * @return DescribeOriginStreamInfoResponse
     * @throws TencentCloudSDKException
     */
    public DescribeOriginStreamInfoResponse DescribeOriginStreamInfo(DescribeOriginStreamInfoRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeOriginStreamInfo", DescribeOriginStreamInfoResponse.class);
    }
...
2. 不能查询被 DeleteRecordTask 接口删除以及已过期（平台侧保留3个月）的录制任务。
     ...
     * @return DescribeSceneVideoTaskResponse
     * @throws TencentCloudSDKException
     */
    public DescribeSceneVideoTaskResponse DescribeSceneVideoTask(DescribeSceneVideoTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeSceneVideoTask", DescribeSceneVideoTaskResponse.class);
    }
...
1. 不支持修改拉流源类型，如需更换，请创建新任务。
     ...
     * @return ModifyOriginStreamInfoResponse
     * @throws TencentCloudSDKException
     */
    public ModifyOriginStreamInfoResponse ModifyOriginStreamInfo(ModifyOriginStreamInfoRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyOriginStreamInfo", ModifyOriginStreamInfoResponse.class);
    }
