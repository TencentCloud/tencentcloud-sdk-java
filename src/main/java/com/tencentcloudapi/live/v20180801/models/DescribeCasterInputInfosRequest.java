...
public class DescribeCasterInputInfosRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCasterInputInfosRequest() {
    }
     ...
     */
    public DescribeCasterInputInfosRequest(DescribeCasterInputInfosRequest source) {
