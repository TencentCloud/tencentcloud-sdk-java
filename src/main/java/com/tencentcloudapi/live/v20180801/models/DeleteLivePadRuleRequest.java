...
public class DeleteLivePadRuleRequest extends AbstractModel{
...
域名+AppName+StreamName唯一标识单个转码规则，如需删除需要强匹配，例如AppName为空也需要传空字符串进行强匹配。
    ...
    public DeleteLivePadRuleRequest() {
    }
     ...
     */
    public DeleteLivePadRuleRequest(DeleteLivePadRuleRequest source) {
