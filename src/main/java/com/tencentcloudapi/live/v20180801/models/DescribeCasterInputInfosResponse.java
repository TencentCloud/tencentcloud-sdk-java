...
public class DescribeCasterInputInfosResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setInputInfos(CasterInputInfo [] InputInfos) {
     ...
     */
    public DescribeCasterInputInfosResponse(DescribeCasterInputInfosResponse source) {
        if (source.InputInfos != null) {
            this.InputInfos = new CasterInputInfo[source.InputInfos.length];
            for (int i = 0; i < source.InputInfos.length; i++) {
                this.InputInfos[i] = new CasterInputInfo(source.InputInfos[i]);
            }
        }
