...
public class DescribeLiveAvatarRoomsResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private AvatarRoomInfo [] InfoList;
    ...
    */
     ...
     */
    public AvatarRoomInfo [] getInfoList() {
     ...
     */
    public void setInfoList(AvatarRoomInfo [] InfoList) {
    ...
    public DescribeLiveAvatarRoomsResponse() {
    }
     ...
     */
    public DescribeLiveAvatarRoomsResponse(DescribeLiveAvatarRoomsResponse source) {
        if (source.InfoList != null) {
            this.InfoList = new AvatarRoomInfo[source.InfoList.length];
            for (int i = 0; i < source.InfoList.length; i++) {
                this.InfoList[i] = new AvatarRoomInfo(source.InfoList[i]);
            }
        }
