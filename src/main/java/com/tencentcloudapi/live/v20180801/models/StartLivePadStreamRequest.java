...
public class StartLivePadStreamRequest extends AbstractModel {
    ...
    */
    ...
    public StartLivePadStreamRequest() {
    }
     ...
     */
    public StartLivePadStreamRequest(StartLivePadStreamRequest source) {
