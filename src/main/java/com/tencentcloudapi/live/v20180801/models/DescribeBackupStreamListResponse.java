...
public class DescribeBackupStreamListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private BackupStreamGroupInfo [] StreamInfoList;
    ...
    */
    ...
    public DescribeBackupStreamListResponse() {
    }
     ...
     */
    public DescribeBackupStreamListResponse(DescribeBackupStreamListResponse source) {
        if (source.StreamInfoList != null) {
            this.StreamInfoList = new BackupStreamGroupInfo[source.StreamInfoList.length];
            for (int i = 0; i < source.StreamInfoList.length; i++) {
                this.StreamInfoList[i] = new BackupStreamGroupInfo(source.StreamInfoList[i]);
            }
        }
