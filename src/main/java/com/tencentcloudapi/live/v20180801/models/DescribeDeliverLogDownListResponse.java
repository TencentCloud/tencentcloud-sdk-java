...
public class DescribeDeliverLogDownListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeDeliverLogDownListResponse() {
    }
     ...
     */
    public DescribeDeliverLogDownListResponse(DescribeDeliverLogDownListResponse source) {
        if (source.LogInfoList != null) {
            this.LogInfoList = new PushLogInfo[source.LogInfoList.length];
            for (int i = 0; i < source.LogInfoList.length; i++) {
                this.LogInfoList[i] = new PushLogInfo(source.LogInfoList[i]);
            }
        }
