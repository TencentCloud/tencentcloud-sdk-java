...
public class DescribeScreenshotTaskRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeScreenshotTaskRequest() {
    }
     ...
     */
    public DescribeScreenshotTaskRequest(DescribeScreenshotTaskRequest source) {
