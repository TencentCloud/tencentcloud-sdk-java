...
public class StopLivePadProcessorRequest extends AbstractModel {
    ...
    */
    ...
    public StopLivePadProcessorRequest() {
    }
     ...
     */
    public StopLivePadProcessorRequest(StopLivePadProcessorRequest source) {
