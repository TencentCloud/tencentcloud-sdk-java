...
public class DescribeLivePadTemplatesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setTemplates(PadTemplate [] Templates) {
     ...
     */
    public DescribeLivePadTemplatesResponse(DescribeLivePadTemplatesResponse source) {
        if (source.Templates != null) {
            this.Templates = new PadTemplate[source.Templates.length];
            for (int i = 0; i < source.Templates.length; i++) {
                this.Templates[i] = new PadTemplate(source.Templates[i]);
            }
        }
