...
public class ModifyCasterOutputInfoRequest extends AbstractModel {
    ...
    */
     ...
     */
    public void setOutputInfo(CasterOutputInfo OutputInfo) {
        this.OutputInfo = OutputInfo;
    }

    public ModifyCasterOutputInfoRequest() {
    }
     ...
     */
    public ModifyCasterOutputInfoRequest(ModifyCasterOutputInfoRequest source) {
        if (source.CasterId != null) {
            this.CasterId = new Long(source.CasterId);
        }
        if (source.OutputInfo != null) {
            this.OutputInfo = new CasterOutputInfo(source.OutputInfo);
        }
    }
