...
public class DeleteCasterMarkPicInfoRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteCasterMarkPicInfoRequest() {
    }
     ...
     */
    public DeleteCasterMarkPicInfoRequest(DeleteCasterMarkPicInfoRequest source) {
