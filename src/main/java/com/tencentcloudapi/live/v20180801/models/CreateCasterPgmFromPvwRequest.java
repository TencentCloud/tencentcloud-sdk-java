...
public class CreateCasterPgmFromPvwRequest extends AbstractModel {
    ...
    */
    ...
    public CreateCasterPgmFromPvwRequest() {
    }
     ...
     */
    public CreateCasterPgmFromPvwRequest(CreateCasterPgmFromPvwRequest source) {
