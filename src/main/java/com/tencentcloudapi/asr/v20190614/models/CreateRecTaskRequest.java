...
注意：此功能结果仅供参考
    ...
    /**
     * Get 回调 URL：用户自行搭建的用于接收识别结果的服务URL。回调格式和内容详见：[录音识别回调说明](https://cloud.tencent.com/document/product/1093/52632)
如果用户使用轮询方式获取识别结果，则无需提交该参数。 
...
如果用户使用轮询方式获取识别结果，则无需提交该参数。
    ...
    /**
     * Set 回调 URL：用户自行搭建的用于接收识别结果的服务URL。回调格式和内容详见：[录音识别回调说明](https://cloud.tencent.com/document/product/1093/52632)
如果用户使用轮询方式获取识别结果，则无需提交该参数。
