...
public class DescribePublicDirectConnectTunnelRoutesResponse extends AbstractModel{
    ...
    */
    ...
    public DescribePublicDirectConnectTunnelRoutesResponse() {
    }
     ...
     */
    public DescribePublicDirectConnectTunnelRoutesResponse(DescribePublicDirectConnectTunnelRoutesResponse source) {
        if (source.Routes != null) {
            this.Routes = new DirectConnectTunnelRoute[source.Routes.length];
            for (int i = 0; i < source.Routes.length; i++) {
                this.Routes[i] = new DirectConnectTunnelRoute(source.Routes[i]);
            }
        }
