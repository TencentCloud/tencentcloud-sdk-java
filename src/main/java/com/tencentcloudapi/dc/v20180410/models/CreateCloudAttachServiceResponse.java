...
public class CreateCloudAttachServiceResponse extends AbstractModel {
    ...
    */
     ...
     */
    public CreateCloudAttachServiceResponse(CreateCloudAttachServiceResponse source) {
        if (source.CloudAttach != null) {
            this.CloudAttach = new CloudAttachInfo(source.CloudAttach);
        }
