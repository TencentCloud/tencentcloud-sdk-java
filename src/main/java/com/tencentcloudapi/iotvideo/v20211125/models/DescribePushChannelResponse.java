...
public class DescribePushChannelResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribePushChannelResponse() {
    }
     ...
     */
    public DescribePushChannelResponse(DescribePushChannelResponse source) {
        if (source.Type != null) {
