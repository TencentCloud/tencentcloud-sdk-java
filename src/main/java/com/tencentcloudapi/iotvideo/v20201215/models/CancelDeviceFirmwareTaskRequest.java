...
public class CancelDeviceFirmwareTaskRequest extends AbstractModel{
    ...
    */
    ...
    public CancelDeviceFirmwareTaskRequest() {
    }
     ...
     */
    public CancelDeviceFirmwareTaskRequest(CancelDeviceFirmwareTaskRequest source) {
