...
public class DescribeBalanceTransactionsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setTransactions(BalanceTransaction [] Transactions) {
     ...
     */
    public DescribeBalanceTransactionsResponse(DescribeBalanceTransactionsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Transactions != null) {
            this.Transactions = new BalanceTransaction[source.Transactions.length];
            for (int i = 0; i < source.Transactions.length; i++) {
                this.Transactions[i] = new BalanceTransaction(source.Transactions[i]);
            }
        }
