...
public class ImportModelDefinitionRequest extends AbstractModel{
    ...
    */
    ...
    public ImportModelDefinitionRequest() {
    }
     ...
     */
    public ImportModelDefinitionRequest(ImportModelDefinitionRequest source) {
