...
public class ClearDeviceActiveCodeRequest extends AbstractModel{
    ...
    */
    ...
    public ClearDeviceActiveCodeRequest() {
    }
     ...
     */
    public ClearDeviceActiveCodeRequest(ClearDeviceActiveCodeRequest source) {
        if (source.Tids != null) {
