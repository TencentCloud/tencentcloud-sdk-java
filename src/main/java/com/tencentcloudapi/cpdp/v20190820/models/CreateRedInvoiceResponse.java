...
public class CreateRedInvoiceResponse extends AbstractModel{
    ...
    */
     ...
     * @param Result 红冲结果
     */
    public void setResult(CreateRedInvoiceResult Result) {
        this.Result = Result;
    }
     ...
     */
    public CreateRedInvoiceResponse(CreateRedInvoiceResponse source) {
        if (source.Result != null) {
            this.Result = new CreateRedInvoiceResult(source.Result);
        }
