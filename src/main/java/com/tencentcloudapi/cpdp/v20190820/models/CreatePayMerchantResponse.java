...
public class CreatePayMerchantResponse extends AbstractModel{
    ...
    */
    ...
    public CreatePayMerchantResponse() {
    }
     ...
     */
    public CreatePayMerchantResponse(CreatePayMerchantResponse source) {
