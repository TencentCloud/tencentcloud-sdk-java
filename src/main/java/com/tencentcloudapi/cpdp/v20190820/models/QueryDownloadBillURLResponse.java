...
public class QueryDownloadBillURLResponse extends AbstractModel{
    ...
    */
    ...
    public QueryDownloadBillURLResponse() {
    }
     ...
     */
    public QueryDownloadBillURLResponse(QueryDownloadBillURLResponse source) {
