...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public QueryMerchantInfoForManagementResponse() {
    }
     ...
     */
    public QueryMerchantInfoForManagementResponse(QueryMerchantInfoForManagementResponse source) {
        if (source.Result != null) {
            this.Result = new MerchantManagementResult(source.Result);
        }
