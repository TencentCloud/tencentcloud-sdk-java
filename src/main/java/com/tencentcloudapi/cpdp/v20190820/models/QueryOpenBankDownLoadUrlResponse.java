...
public class QueryOpenBankDownLoadUrlResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QueryOpenBankDownLoadUrlResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public QueryOpenBankDownLoadUrlResponse() {
    }
     ...
     */
    public QueryOpenBankDownLoadUrlResponse(QueryOpenBankDownLoadUrlResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new QueryOpenBankDownLoadUrlResult(source.Result);
        }
