...
public class QueryOrderStatusResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QueryOrderStatusResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QueryOrderStatusResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(QueryOrderStatusResult Result) {
        this.Result = Result;
    }
     ...
     */
    public QueryOrderStatusResponse(QueryOrderStatusResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new QueryOrderStatusResult(source.Result);
        }
