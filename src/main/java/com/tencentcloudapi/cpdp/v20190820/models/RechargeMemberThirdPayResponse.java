...
public class RechargeMemberThirdPayResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("MemberSubAcctPreAvailBal")
    @Expose
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public void setMemberSubAcctPreAvailBal(String MemberSubAcctPreAvailBal) {
        this.MemberSubAcctPreAvailBal = MemberSubAcctPreAvailBal;
    }
