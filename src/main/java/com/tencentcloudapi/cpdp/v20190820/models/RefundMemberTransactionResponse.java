...
public class RefundMemberTransactionResponse extends AbstractModel{
    ...
    */
    ...
    public RefundMemberTransactionResponse() {
    }
     ...
     */
    public RefundMemberTransactionResponse(RefundMemberTransactionResponse source) {
