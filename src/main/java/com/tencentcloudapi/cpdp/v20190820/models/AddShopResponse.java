...
public class AddShopResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public AddShopResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(AddShopResult Result) {
        this.Result = Result;
    }
     ...
     */
    public AddShopResponse(AddShopResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new AddShopResult(source.Result);
        }
