...
public class QueryBankTransactionDetailsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get STRING(4)，查询标志（1: 全部; 2: 转出; 3: 转入 ） 
    ...
    /**
     * Set STRING(4)，查询标志（1: 全部; 2: 转出; 3: 转入 ）
    ...
    /**
     * Get STRING(8)，终止日期（若是历史查询，则必输，当日查询时，不起作用。格式：20190101） 
    ...
    /**
     * Set STRING(8)，终止日期（若是历史查询，则必输，当日查询时，不起作用。格式：20190101）
