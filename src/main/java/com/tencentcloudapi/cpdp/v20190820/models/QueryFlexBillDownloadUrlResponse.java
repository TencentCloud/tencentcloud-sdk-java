...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(FlexBillDownloadUrlResult Result) {
        this.Result = Result;
    }
     ...
     */
    public QueryFlexBillDownloadUrlResponse(QueryFlexBillDownloadUrlResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new FlexBillDownloadUrlResult(source.Result);
        }
