...
public class DownloadOrgFileResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(DownloadFileResult Result) {
        this.Result = Result;
    }
    ...
    public DownloadOrgFileResponse() {
    }
     ...
     */
    public DownloadOrgFileResponse(DownloadOrgFileResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new DownloadFileResult(source.Result);
        }
