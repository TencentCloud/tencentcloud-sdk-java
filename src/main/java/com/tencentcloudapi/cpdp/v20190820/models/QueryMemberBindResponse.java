...
public class QueryMemberBindResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TranItem [] TranItemArray;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TranItem [] getTranItemArray() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTranItemArray(TranItem [] TranItemArray) {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public QueryMemberBindResponse() {
    }
     ...
     */
    public QueryMemberBindResponse(QueryMemberBindResponse source) {
        ...
        if (source.TranItemArray != null) {
            this.TranItemArray = new TranItem[source.TranItemArray.length];
            for (int i = 0; i < source.TranItemArray.length; i++) {
                this.TranItemArray[i] = new TranItem(source.TranItemArray[i]);
            }
        }
