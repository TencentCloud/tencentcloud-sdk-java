...
缺省: release
    ...
    public ContractOrderRequest(ContractOrderRequest source) {
        ...
        if (source.ContractNotifyUrl != null) {
            this.ContractNotifyUrl = new String(source.ContractNotifyUrl);
        }
        ...
        if (source.SubOrderList != null) {
            this.SubOrderList = new ContractOrderInSubOrder[source.SubOrderList.length];
            for (int i = 0; i < source.SubOrderList.length; i++) {
                this.SubOrderList[i] = new ContractOrderInSubOrder(source.SubOrderList[i]);
            }
        }
        ...
        if (source.AttachData != null) {
            this.AttachData = new String(source.AttachData);
        }
        if (source.ContractDisplayName != null) {
            this.ContractDisplayName = new String(source.ContractDisplayName);
        }
    }
