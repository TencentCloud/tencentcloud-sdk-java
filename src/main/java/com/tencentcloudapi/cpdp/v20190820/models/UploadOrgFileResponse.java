...
public class UploadOrgFileResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(UploadFileResult Result) {
        this.Result = Result;
    }
     ...
     */
    public UploadOrgFileResponse(UploadOrgFileResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new UploadFileResult(source.Result);
        }
