...
public class ViewMerchantResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private ViewMerchantResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public ViewMerchantResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(ViewMerchantResult Result) {
        this.Result = Result;
    }
     ...
     */
    public ViewMerchantResponse(ViewMerchantResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new ViewMerchantResult(source.Result);
        }
