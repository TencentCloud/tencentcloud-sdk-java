...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(QueryTransferResultData Result) {
        this.Result = Result;
    }
     ...
     */
    public QueryTransferResultResponse(QueryTransferResultResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new QueryTransferResultData(source.Result);
        }
