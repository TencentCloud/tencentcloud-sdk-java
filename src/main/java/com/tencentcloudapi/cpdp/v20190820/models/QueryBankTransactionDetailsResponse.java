...
public class QueryBankTransactionDetailsResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TransactionItem [] TranItemArray;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TransactionItem [] getTranItemArray() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTranItemArray(TransactionItem [] TranItemArray) {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public QueryBankTransactionDetailsResponse() {
    }
     ...
     */
    public QueryBankTransactionDetailsResponse(QueryBankTransactionDetailsResponse source) {
        ...
        if (source.TranItemArray != null) {
            this.TranItemArray = new TransactionItem[source.TranItemArray.length];
            for (int i = 0; i < source.TranItemArray.length; i++) {
                this.TranItemArray[i] = new TransactionItem(source.TranItemArray[i]);
            }
        }
