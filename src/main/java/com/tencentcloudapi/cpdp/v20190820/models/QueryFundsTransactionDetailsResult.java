...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private FundsTransactionItem [] TranItemArray;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public FundsTransactionItem [] getTranItemArray() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTranItemArray(FundsTransactionItem [] TranItemArray) {
        this.TranItemArray = TranItemArray;
    }

    public QueryFundsTransactionDetailsResult() {
    }
     ...
     */
    public QueryFundsTransactionDetailsResult(QueryFundsTransactionDetailsResult source) {
        ...
        if (source.TranItemArray != null) {
            this.TranItemArray = new FundsTransactionItem[source.TranItemArray.length];
            for (int i = 0; i < source.TranItemArray.length; i++) {
                this.TranItemArray[i] = new FundsTransactionItem(source.TranItemArray[i]);
            }
        }
    }
