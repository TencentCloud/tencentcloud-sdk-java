...
public class QueryMerchantBalanceResult extends AbstractModel{
    ...
    */
     ...
     */
    public void setData(QueryMerchantBalanceData Data) {
        this.Data = Data;
    }
     ...
     */
    public QueryMerchantBalanceResult(QueryMerchantBalanceResult source) {
        if (source.Code != null) {
            this.Code = new String(source.Code);
        }
        if (source.Data != null) {
            this.Data = new QueryMerchantBalanceData(source.Data);
        }
    }
