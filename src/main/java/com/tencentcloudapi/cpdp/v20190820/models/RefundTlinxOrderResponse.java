...
public class RefundTlinxOrderResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private RefundOrderResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public RefundOrderResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(RefundOrderResult Result) {
        this.Result = Result;
    }
    ...
    public RefundTlinxOrderResponse() {
    }
     ...
     */
    public RefundTlinxOrderResponse(RefundTlinxOrderResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new RefundOrderResult(source.Result);
        }
