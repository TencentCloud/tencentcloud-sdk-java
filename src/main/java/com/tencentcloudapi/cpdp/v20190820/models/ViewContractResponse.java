...
public class ViewContractResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private ViewContractResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public ViewContractResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(ViewContractResult Result) {
        this.Result = Result;
    }
     ...
     */
    public ViewContractResponse(ViewContractResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new ViewContractResult(source.Result);
        }
