...
public class QueryCustAcctIdBalanceRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get STRING(4)，查询标志（2: 普通会员子账号; 3: 功能子账号） 
    ...
    /**
     * Set STRING(4)，查询标志（2: 普通会员子账号; 3: 功能子账号）
    ...
    /**
     * Get STRING(50)，见证子账户的账号（若SelectFlag为2时，子账号必输） 
    ...
    /**
     * Set STRING(50)，见证子账户的账号（若SelectFlag为2时，子账号必输）
    ...
    public QueryCustAcctIdBalanceRequest() {
    }
     ...
     */
    public QueryCustAcctIdBalanceRequest(QueryCustAcctIdBalanceRequest source) {
