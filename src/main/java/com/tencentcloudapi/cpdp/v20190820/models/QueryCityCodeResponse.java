...
public class QueryCityCodeResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public CityCodeResult [] getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(CityCodeResult [] Result) {
        this.Result = Result;
    }
     ...
     */
    public QueryCityCodeResponse(QueryCityCodeResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new CityCodeResult[source.Result.length];
            for (int i = 0; i < source.Result.length; i++) {
                this.Result[i] = new CityCodeResult(source.Result[i]);
            }
        }
