...
public class CreateOpenBankPaymentOrderResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private CreateOpenBankOrderPaymentResult Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public CreateOpenBankOrderPaymentResult getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(CreateOpenBankOrderPaymentResult Result) {
        this.Result = Result;
    }
    ...
    public CreateOpenBankPaymentOrderResponse() {
    }
     ...
     */
    public CreateOpenBankPaymentOrderResponse(CreateOpenBankPaymentOrderResponse source) {
        ...
        if (source.Result != null) {
            this.Result = new CreateOpenBankOrderPaymentResult(source.Result);
        }
