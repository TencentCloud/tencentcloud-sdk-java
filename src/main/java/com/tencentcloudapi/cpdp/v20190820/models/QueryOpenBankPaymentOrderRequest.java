...
public class QueryOpenBankPaymentOrderRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 外部商户订单号。与ChannelOrderId不能同时为空字符串。 
    ...
    /**
     * Set 外部商户订单号。与ChannelOrderId不能同时为空字符串。
    ...
    /**
     * Get 云平台订单号。与OutOrderId不能同时为空字符串。 
    ...
    /**
     * Set 云平台订单号。与OutOrderId不能同时为空字符串。
    ...
    public QueryOpenBankPaymentOrderRequest() {
    }
     ...
     */
    public QueryOpenBankPaymentOrderRequest(QueryOpenBankPaymentOrderRequest source) {
