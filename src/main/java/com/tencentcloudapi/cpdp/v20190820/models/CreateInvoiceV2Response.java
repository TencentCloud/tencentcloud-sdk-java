...
public class CreateInvoiceV2Response extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private CreateInvoiceResultV2 Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public CreateInvoiceResultV2 getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(CreateInvoiceResultV2 Result) {
        this.Result = Result;
    }
