...
public class WithdrawCashMembershipResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public WithdrawCashMembershipResponse() {
    }
     ...
     */
    public WithdrawCashMembershipResponse(WithdrawCashMembershipResponse source) {
        ...
        if (source.TransferFee != null) {
            this.TransferFee = new String(source.TransferFee);
        }
