...
public class QueryFlexSettlementOrderListRequest extends AbstractModel{
    ...
    */
     ...
     */
    public QueryFlexSettlementOrderListRequest(QueryFlexSettlementOrderListRequest source) {
