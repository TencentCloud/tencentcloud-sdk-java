...
public class BindOpenBankExternalSubMerchantBankAccountRequest extends AbstractModel{
...
__OPENBANK_PAYMENT__: openbank支付
    ...
    */
    @SerializedName("ExternalSubMerchantBindBankAccountData")
    @Expose
    private String ExternalSubMerchantBindBankAccountData;
...
__OPENBANK_PAYMENT__: openbank支付
    ...
    /**
     * Get 第三方渠道子商户收款方银行卡信息, 为JSON格式字符串。详情见附录-复杂类型。 
     * @return ExternalSubMerchantBindBankAccountData 第三方渠道子商户收款方银行卡信息, 为JSON格式字符串。详情见附录-复杂类型。
     */
    public String getExternalSubMerchantBindBankAccountData() {
        return this.ExternalSubMerchantBindBankAccountData;
    }

    /**
     * Set 第三方渠道子商户收款方银行卡信息, 为JSON格式字符串。详情见附录-复杂类型。
     * @param ExternalSubMerchantBindBankAccountData 第三方渠道子商户收款方银行卡信息, 为JSON格式字符串。详情见附录-复杂类型。
     */
    public void setExternalSubMerchantBindBankAccountData(String ExternalSubMerchantBindBankAccountData) {
        this.ExternalSubMerchantBindBankAccountData = ExternalSubMerchantBindBankAccountData;
    }
...
_不填默认为生产环境_
    ...
    public BindOpenBankExternalSubMerchantBankAccountRequest() {
    }
     ...
     */
    public BindOpenBankExternalSubMerchantBankAccountRequest(BindOpenBankExternalSubMerchantBankAccountRequest source) {
        ...
        if (source.ExternalSubMerchantBindBankAccountData != null) {
            this.ExternalSubMerchantBindBankAccountData = new String(source.ExternalSubMerchantBindBankAccountData);
        }
