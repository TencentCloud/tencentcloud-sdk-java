...
public class CreatePersonalAccountResponse extends AbstractModel{
    ...
    */
    ...
    public CreatePersonalAccountResponse() {
    }
     ...
     */
    public CreatePersonalAccountResponse(CreatePersonalAccountResponse source) {
