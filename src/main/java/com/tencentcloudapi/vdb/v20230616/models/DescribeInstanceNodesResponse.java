...
public class DescribeInstanceNodesResponse extends AbstractModel {
    ...
    */
     ...
     * @param Items 实例pod列表。
     */
    public void setItems(NodeInfo [] Items) {
        this.Items = Items;
    }
    ...
    public DescribeInstanceNodesResponse(DescribeInstanceNodesResponse source) {
        if (source.Items != null) {
            this.Items = new NodeInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new NodeInfo(source.Items[i]);
            }
        }
