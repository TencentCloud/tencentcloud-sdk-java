...
public class AttachRemoteDisksRequest extends AbstractModel {
    ...
    */
    ...
    public AttachRemoteDisksRequest() {
    }
     ...
     */
    public AttachRemoteDisksRequest(AttachRemoteDisksRequest source) {
