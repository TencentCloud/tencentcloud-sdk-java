...
public class DescribeVcubeApplicationAndPlayListRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeVcubeApplicationAndPlayListRequest(DescribeVcubeApplicationAndPlayListRequest source) {
