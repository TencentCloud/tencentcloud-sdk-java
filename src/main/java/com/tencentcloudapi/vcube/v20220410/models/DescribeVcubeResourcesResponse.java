...
public class DescribeVcubeResourcesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResourceList(LicenseResourceSimpleInfo [] ResourceList) {
     ...
     */
    public DescribeVcubeResourcesResponse(DescribeVcubeResourcesResponse source) {
        if (source.ResourceList != null) {
            this.ResourceList = new LicenseResourceSimpleInfo[source.ResourceList.length];
            for (int i = 0; i < source.ResourceList.length; i++) {
                this.ResourceList[i] = new LicenseResourceSimpleInfo(source.ResourceList[i]);
            }
        }
