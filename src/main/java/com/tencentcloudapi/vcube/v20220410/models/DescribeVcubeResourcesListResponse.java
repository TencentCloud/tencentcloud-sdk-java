...
public class DescribeVcubeResourcesListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResourceList(LicenseResourceInfo [] ResourceList) {
     ...
     */
    public DescribeVcubeResourcesListResponse(DescribeVcubeResourcesListResponse source) {
        if (source.ResourceList != null) {
            this.ResourceList = new LicenseResourceInfo[source.ResourceList.length];
            for (int i = 0; i < source.ResourceList.length; i++) {
                this.ResourceList[i] = new LicenseResourceInfo(source.ResourceList[i]);
            }
        }
