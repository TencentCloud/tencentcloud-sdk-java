...
public class QueryActivityAntiRushAdvancedRequest extends AbstractModel{
    ...
    */
    ...
    @Expose
    private InputActivityAntiRushAdvanced BusinessSecurityData;

    /**
     * Get 业务入参 
     * @return BusinessSecurityData 业务入参
     */
    public InputActivityAntiRushAdvanced getBusinessSecurityData() {
     ...
     */
    public void setBusinessSecurityData(InputActivityAntiRushAdvanced BusinessSecurityData) {
