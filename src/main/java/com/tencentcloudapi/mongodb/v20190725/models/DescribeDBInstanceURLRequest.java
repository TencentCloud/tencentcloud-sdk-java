...
public class DescribeDBInstanceURLRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDBInstanceURLRequest() {
    }
     ...
     */
    public DescribeDBInstanceURLRequest(DescribeDBInstanceURLRequest source) {
