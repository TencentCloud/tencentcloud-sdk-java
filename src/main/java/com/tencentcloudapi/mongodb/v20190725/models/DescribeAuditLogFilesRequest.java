...
public class DescribeAuditLogFilesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 分页大小参数。默认值为 20，取值范围[1,100]。 
     * @return Limit 分页大小参数。默认值为 20，取值范围[1,100]。
     */
    ...
    /**
     * Set 分页大小参数。默认值为 20，取值范围[1,100]。
     * @param Limit 分页大小参数。默认值为 20，取值范围[1,100]。
     */
    ...
    /**
     * Get 审计日志文件名。该接口将根据此参数过滤相关的审计日志文件。 
     * @return FileName 审计日志文件名。该接口将根据此参数过滤相关的审计日志文件。
     */
    ...
    /**
     * Set 审计日志文件名。该接口将根据此参数过滤相关的审计日志文件。
     * @param FileName 审计日志文件名。该接口将根据此参数过滤相关的审计日志文件。
     */
