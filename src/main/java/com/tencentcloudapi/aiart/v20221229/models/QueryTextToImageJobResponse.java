...
public class QueryTextToImageJobResponse extends AbstractModel {
...
1：等待中、2：运行中、4：处理失败、5：处理完成。
    ...
    public QueryTextToImageJobResponse() {
    }
     ...
     */
    public QueryTextToImageJobResponse(QueryTextToImageJobResponse source) {
