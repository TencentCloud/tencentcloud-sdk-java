...
public class QueryTrainPortraitModelJobResponse extends AbstractModel {
...
INIT: 初始化、WAIT：等待中、RUN：运行中、FAIL：处理失败、DONE：处理完成。
    ...
    public QueryTrainPortraitModelJobResponse() {
    }
     ...
     */
    public QueryTrainPortraitModelJobResponse(QueryTrainPortraitModelJobResponse source) {
