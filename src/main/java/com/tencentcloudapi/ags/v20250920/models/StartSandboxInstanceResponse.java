...
public class StartSandboxInstanceResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private SandboxInstance Instance;
    ...
    */
    ...
    public StartSandboxInstanceResponse() {
    }
     ...
     */
    public StartSandboxInstanceResponse(StartSandboxInstanceResponse source) {
        if (source.Instance != null) {
            this.Instance = new SandboxInstance(source.Instance);
        }
