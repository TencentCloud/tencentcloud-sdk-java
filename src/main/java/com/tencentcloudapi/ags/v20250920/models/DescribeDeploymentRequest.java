...
public class DescribeDeploymentRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDeploymentRequest(DescribeDeploymentRequest source) {
