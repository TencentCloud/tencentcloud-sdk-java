...
public class DescribeSandboxInstanceListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeSandboxInstanceListResponse() {
    }
     ...
     */
    public DescribeSandboxInstanceListResponse(DescribeSandboxInstanceListResponse source) {
        if (source.InstanceSet != null) {
            this.InstanceSet = new SandboxInstance[source.InstanceSet.length];
            for (int i = 0; i < source.InstanceSet.length; i++) {
                this.InstanceSet[i] = new SandboxInstance(source.InstanceSet[i]);
            }
        }
