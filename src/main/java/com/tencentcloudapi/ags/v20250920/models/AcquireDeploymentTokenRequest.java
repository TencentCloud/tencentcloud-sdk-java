...
public class AcquireDeploymentTokenRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>目标 ACTIVE Deployment 的稳定 ID。</p> 
    ...
    /**
     * Set <p>目标 ACTIVE Deployment 的稳定 ID。</p>
    ...
    public AcquireDeploymentTokenRequest() {
    }
     ...
     */
    public AcquireDeploymentTokenRequest(AcquireDeploymentTokenRequest source) {
