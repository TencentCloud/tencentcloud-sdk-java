...
public class QueryGeneralStatResponse extends AbstractModel{

    /**
    * 调用量信息
    */
    @SerializedName("GeneralStat")
    @Expose
    ...
    */
     ...
     */
    public GeneralStat getGeneralStat() {
     ...
     */
    public void setGeneralStat(GeneralStat GeneralStat) {
