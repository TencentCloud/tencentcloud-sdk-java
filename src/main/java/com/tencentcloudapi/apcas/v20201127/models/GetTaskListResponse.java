...
public class GetTaskListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public GetTaskListResponse(GetTaskListResponse source) {
        if (source.TaskListData != null) {
            this.TaskListData = new TaskListData(source.TaskListData);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "TaskListData.", this.TaskListData);
