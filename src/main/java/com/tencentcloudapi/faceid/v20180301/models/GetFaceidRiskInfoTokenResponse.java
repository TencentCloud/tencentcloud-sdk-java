...
public class GetFaceidRiskInfoTokenResponse extends AbstractModel {
    ...
    */
    ...
    public GetFaceidRiskInfoTokenResponse() {
    }
     ...
     */
    public GetFaceidRiskInfoTokenResponse(GetFaceidRiskInfoTokenResponse source) {
