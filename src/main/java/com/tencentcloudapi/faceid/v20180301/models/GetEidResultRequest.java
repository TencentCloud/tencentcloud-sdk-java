...
默认值：0
    ...
    */
    ...
    /**
     * Get 指定拉取的结果信息，取值（0：全部；1：文本类；2：身份证信息；3：最佳截图信息；5：意愿核身相关结果；）。
如 13表示拉取文本类、最佳截图信息。
默认值：0 
     * @return InfoType 指定拉取的结果信息，取值（0：全部；1：文本类；2：身份证信息；3：最佳截图信息；5：意愿核身相关结果；）。
如 13表示拉取文本类、最佳截图信息。
默认值：0
     */
    ...
    /**
     * Set 指定拉取的结果信息，取值（0：全部；1：文本类；2：身份证信息；3：最佳截图信息；5：意愿核身相关结果；）。
如 13表示拉取文本类、最佳截图信息。
默认值：0
