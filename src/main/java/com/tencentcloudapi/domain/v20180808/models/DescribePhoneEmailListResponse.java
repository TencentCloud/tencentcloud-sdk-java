...
public class DescribePhoneEmailListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setPhoneEmailList(PhoneEmailData [] PhoneEmailList) {
     ...
     */
    public DescribePhoneEmailListResponse(DescribePhoneEmailListResponse source) {
        if (source.PhoneEmailList != null) {
            this.PhoneEmailList = new PhoneEmailData[source.PhoneEmailList.length];
            for (int i = 0; i < source.PhoneEmailList.length; i++) {
                this.PhoneEmailList[i] = new PhoneEmailData(source.PhoneEmailList[i]);
            }
        }
