...
public class CheckBatchStatusResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setStatusSet(BatchStatus [] StatusSet) {
     ...
     */
    public CheckBatchStatusResponse(CheckBatchStatusResponse source) {
        if (source.StatusSet != null) {
            this.StatusSet = new BatchStatus[source.StatusSet.length];
            for (int i = 0; i < source.StatusSet.length; i++) {
                this.StatusSet[i] = new BatchStatus(source.StatusSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "StatusSet.", this.StatusSet);
