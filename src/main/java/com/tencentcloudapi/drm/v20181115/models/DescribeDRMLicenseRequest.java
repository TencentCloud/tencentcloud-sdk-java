...
public class DescribeDRMLicenseRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDRMLicenseRequest() {
    }
     ...
     */
    public DescribeDRMLicenseRequest(DescribeDRMLicenseRequest source) {
