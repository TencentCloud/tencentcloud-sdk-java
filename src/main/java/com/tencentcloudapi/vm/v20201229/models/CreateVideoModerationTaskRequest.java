...
public class CreateVideoModerationTaskRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType 
     * @return BizType 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
     */
    ...
    /**
     * Set 业务类型, 定义 模版策略，输出存储配置。默认为default，客户可以在视频审核控制台创建自己的 BizType
    ...
    /**
     * Get （可选）回调签名key，具体可以查看回调签名示例 
     * @return Seed （可选）回调签名key，具体可以查看回调签名示例
     */
