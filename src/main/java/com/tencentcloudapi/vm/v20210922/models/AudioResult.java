...
public class AudioResult extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p> 
    ...
    /**
     * Set <p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
     * @param Extra <p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
     */
    ...
    /**
     * Get <p>该字段用于返回音频文件说话人检测的详细审核结果</p> 
    ...
    /**
     * Set <p>该字段用于返回音频文件说话人检测的详细审核结果</p>
     * @param SpeakerResults <p>该字段用于返回音频文件说话人检测的详细审核结果</p>
     */
    ...
    /**
     * Get <p>该字段用于返回音频文件出行检测的详细审核结果</p> 
    ...
    /**
     * Set <p>该字段用于返回音频文件出行检测的详细审核结果</p>
     * @param TravelResults <p>该字段用于返回音频文件出行检测的详细审核结果</p>
     */
    ...
    /**
     * Set <p>该字段用于返回音频文件的三级标签</p>
     * @param SubTag <p>该字段用于返回音频文件的三级标签</p>
     */
    ...
    /**
     * Set <p>该字段用于返回音频文件的三级标签码</p>
     * @param SubTagCode <p>该字段用于返回音频文件的三级标签码</p>
     */
    ...
    /**
     * Get <p>该字段用于返回音频文件歌曲识别的详细审核结果</p> 
    ...
    /**
     * Set <p>该字段用于返回音频文件歌曲识别的详细审核结果</p>
     * @param LabelResults <p>该字段用于返回音频文件歌曲识别的详细审核结果</p>
     */
