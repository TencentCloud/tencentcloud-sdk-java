...
public class DescribeVideoStatRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeVideoStatRequest() {
    }
     ...
     */
    public DescribeVideoStatRequest(DescribeVideoStatRequest source) {
