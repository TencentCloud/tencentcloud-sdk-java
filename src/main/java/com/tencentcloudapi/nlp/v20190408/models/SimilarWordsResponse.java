...
public class SimilarWordsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public SimilarWordsResponse(SimilarWordsResponse source) {
        if (source.SimilarWords != null) {
            this.SimilarWords = new String[source.SimilarWords.length];
            for (int i = 0; i < source.SimilarWords.length; i++) {
                this.SimilarWords[i] = new String(source.SimilarWords[i]);
            }
        }
