...
public class UpdateIPWhitelistRequest extends AbstractModel {
    ...
    */
    ...
    public UpdateIPWhitelistRequest() {
    }
     ...
     */
    public UpdateIPWhitelistRequest(UpdateIPWhitelistRequest source) {
