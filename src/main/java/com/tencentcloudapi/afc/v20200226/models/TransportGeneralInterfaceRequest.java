...
public class TransportGeneralInterfaceRequest extends AbstractModel{
    ...
    */
     ...
     */
    public void setBusinessSecurityData(TransportGeneralInterfaceInput BusinessSecurityData) {
     ...
     */
    public TransportGeneralInterfaceRequest(TransportGeneralInterfaceRequest source) {
        if (source.BusinessSecurityData != null) {
            this.BusinessSecurityData = new TransportGeneralInterfaceInput(source.BusinessSecurityData);
        }
    }
