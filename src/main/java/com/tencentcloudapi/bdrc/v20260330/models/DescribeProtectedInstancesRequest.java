...
public class DescribeProtectedInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 过滤条件。支持: instance-id, agent-status 
     * @return Filters 过滤条件。支持: instance-id, agent-status
     */
    ...
    /**
     * Set 过滤条件。支持: instance-id, agent-status
    ...
    public DescribeProtectedInstancesRequest() {
    }
     ...
     */
    public DescribeProtectedInstancesRequest(DescribeProtectedInstancesRequest source) {
