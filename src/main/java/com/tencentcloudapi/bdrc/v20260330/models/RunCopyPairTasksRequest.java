...
public class RunCopyPairTasksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 要启动复制对的类型（DISK/INSTANCE/CFS） 
    ...
    /**
     * Set 要启动复制对的类型（DISK/INSTANCE/CFS）
    ...
    public RunCopyPairTasksRequest() {
    }
     ...
     */
    public RunCopyPairTasksRequest(RunCopyPairTasksRequest source) {
