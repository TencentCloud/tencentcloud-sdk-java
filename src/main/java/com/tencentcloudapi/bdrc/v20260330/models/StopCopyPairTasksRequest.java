...
public class StopCopyPairTasksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 复制对类型（DISK/INSTANCE/CFS） 
     * @return CopyPairType 复制对类型（DISK/INSTANCE/CFS）
     */
    ...
    public StopCopyPairTasksRequest() {
    }
     ...
     */
    public StopCopyPairTasksRequest(StopCopyPairTasksRequest source) {
