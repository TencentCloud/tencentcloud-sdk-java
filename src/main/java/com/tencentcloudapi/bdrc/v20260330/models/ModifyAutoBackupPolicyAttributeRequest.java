...
public class ModifyAutoBackupPolicyAttributeRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 备份存储类型。SNAPSHOT表示走快照（不需要备份库），VAULT表示走备份库（必须关联一个备份库）。默认为SNAPSHOT 
    ...
    /**
     * Set 备份存储类型。SNAPSHOT表示走快照（不需要备份库），VAULT表示走备份库（必须关联一个备份库）。默认为SNAPSHOT
    ...
    public ModifyAutoBackupPolicyAttributeRequest() {
    }
     ...
     */
    public ModifyAutoBackupPolicyAttributeRequest(ModifyAutoBackupPolicyAttributeRequest source) {
