...
public class DescribeFileBackupPlansRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 过滤条件。支持: instance-id, plan-id, plan-name, status, auto-backup-policy-id 
    ...
    /**
     * Set 过滤条件。支持: instance-id, plan-id, plan-name, status, auto-backup-policy-id
    ...
    public DescribeFileBackupPlansRequest() {
    }
     ...
     */
    public DescribeFileBackupPlansRequest(DescribeFileBackupPlansRequest source) {
