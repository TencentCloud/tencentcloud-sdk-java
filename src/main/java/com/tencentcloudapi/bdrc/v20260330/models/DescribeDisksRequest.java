...
public class DescribeDisksRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDisksRequest(DescribeDisksRequest source) {
        ...
        if (source.DiskRegion != null) {
            this.DiskRegion = new String(source.DiskRegion);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "DiskRegion", this.DiskRegion);
