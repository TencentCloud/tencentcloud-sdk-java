...
public class DeleteBackupGroupsRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteBackupGroupsRequest() {
    }
     ...
     */
    public DeleteBackupGroupsRequest(DeleteBackupGroupsRequest source) {
