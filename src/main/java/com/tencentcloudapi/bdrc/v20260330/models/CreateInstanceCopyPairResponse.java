...
public class CreateInstanceCopyPairResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 创建的CVM复制对ID列表 
     * @return CopyPairIds 创建的CVM复制对ID列表
     */
    ...
    public CreateInstanceCopyPairResponse() {
    }
     ...
     */
    public CreateInstanceCopyPairResponse(CreateInstanceCopyPairResponse source) {
