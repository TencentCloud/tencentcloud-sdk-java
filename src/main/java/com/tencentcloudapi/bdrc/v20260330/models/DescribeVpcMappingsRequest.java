...
public class DescribeVpcMappingsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 过滤条件。支持: source-vpc-id, target-vpc-id, source-subnet-id, target-subnet-id 
    ...
    /**
     * Set 过滤条件。支持: source-vpc-id, target-vpc-id, source-subnet-id, target-subnet-id
    ...
    public DescribeVpcMappingsRequest() {
    }
     ...
     */
    public DescribeVpcMappingsRequest(DescribeVpcMappingsRequest source) {
