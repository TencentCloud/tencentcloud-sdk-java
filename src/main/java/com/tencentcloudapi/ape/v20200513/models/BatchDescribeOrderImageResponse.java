...
public class BatchDescribeOrderImageResponse extends AbstractModel{
    ...
    */
    ...
    public BatchDescribeOrderImageResponse() {
    }
     ...
     */
    public BatchDescribeOrderImageResponse(BatchDescribeOrderImageResponse source) {
