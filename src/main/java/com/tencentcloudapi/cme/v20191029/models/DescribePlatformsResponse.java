...
public class DescribePlatformsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setPlatformInfoSet(PlatformInfo [] PlatformInfoSet) {
        this.PlatformInfoSet = PlatformInfoSet;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "PlatformInfoSet.", this.PlatformInfoSet);
