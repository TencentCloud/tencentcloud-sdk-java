...
public class AICallAPICallResponseDetail extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>响应头，json 序列化后的字符串，键升序排列。敏感值已脱敏，无响应头时为空字符串。</p> 
    ...
    /**
     * Set <p>响应头，json 序列化后的字符串，键升序排列。敏感值已脱敏，无响应头时为空字符串。</p>
     * @param Headers <p>响应头，json 序列化后的字符串，键升序排列。敏感值已脱敏，无响应头时为空字符串。</p>
     */
    ...
    /**
     * Get <p>响应体，超长时被截断，是否截断见 Truncated。</p> 
    ...
    /**
     * Set <p>响应体，超长时被截断，是否截断见 Truncated。</p>
     * @param Body <p>响应体，超长时被截断，是否截断见 Truncated。</p>
     */
    ...
    /**
     * Set <p>响应体 Body 是否被截断。</p>
     * @param Truncated <p>响应体 Body 是否被截断。</p>
     */
    public void setTruncated(Boolean Truncated) {
        this.Truncated = Truncated;
    }

    public AICallAPICallResponseDetail() {
    }
     ...
     */
    public AICallAPICallResponseDetail(AICallAPICallResponseDetail source) {
