...
public class DeleteCertificatesResponse extends AbstractModel {
    ...
    */
     ...
     * @param Fail 失败的ID和原因
     */
    public void setFail(BatchDeleteFail [] Fail) {
        this.Fail = Fail;
    }
     ...
     */
    public DeleteCertificatesResponse(DeleteCertificatesResponse source) {
        ...
        if (source.Fail != null) {
            this.Fail = new BatchDeleteFail[source.Fail.length];
            for (int i = 0; i < source.Fail.length; i++) {
                this.Fail[i] = new BatchDeleteFail(source.Fail[i]);
            }
        }
