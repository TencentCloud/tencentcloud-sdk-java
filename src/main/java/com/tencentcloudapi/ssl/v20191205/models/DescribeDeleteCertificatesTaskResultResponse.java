...
public class DescribeDeleteCertificatesTaskResultResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDeleteCertificatesTaskResultResponse(DescribeDeleteCertificatesTaskResultResponse source) {
        if (source.DeleteTaskResult != null) {
            this.DeleteTaskResult = new DeleteTaskResult[source.DeleteTaskResult.length];
            for (int i = 0; i < source.DeleteTaskResult.length; i++) {
                this.DeleteTaskResult[i] = new DeleteTaskResult(source.DeleteTaskResult[i]);
            }
        }
