...
public class SubmitAuditManagerResponse extends AbstractModel{
    ...
    */
    ...
    public SubmitAuditManagerResponse() {
    }
     ...
     */
    public SubmitAuditManagerResponse(SubmitAuditManagerResponse source) {
