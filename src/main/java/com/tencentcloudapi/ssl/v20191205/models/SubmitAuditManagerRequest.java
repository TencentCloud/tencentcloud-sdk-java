...
public class SubmitAuditManagerRequest extends AbstractModel{
    ...
    */
    ...
    public SubmitAuditManagerRequest() {
    }
     ...
     */
    public SubmitAuditManagerRequest(SubmitAuditManagerRequest source) {
