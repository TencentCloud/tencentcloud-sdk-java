...
public class CheckCertificateExistRequest extends AbstractModel {
    ...
    */
    ...
    public CheckCertificateExistRequest() {
    }
     ...
     */
    public CheckCertificateExistRequest(CheckCertificateExistRequest source) {
