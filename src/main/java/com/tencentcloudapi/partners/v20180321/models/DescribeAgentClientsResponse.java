...
public class DescribeAgentClientsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeAgentClientsResponse(DescribeAgentClientsResponse source) {
        if (source.AgentClientSet != null) {
            this.AgentClientSet = new AgentClientElem[source.AgentClientSet.length];
            for (int i = 0; i < source.AgentClientSet.length; i++) {
                this.AgentClientSet[i] = new AgentClientElem(source.AgentClientSet[i]);
            }
        }
