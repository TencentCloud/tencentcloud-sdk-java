...
public class DescribeBaselineDownloadListRequest extends AbstractModel{
...
<li>TaskName - string - 是否必填：否 - 任务名称</li>
    ...
    */
    ...
    /**
     * Get <li>Status - int - 是否必填：否 - 0:导出中 1:已完成</li>
<li>StartTime - string - 是否必填：否 - 开始时间</li>
<li>EndTime - string - 是否必填：否 - 结束时间</li>
<li>TaskName - string - 是否必填：否 - 任务名称</li> 
...
<li>TaskName - string - 是否必填：否 - 任务名称</li>
    ...
    /**
     * Set <li>Status - int - 是否必填：否 - 0:导出中 1:已完成</li>
<li>StartTime - string - 是否必填：否 - 开始时间</li>
<li>EndTime - string - 是否必填：否 - 结束时间</li>
<li>TaskName - string - 是否必填：否 - 任务名称</li>
...
<li>TaskName - string - 是否必填：否 - 任务名称</li>
    ...
    public DescribeBaselineDownloadListRequest() {
    }
     ...
     */
    public DescribeBaselineDownloadListRequest(DescribeBaselineDownloadListRequest source) {
