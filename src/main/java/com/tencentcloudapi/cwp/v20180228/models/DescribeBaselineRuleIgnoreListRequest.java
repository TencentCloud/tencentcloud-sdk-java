...
public class DescribeBaselineRuleIgnoreListRequest extends AbstractModel{
...
<li>ItemId- int - 是否必填：否 - 检测项Id</li>
    ...
    public DescribeBaselineRuleIgnoreListRequest() {
    }
     ...
     */
    public DescribeBaselineRuleIgnoreListRequest(DescribeBaselineRuleIgnoreListRequest source) {
