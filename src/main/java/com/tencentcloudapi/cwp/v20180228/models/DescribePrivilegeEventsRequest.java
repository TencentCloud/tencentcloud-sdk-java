...
public class DescribePrivilegeEventsRequest extends AbstractModel{
...
<li>Keywords - String - 是否必填：否 - 关键词(主机IP)</li>
    ...
    public DescribePrivilegeEventsRequest() {
    }
     ...
     */
    public DescribePrivilegeEventsRequest(DescribePrivilegeEventsRequest source) {
