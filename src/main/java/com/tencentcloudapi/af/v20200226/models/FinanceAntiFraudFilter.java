...
public class FinanceAntiFraudFilter extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01 
    ...
    /**
     * Set 身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
    ...
    /**
     * Get qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用 
    ...
    /**
     * Set qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
    ...
    /**
     * Get 业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据 
    ...
    /**
     * Set 业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
    ...
    /**
     * Get 手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3 
    ...
    /**
     * Set 手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
    ...
    /**
     * Get 身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3 
    ...
    /**
     * Set 身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
    ...
    /**
     * Get 姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3 
    ...
    /**
     * Set 姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     ...
     */
    public FinanceAntiFraudFilter(FinanceAntiFraudFilter source) {
