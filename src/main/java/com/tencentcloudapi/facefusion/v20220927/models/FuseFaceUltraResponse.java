...
public class FuseFaceUltraResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get RspImgType 为 url 时，返回结果的 url， RspImgType 为 base64 时返回 base64 数据。url有效期为1天。 
    ...
    /**
     * Set RspImgType 为 url 时，返回结果的 url， RspImgType 为 base64 时返回 base64 数据。url有效期为1天。
     ...
     */
    public FuseFaceUltraResponse(FuseFaceUltraResponse source) {
