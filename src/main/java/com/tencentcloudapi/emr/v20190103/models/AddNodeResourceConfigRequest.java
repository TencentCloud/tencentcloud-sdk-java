...
public class AddNodeResourceConfigRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 是否默认配置,DEFAULT,BACKUP,不填默认不是默认配置 
    ...
    /**
     * Set 是否默认配置,DEFAULT,BACKUP,不填默认不是默认配置
    ...
    /**
     * Get 添加多个规格时，第1个规格详情在ResourceConfig参数，第2-n个在MultipleResourceConfig参数 
    ...
    /**
     * Set 添加多个规格时，第1个规格详情在ResourceConfig参数，第2-n个在MultipleResourceConfig参数
