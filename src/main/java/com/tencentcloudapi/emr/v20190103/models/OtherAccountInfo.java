...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setOtherUin(String OtherUin) {
        this.OtherUin = OtherUin;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public OtherAccountInfo(OtherAccountInfo source) {
        if (source.OtherUin != null) {
            this.OtherUin = new String(source.OtherUin);
        }
