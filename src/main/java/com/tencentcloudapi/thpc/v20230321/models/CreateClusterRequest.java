...
public class CreateClusterRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>调度器类型。默认取值：SLURM。<li>SLURM：SLURM调度器。</li></p> 
    ...
    /**
     * Set <p>调度器类型。默认取值：SLURM。<li>SLURM：SLURM调度器。</li></p>
    ...
    /**
     * Get <p>创建调度器的版本号，可填写版本号为“latest” 和 各调度器支持的版本号；如果是&quot;latest&quot;, 则代表创建的是平台当前支持的该类型调度器最新版本。如果不填写，默认创建的是“latest”版本调度器<br>各调度器支持的集群版本：</p><li>SLURM：21.08.8、23.11.7</li> 
    ...
    /**
     * Set <p>创建调度器的版本号，可填写版本号为“latest” 和 各调度器支持的版本号；如果是&quot;latest&quot;, 则代表创建的是平台当前支持的该类型调度器最新版本。如果不填写，默认创建的是“latest”版本调度器<br>各调度器支持的集群版本：</p><li>SLURM：21.08.8、23.11.7</li>
    ...
    /**
     * Get <p>域名字服务类型。默认取值：NIS。</p><li>NIS：NIS域名字服务。</li> 
    ...
    /**
     * Set <p>域名字服务类型。默认取值：NIS。</p><li>NIS：NIS域名字服务。</li>
