...
public class EnableClusterMonitorRequest extends AbstractModel {
    ...
    */
    ...
    public EnableClusterMonitorRequest() {
    }
     ...
     */
    public EnableClusterMonitorRequest(EnableClusterMonitorRequest source) {
