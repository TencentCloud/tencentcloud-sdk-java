...
public class DescribeWorkspacesResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeWorkspacesResponse(DescribeWorkspacesResponse source) {
        if (source.SpaceSet != null) {
            this.SpaceSet = new SpaceInfo[source.SpaceSet.length];
            for (int i = 0; i < source.SpaceSet.length; i++) {
                this.SpaceSet[i] = new SpaceInfo(source.SpaceSet[i]);
            }
        }
