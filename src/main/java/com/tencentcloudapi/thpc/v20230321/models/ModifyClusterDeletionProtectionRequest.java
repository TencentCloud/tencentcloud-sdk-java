...
public class ModifyClusterDeletionProtectionRequest extends AbstractModel {
...
可选值：<li>OFF：关闭集群删除保护。</li><li>ON：打开集群删除保护。</li>
     ...
     */
    public ModifyClusterDeletionProtectionRequest(ModifyClusterDeletionProtectionRequest source) {
