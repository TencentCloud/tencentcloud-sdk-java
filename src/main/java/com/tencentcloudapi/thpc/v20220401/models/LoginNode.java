...
public class LoginNode extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 节点显示名称。<br><li> 不指定节点显示名称则默认显示‘未命名’。 最多支持60个字符。</li>	 
    ...
    /**
     * Set 节点显示名称。<br><li> 不指定节点显示名称则默认显示‘未命名’。 最多支持60个字符。</li>	
     ...
     */
    public LoginNode(LoginNode source) {
        ...
        if (source.InternetAccessible != null) {
            this.InternetAccessible = new InternetAccessible[source.InternetAccessible.length];
            for (int i = 0; i < source.InternetAccessible.length; i++) {
                this.InternetAccessible[i] = new InternetAccessible(source.InternetAccessible[i]);
            }
        }
