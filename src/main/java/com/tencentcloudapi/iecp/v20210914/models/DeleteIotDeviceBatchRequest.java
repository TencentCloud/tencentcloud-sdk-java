...
public class DeleteIotDeviceBatchRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteIotDeviceBatchRequest() {
    }
     ...
     */
    public DeleteIotDeviceBatchRequest(DeleteIotDeviceBatchRequest source) {
        if (source.DeviceIDList != null) {
            this.DeviceIDList = new Long[source.DeviceIDList.length];
            for (int i = 0; i < source.DeviceIDList.length; i++) {
                this.DeviceIDList[i] = new Long(source.DeviceIDList[i]);
            }
        }
    }
