...
public class DescribeMessageRouteListResponse extends AbstractModel{
    ...
    */
     ...
     * @param RouteList 无
     */
    public void setRouteList(RouteInfo [] RouteList) {
     ...
     */
    public DescribeMessageRouteListResponse(DescribeMessageRouteListResponse source) {
        if (source.RouteList != null) {
            this.RouteList = new RouteInfo[source.RouteList.length];
            for (int i = 0; i < source.RouteList.length; i++) {
                this.RouteList[i] = new RouteInfo(source.RouteList[i]);
            }
        }
