...
public class GetMarketComponentListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setComponentList(MarketComponentInfo [] ComponentList) {
        this.ComponentList = ComponentList;
    }

    /**
     * Get 组件总数 
     * @return TotalCount 组件总数
     */
     ...
     */
    public GetMarketComponentListResponse(GetMarketComponentListResponse source) {
        if (source.ComponentList != null) {
            this.ComponentList = new MarketComponentInfo[source.ComponentList.length];
            for (int i = 0; i < source.ComponentList.length; i++) {
                this.ComponentList[i] = new MarketComponentInfo(source.ComponentList[i]);
            }
        }
