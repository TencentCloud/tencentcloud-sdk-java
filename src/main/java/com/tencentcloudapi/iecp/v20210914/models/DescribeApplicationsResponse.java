...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    @Expose
    private ApplicationTemplate [] ApplicationSet;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public ApplicationTemplate [] getApplicationSet() {
     ...
     */
    public void setApplicationSet(ApplicationTemplate [] ApplicationSet) {
    ...
    public DescribeApplicationsResponse(DescribeApplicationsResponse source) {
        ...
        if (source.ApplicationSet != null) {
            this.ApplicationSet = new ApplicationTemplate[source.ApplicationSet.length];
            for (int i = 0; i < source.ApplicationSet.length; i++) {
                this.ApplicationSet[i] = new ApplicationTemplate(source.ApplicationSet[i]);
            }
        }
