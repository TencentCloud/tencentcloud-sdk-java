...
public class ModifyApplicationVisualizationRequest extends AbstractModel{
    ...
    */
     ...
     */
    public ModifyApplicationVisualizationRequest(ModifyApplicationVisualizationRequest source) {
        ...
        if (source.InitContainer != null) {
            this.InitContainer = new Container(source.InitContainer);
        }
    }
