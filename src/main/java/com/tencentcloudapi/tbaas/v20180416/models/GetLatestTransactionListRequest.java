...
public class GetLatestTransactionListRequest extends AbstractModel {
    ...
    */
    ...
    public GetLatestTransactionListRequest() {
    }
     ...
     */
    public GetLatestTransactionListRequest(GetLatestTransactionListRequest source) {
