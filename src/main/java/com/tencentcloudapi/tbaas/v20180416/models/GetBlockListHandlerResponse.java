...
public class GetBlockListHandlerResponse extends AbstractModel{
    ...
    */
     ...
     * @param List 返回数据列表
     */
    public void setList(BcosBlockObj [] List) {
        this.List = List;
    }
    ...
    public GetBlockListHandlerResponse() {
    }
     ...
     */
    public GetBlockListHandlerResponse(GetBlockListHandlerResponse source) {
