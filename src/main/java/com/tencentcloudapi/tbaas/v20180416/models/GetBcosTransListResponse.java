...
public class GetBcosTransListResponse extends AbstractModel{
    ...
    */
    ...
    public GetBcosTransListResponse() {
    }
     ...
     */
    public GetBcosTransListResponse(GetBcosTransListResponse source) {
