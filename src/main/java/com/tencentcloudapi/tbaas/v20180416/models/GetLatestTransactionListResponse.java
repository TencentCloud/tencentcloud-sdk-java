...
public class GetLatestTransactionListResponse extends AbstractModel{
    ...
    */
    ...
    public GetLatestTransactionListResponse() {
    }
     ...
     */
    public GetLatestTransactionListResponse(GetLatestTransactionListResponse source) {
