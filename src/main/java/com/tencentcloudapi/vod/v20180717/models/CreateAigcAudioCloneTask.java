...
public class CreateAigcAudioCloneTask extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>AIGC 音频复刻任务的输入信息。</p> 
     * @return Input <p>AIGC 音频复刻任务的输入信息。</p>
     */
    ...
    /**
     * Set <p>AIGC 音频复刻任务的输入信息。</p>
     * @param Input <p>AIGC 音频复刻任务的输入信息。</p>
     */
    ...
    /**
     * Get <p>AIGC 音频复刻任务的输出信息。</p> 
     * @return Output <p>AIGC 音频复刻任务的输出信息。</p>
     */
    ...
    /**
     * Set <p>AIGC 音频复刻任务的输出信息。</p>
     * @param Output <p>AIGC 音频复刻任务的输出信息。</p>
     */
