...
public class ModifyBlindWatermarkTemplateRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 数字水印模板名称，支持 中文、英文、数字、_、-和. 六种格式，长度限制：64 个字符。 
    ...
    /**
     * Set 数字水印模板名称，支持 中文、英文、数字、_、-和. 六种格式，长度限制：64 个字符。
    ...
    /**
     * Get 数字水印文字内容，长度不超过64个字符，NAGRA水印类型的模板不支持修改文字内容。 
    ...
    /**
     * Set 数字水印文字内容，长度不超过64个字符，NAGRA水印类型的模板不支持修改文字内容。
