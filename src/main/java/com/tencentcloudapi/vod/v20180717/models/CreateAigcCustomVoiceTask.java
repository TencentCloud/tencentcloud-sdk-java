...
public class CreateAigcCustomVoiceTask extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>创建 AIGC 自定义音色输入信息。</p>
     * @param Input <p>创建 AIGC 自定义音色输入信息。</p>
     */
    ...
    /**
     * Set <p>创建 AIGC 自定义音色输出信息。</p>
     * @param Output <p>创建 AIGC 自定义音色输出信息。</p>
     */
