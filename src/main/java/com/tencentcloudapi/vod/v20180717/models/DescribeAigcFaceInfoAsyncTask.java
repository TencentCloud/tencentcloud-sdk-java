...
public class DescribeAigcFaceInfoAsyncTask extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul> 
     * @return ErrCodeExt <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
     */
    ...
    /**
     * Set <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
     * @param ErrCodeExt <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
     */
    ...
    /**
     * Get <p>异步获取 AIGC 人脸信息任务的输入信息。</p> 
     * @return Input <p>异步获取 AIGC 人脸信息任务的输入信息。</p>
     */
    ...
    /**
     * Set <p>异步获取 AIGC 人脸信息任务的输入信息。</p>
     * @param Input <p>异步获取 AIGC 人脸信息任务的输入信息。</p>
     */
    ...
    /**
     * Get <p>异步获取 AIGC 人脸信息任务的输出信息。</p> 
     * @return Output <p>异步获取 AIGC 人脸信息任务的输出信息。</p>
     */
    ...
    /**
     * Set <p>异步获取 AIGC 人脸信息任务的输出信息。</p>
     * @param Output <p>异步获取 AIGC 人脸信息任务的输出信息。</p>
     */
