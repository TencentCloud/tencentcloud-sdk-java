...
public class AigcAudioReferenceVideoInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>视频文件的媒体文件 ID，即该文件在云点播上的全局唯一标识符，在上传成功后由云点播后台分配。可以在 <a href="/document/product/266/7830">视频上传完成事件通知</a> 或 <a href="https://console.cloud.tencent.com/vod/media">云点播控制台</a> 获取该字段。当 Type 取值为 File 时，本参数有效。</p> 
     * @return FileId <p>视频文件的媒体文件 ID，即该文件在云点播上的全局唯一标识符，在上传成功后由云点播后台分配。可以在 <a href="/document/product/266/7830">视频上传完成事件通知</a> 或 <a href="https://console.cloud.tencent.com/vod/media">云点播控制台</a> 获取该字段。当 Type 取值为 File 时，本参数有效。</p>
     */
    ...
    /**
     * Set <p>视频文件的媒体文件 ID，即该文件在云点播上的全局唯一标识符，在上传成功后由云点播后台分配。可以在 <a href="/document/product/266/7830">视频上传完成事件通知</a> 或 <a href="https://console.cloud.tencent.com/vod/media">云点播控制台</a> 获取该字段。当 Type 取值为 File 时，本参数有效。</p>
    ...
    /**
     * Get <p>参考视频URL，需要外网可访问。当 Type 取值为 Url 时，本参数有效。</p> 
     * @return Url <p>参考视频URL，需要外网可访问。当 Type 取值为 Url 时，本参数有效。</p>
     */
    ...
    /**
     * Set <p>参考视频URL，需要外网可访问。当 Type 取值为 Url 时，本参数有效。</p>
