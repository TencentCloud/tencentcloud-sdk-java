...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get 音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。 
    ...
    /**
     * Set 音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
