...
<li>OCR：画面上的文字。</li>
    ...
    /**
     * Get 嫌疑人物、图标或文字出现的区域坐标 (像素级)，[x1, y1, x2, y2]，即左上角坐标、右下角坐标。 
    ...
    /**
     * Set 嫌疑人物、图标或文字出现的区域坐标 (像素级)，[x1, y1, x2, y2]，即左上角坐标、右下角坐标。
    ...
    /**
     * Get 当 Form 为 OCR 时有效，表示识别出来的 OCR 文本内容。 
    ...
    /**
     * Set 当 Form 为 OCR 时有效，表示识别出来的 OCR 文本内容。
    ...
    /**
     * Get 当 Form 为 OCR 时有效，表示嫌疑片段命中的违规关键词列表。 
    ...
    /**
     * Set 当 Form 为 OCR 时有效，表示嫌疑片段命中的违规关键词列表。
