...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>AIGC 视频转绘信息，仅当 TaskType 为 AigcVideoRedrawTask，该字段有值。</p> 
     * @return AigcVideoRedrawTask <p>AIGC 视频转绘信息，仅当 TaskType 为 AigcVideoRedrawTask，该字段有值。</p>
     */
    ...
    /**
     * Set <p>AIGC 视频转绘信息，仅当 TaskType 为 AigcVideoRedrawTask，该字段有值。</p>
     * @param AigcVideoRedrawTask <p>AIGC 视频转绘信息，仅当 TaskType 为 AigcVideoRedrawTask，该字段有值。</p>
     */
    ...
    /**
     * Get <p>AIGC音效信息，仅当 TaskType 为 AigcAudioTask，该字段有值。</p> 
     * @return AigcAudioTask <p>AIGC音效信息，仅当 TaskType 为 AigcAudioTask，该字段有值。</p>
     */
    ...
    /**
     * Set <p>AIGC音效信息，仅当 TaskType 为 AigcAudioTask，该字段有值。</p>
     * @param AigcAudioTask <p>AIGC音效信息，仅当 TaskType 为 AigcAudioTask，该字段有值。</p>
     */
    ...
    /**
     * Get <p>AIGC 声音复刻信息，仅当 TaskType 为 CreateAigcAudioClone，该字段有值。</p> 
     * @return CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为 CreateAigcAudioClone，该字段有值。</p>
     */
    ...
    /**
     * Set <p>AIGC 声音复刻信息，仅当 TaskType 为 CreateAigcAudioClone，该字段有值。</p>
     * @param CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为 CreateAigcAudioClone，该字段有值。</p>
     */
    ...
    /**
     * Get <p>异步获取 AIGC 人脸信息，仅当 TaskType 为 DescribeAigcFaceInfoAsync，该字段有值。</p> 
     * @return DescribeAigcFaceInfoAsyncTask <p>异步获取 AIGC 人脸信息，仅当 TaskType 为 DescribeAigcFaceInfoAsync，该字段有值。</p>
     */
    ...
    /**
     * Set <p>异步获取 AIGC 人脸信息，仅当 TaskType 为 DescribeAigcFaceInfoAsync，该字段有值。</p>
     * @param DescribeAigcFaceInfoAsyncTask <p>异步获取 AIGC 人脸信息，仅当 TaskType 为 DescribeAigcFaceInfoAsync，该字段有值。</p>
     */
    ...
    /**
     * Get <p>混元 3D 任务，仅当 TaskType 为 AigcHunyuan3DTask，该字段有值。</p> 
    ...
    /**
     * Set <p>混元 3D 任务，仅当 TaskType 为 AigcHunyuan3DTask，该字段有值。</p>
     * @param AigcHunyuan3DTask <p>混元 3D 任务，仅当 TaskType 为 AigcHunyuan3DTask，该字段有值。</p>
     */
    ...
    /**
     * Get <p>音色设计，仅当 TaskType 为 DesignVoiceAsync，该字段有值。</p> 
    ...
    /**
     * Set <p>音色设计，仅当 TaskType 为 DesignVoiceAsync，该字段有值。</p>
     * @param DesignVoiceAsyncTask <p>音色设计，仅当 TaskType 为 DesignVoiceAsync，该字段有值。</p>
     */
    ...
    /**
     * Get <p>音色克隆，仅当 TaskType 为 CloneVoiceAsync，该字段有值。</p> 
    ...
    /**
     * Set <p>音色克隆，仅当 TaskType 为 CloneVoiceAsync，该字段有值。</p>
     * @param CloneVoiceAsyncTask <p>音色克隆，仅当 TaskType 为 CloneVoiceAsync，该字段有值。</p>
     */
    ...
    /**
     * Get <p>语音合成，仅当 TaskType 为 TextToSpeechAsync，该字段有值。</p> 
    ...
    /**
     * Set <p>语音合成，仅当 TaskType 为 TextToSpeechAsync，该字段有值。</p>
     * @param TextToSpeechAsyncTask <p>语音合成，仅当 TaskType 为 TextToSpeechAsync，该字段有值。</p>
     */
    ...
    /**
     * Get <p>视频翻译配音，仅当 TaskType 为VideoDubbingAsync，该字段有值。</p> 
    ...
    /**
     * Set <p>视频翻译配音，仅当 TaskType 为VideoDubbingAsync，该字段有值。</p>
     * @param VideoDubbingAsyncTask <p>视频翻译配音，仅当 TaskType 为VideoDubbingAsync，该字段有值。</p>
     */
