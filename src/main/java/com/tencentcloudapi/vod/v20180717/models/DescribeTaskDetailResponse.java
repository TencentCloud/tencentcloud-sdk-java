...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p> 
    ...
    /**
     * Set <p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
     * @param AigcVideoRedrawTask <p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
     */
    ...
    /**
     * Get <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p> 
     * @return AigcAudioTask <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
     */
    ...
    /**
     * Set <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
     * @param AigcAudioTask <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
     */
    ...
    /**
     * Get <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p> 
     * @return CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
     */
    ...
    /**
     * Set <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
     * @param CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
     */
