...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get 对视频按指定时间点截图任务进度，取值范围 [0-100] 。 
    ...
    /**
     * Set 对视频按指定时间点截图任务进度，取值范围 [0-100] 。
    ...
    /**
     * Get 时间点截图任务开始执行的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。 
    ...
    /**
     * Set 时间点截图任务开始执行的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
    ...
    /**
     * Get 时间点截图任务执行完毕的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。 
    ...
    /**
     * Set 时间点截图任务执行完毕的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
