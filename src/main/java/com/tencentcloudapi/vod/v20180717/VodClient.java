...
- 对具体事件服务的通知事件选择设置接收或者忽略。
     * @param req ModifyEventNotificationConfigForConsoleRequest
     * @return ModifyEventNotificationConfigForConsoleResponse
     * @throws TencentCloudSDKException
     */
    public ModifyEventNotificationConfigForConsoleResponse ModifyEventNotificationConfigForConsole(ModifyEventNotificationConfigForConsoleRequest req) throws TencentCloudSDKException{
        JsonResponseModel<ModifyEventNotificationConfigForConsoleResponse> rsp = null;
        try {
                Type type = new TypeToken<JsonResponseModel<ModifyEventNotificationConfigForConsoleResponse>>() {
                }.getType();
                rsp  = gson.fromJson(this.internalRequest(req, "ModifyEventNotificationConfigForConsole"), type);
        } catch (JsonSyntaxException e) {
            throw new TencentCloudSDKException(e.getMessage());
        }
        return rsp.response;
