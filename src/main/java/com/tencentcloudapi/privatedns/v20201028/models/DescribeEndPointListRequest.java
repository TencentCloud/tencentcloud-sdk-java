...
public class DescribeEndPointListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip 
     * @return Filters 过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
     */
    ...
    /**
     * Set 过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
