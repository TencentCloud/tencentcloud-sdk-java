...
public class InputDescribeNameListDetail extends AbstractModel {
    ...
    */
    ...
    public InputDescribeNameListDetail() {
    }
     ...
     */
    public InputDescribeNameListDetail(InputDescribeNameListDetail source) {
