...
public class DeleteNameListDataRequest extends AbstractModel {
    ...
    */
     ...
     */
    public void setBusinessSecurityData(InputDeleteNameListData BusinessSecurityData) {
     ...
     */
    public DeleteNameListDataRequest(DeleteNameListDataRequest source) {
        if (source.BusinessSecurityData != null) {
            this.BusinessSecurityData = new InputDeleteNameListData(source.BusinessSecurityData);
        }
    }
