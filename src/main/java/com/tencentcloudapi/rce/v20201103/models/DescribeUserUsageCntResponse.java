...
public class DescribeUserUsageCntResponse extends AbstractModel {
    ...
    */
     ...
     * @param Data 业务出参
     */
    public void setData(OutputDescribeUserUsageCntData Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeUserUsageCntResponse(DescribeUserUsageCntResponse source) {
        if (source.Data != null) {
            this.Data = new OutputDescribeUserUsageCntData(source.Data);
        }
