...
import com.tencentcloudapi.rce.v20250425.models.*;
...
public class RceClient extends AbstractClient{
    ...
    private static String version = "2025-04-25";
     ...
     * @return ManageIPPortraitRiskResponse
     * @throws TencentCloudSDKException
     */
    public ManageIPPortraitRiskResponse ManageIPPortraitRisk(ManageIPPortraitRiskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ManageIPPortraitRisk", ManageIPPortraitRiskResponse.class);
    }
