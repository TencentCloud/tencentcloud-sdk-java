...
public class DescribeKTVMusicsByTagResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeKTVMusicsByTagResponse() {
    }
     ...
     */
    public DescribeKTVMusicsByTagResponse(DescribeKTVMusicsByTagResponse source) {
