...
public class QueryCrmStatisticsResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private CrmStatisticsData [] PageData;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public CrmStatisticsData [] getPageData() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setPageData(CrmStatisticsData [] PageData) {
    ...
    public QueryCrmStatisticsResponse() {
    }
     ...
     */
    public QueryCrmStatisticsResponse(QueryCrmStatisticsResponse source) {
        if (source.NextCursor != null) {
            this.NextCursor = new String(source.NextCursor);
        }
        if (source.PageData != null) {
            this.PageData = new CrmStatisticsData[source.PageData.length];
            for (int i = 0; i < source.PageData.length; i++) {
                this.PageData[i] = new CrmStatisticsData(source.PageData[i]);
            }
        }
