...
public class QueryChannelCodeListRequest extends AbstractModel{
    ...
    */
    ...
    public QueryChannelCodeListRequest() {
    }
     ...
     */
    public QueryChannelCodeListRequest(QueryChannelCodeListRequest source) {
