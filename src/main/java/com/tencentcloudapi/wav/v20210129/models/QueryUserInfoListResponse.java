...
public class QueryUserInfoListResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public CorpUserInfo [] getPageData() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setPageData(CorpUserInfo [] PageData) {
    ...
    public QueryUserInfoListResponse() {
    }
     ...
     */
    public QueryUserInfoListResponse(QueryUserInfoListResponse source) {
        if (source.NextCursor != null) {
            this.NextCursor = new String(source.NextCursor);
        }
        if (source.PageData != null) {
            this.PageData = new CorpUserInfo[source.PageData.length];
            for (int i = 0; i < source.PageData.length; i++) {
                this.PageData[i] = new CorpUserInfo(source.PageData[i]);
            }
        }
