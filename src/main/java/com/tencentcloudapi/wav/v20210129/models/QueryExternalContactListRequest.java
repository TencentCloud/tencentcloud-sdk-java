...
public class QueryExternalContactListRequest extends AbstractModel{
    ...
    */
    ...
    public QueryExternalContactListRequest() {
    }
     ...
     */
    public QueryExternalContactListRequest(QueryExternalContactListRequest source) {
