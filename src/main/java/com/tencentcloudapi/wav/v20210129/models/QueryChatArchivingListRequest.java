...
public class QueryChatArchivingListRequest extends AbstractModel{
    ...
    */
    ...
    public QueryChatArchivingListRequest() {
    }
     ...
     */
    public QueryChatArchivingListRequest(QueryChatArchivingListRequest source) {
