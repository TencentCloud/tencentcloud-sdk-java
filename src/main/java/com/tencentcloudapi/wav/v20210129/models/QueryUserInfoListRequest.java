...
public class QueryUserInfoListRequest extends AbstractModel{
    ...
    */
    ...
    public QueryUserInfoListRequest() {
    }
     ...
     */
    public QueryUserInfoListRequest(QueryUserInfoListRequest source) {
