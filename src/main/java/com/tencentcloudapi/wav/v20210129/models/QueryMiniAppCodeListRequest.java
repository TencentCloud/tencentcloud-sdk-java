...
public class QueryMiniAppCodeListRequest extends AbstractModel{
    ...
    */
    ...
    public QueryMiniAppCodeListRequest() {
    }
     ...
     */
    public QueryMiniAppCodeListRequest(QueryMiniAppCodeListRequest source) {
