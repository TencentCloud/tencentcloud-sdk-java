...
public class QueryVehicleInfoListRequest extends AbstractModel {
    ...
    */
    ...
    public QueryVehicleInfoListRequest() {
    }
     ...
     */
    public QueryVehicleInfoListRequest(QueryVehicleInfoListRequest source) {
