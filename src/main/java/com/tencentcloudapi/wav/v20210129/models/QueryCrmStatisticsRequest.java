...
public class QueryCrmStatisticsRequest extends AbstractModel{
    ...
    */
    ...
    public QueryCrmStatisticsRequest() {
    }
     ...
     */
    public QueryCrmStatisticsRequest(QueryCrmStatisticsRequest source) {
