...
public class DescribeAccountWarningResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeAccountWarningResponse() {
    }
     ...
     */
    public DescribeAccountWarningResponse(DescribeAccountWarningResponse source) {
        if (source.Threshold != null) {
            this.Threshold = new String(source.Threshold);
        }
        if (source.Open != null) {
            this.Open = new String(source.Open);
        }
