...
public class DescribeProcessDaemonGlobalConfResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>是否开启进程防护 0 否 1 是 9 未设置,和0一样是未开启</p> 
     * @return Enable <p>是否开启进程防护 0 否 1 是 9 未设置,和0一样是未开启</p>
     */
    ...
    /**
     * Set <p>是否开启进程防护 0 否 1 是 9 未设置,和0一样是未开启</p>
     * @param Enable <p>是否开启进程防护 0 否 1 是 9 未设置,和0一样是未开启</p>
     */
    ...
    /**
     * Set <p>正选主机数</p>
     * @param IncludeHostCount <p>正选主机数</p>
     */
    ...
    /**
     * Set <p>反选主机数</p>
     * @param ExcludeHostCount <p>反选主机数</p>
     */
    ...
    /**
     * Set <p>正选quuid列表</p>
     * @param IncludeQuuid <p>正选quuid列表</p>
     */
    ...
    /**
     * Set <p>反选quuid列表</p>
     * @param ExcludeQuuid <p>反选quuid列表</p>
     */
