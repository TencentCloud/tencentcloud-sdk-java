...
public class DescribeAIScheduleTaskDetailRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>任务 ID。可通过 DescribeAIScheduleTaskList 接口获取。</p> 
    ...
    /**
     * Set <p>任务 ID。可通过 DescribeAIScheduleTaskList 接口获取。</p>
     * @param TaskId <p>任务 ID。可通过 DescribeAIScheduleTaskList 接口获取。</p>
     */
