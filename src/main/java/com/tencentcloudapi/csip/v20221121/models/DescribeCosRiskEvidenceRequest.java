...
public class DescribeCosRiskEvidenceRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCosRiskEvidenceRequest() {
    }
     ...
     */
    public DescribeCosRiskEvidenceRequest(DescribeCosRiskEvidenceRequest source) {
