...
public class DescribeCspmShardConfigResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>共享配额来源appid</p>
     * @param ShardFromAppID <p>共享配额来源appid</p>
     */
    ...
    /**
     * Set <p>自动共享开关状态</p>
     * @param AutoShardStatus <p>自动共享开关状态</p>
     */
    ...
    /**
     * Set <p>已被共享配额的目标appid列表</p>
     * @param ShardAppIDs <p>已被共享配额的目标appid列表</p>
     */
