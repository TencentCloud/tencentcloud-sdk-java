...
public class DescribeCosInvokeUaRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCosInvokeUaRequest() {
    }
     ...
     */
    public DescribeCosInvokeUaRequest(DescribeCosInvokeUaRequest source) {
