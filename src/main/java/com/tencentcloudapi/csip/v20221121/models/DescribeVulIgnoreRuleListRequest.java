...
public class DescribeVulIgnoreRuleListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>过滤条件，支持以下 Name：</p><li>Keyword - 漏洞名/备注，模糊匹配</li><li>Switch - 开关状态，过滤值：0（关闭）/ 1（开启）</li> 
    ...
    /**
     * Set <p>过滤条件，支持以下 Name：</p><li>Keyword - 漏洞名/备注，模糊匹配</li><li>Switch - 开关状态，过滤值：0（关闭）/ 1（开启）</li>
    ...
    /**
     * Get <p>排序字段，默认按更新时间（UpdateTime）排序</p> 
    ...
    /**
     * Set <p>排序字段，默认按更新时间（UpdateTime）排序</p>
