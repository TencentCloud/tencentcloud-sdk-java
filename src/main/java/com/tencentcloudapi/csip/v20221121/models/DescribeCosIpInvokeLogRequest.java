...
public class DescribeCosIpInvokeLogRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCosIpInvokeLogRequest() {
    }
     ...
     */
    public DescribeCosIpInvokeLogRequest(DescribeCosIpInvokeLogRequest source) {
