...
public class DeleteIntentRouterRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteIntentRouterRequest() {
    }
     ...
     */
    public DeleteIntentRouterRequest(DeleteIntentRouterRequest source) {
