...
public class RateLimitConfigForBudget extends AbstractModel {
    ...
    */
    ...
    public RateLimitConfigForBudget() {
    }
     ...
     */
    public RateLimitConfigForBudget(RateLimitConfigForBudget source) {
        if (source.RPM != null) {
