...
public class CreateModelResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>服务供应商ID</p> 
     * @return ServiceProviderId <p>服务供应商ID</p>
     */
    ...
    /**
     * Get <p>生成的 Key ID 列表</p> 
     * @return KeyIds <p>生成的 Key ID 列表</p>
     */
     ...
     */
    public CreateModelResponse(CreateModelResponse source) {
