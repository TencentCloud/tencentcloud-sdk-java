...
public class CreateModelRouterResponse extends AbstractModel {
    ...
    */
    ...
    public CreateModelRouterResponse() {
    }
     ...
     */
    public CreateModelRouterResponse(CreateModelRouterResponse source) {
