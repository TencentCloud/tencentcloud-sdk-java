...
public class AssociatedModelRouterItem extends AbstractModel {
    ...
    */
    ...
    public AssociatedModelRouterItem() {
    }
     ...
     */
    public AssociatedModelRouterItem(AssociatedModelRouterItem source) {
