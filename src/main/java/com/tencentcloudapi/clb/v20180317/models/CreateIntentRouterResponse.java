...
public class CreateIntentRouterResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>创建的意图路由ID（ir-xxx格式）。</p> 
     * @return IntentRouterId <p>创建的意图路由ID（ir-xxx格式）。</p>
     */
    ...
    public CreateIntentRouterResponse() {
    }
     ...
     */
    public CreateIntentRouterResponse(CreateIntentRouterResponse source) {
