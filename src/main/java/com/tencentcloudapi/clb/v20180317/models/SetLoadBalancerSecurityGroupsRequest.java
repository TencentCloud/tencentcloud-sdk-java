...
public class SetLoadBalancerSecurityGroupsRequest  extends AbstractModel{
    ...
    */
    ...
    /**
     * 获取安全组ID构成的数组，一个负载均衡实例最多关联50个安全组，如果要解绑所有安全组，可不传此参数。
     * @return SecurityGroups 安全组ID构成的数组，一个负载均衡实例最多关联50个安全组，如果要解绑所有安全组，可不传此参数。
     */
    ...
    /**
     * 设置安全组ID构成的数组，一个负载均衡实例最多关联50个安全组，如果要解绑所有安全组，可不传此参数。
