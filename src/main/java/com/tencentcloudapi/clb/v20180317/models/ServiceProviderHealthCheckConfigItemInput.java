...
public class ServiceProviderHealthCheckConfigItemInput extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>健康检查间隔。支持以300s为步长配置。</p><p>取值范围：[300, 14400]</p><p>单位：s</p><p>默认值：300</p> 
    ...
    /**
     * Set <p>健康检查间隔。支持以300s为步长配置。</p><p>取值范围：[300, 14400]</p><p>单位：s</p><p>默认值：300</p>
    ...
    /**
     * Get <p>不健康阈值。表示当模型连续多少次不健康时认为该模型不健康。</p><p>取值范围：[1, 10]</p> 
    ...
    /**
     * Set <p>不健康阈值。表示当模型连续多少次不健康时认为该模型不健康。</p><p>取值范围：[1, 10]</p>
    ...
    /**
     * Get <p>健康检查使用的最大Token数量。部分模型如gpt系列可能仅支持大于等于16。</p><p>取值范围：[1, 1024]</p><p>默认值：1</p> 
    ...
    /**
     * Set <p>健康检查使用的最大Token数量。部分模型如gpt系列可能仅支持大于等于16。</p><p>取值范围：[1, 1024]</p><p>默认值：1</p>
     ...
     */
    public ServiceProviderHealthCheckConfigItemInput(ServiceProviderHealthCheckConfigItemInput source) {
