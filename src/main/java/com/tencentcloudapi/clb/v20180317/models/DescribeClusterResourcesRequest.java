...
<li> idle - String 是否必填：否 - （过滤条件）按照是否闲置过滤，如"True","False"。</li>
    */
    ...
    /**
     * Get 返回集群中资源列表数目，默认20，最大值100 
     * @return Limit 返回集群中资源列表数目，默认20，最大值100
     */
    ...
    /**
     * Get 返回集群中资源列表起始偏移量，默认0 
     * @return Offset 返回集群中资源列表起始偏移量，默认0
     */
