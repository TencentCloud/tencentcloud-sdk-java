...
public class RefundModelRouterResourcePackageRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>待退还的模型路由资源包Id</p><p>非有效状态或者设置了自动续订且自动续订已生效的资源包不允许退款。</p> 
    ...
    /**
     * Set <p>待退还的模型路由资源包Id</p><p>非有效状态或者设置了自动续订且自动续订已生效的资源包不允许退款。</p>
    ...
    public RefundModelRouterResourcePackageRequest() {
    }
     ...
     */
    public RefundModelRouterResourcePackageRequest(RefundModelRouterResourcePackageRequest source) {
