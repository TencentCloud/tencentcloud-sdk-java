...
public class DescribeServiceProviderHealthStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>本次查询的限制数量</p><p>取值范围：[1, 100]</p><p>默认值：20</p> 
    ...
    /**
     * Set <p>本次查询的限制数量</p><p>取值范围：[1, 100]</p><p>默认值：20</p>
    ...
    public DescribeServiceProviderHealthStatusRequest() {
    }
     ...
     */
    public DescribeServiceProviderHealthStatusRequest(DescribeServiceProviderHealthStatusRequest source) {
