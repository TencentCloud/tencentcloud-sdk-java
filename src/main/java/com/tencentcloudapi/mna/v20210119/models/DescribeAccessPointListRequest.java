...
public class DescribeAccessPointListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAccessPointListRequest() {
    }
     ...
     */
    public DescribeAccessPointListRequest(DescribeAccessPointListRequest source) {
