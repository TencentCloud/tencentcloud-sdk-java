...
public class DescribeCustomCategoriesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setCategorySet(CustomCategory [] CategorySet) {
     ...
     */
    public DescribeCustomCategoriesResponse(DescribeCustomCategoriesResponse source) {
        if (source.CategorySet != null) {
            this.CategorySet = new CustomCategory[source.CategorySet.length];
            for (int i = 0; i < source.CategorySet.length; i++) {
                this.CategorySet[i] = new CustomCategory(source.CategorySet[i]);
            }
        }
