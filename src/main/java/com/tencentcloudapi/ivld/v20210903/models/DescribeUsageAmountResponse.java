...
public class DescribeUsageAmountResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeUsageAmountResponse(DescribeUsageAmountResponse source) {
        if (source.UsedHours != null) {
            this.UsedHours = new Float(source.UsedHours);
        }
        if (source.TotalHours != null) {
            this.TotalHours = new Float(source.TotalHours);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "UsedHours", this.UsedHours);
        this.setParamSimple(map, prefix + "TotalHours", this.TotalHours);
