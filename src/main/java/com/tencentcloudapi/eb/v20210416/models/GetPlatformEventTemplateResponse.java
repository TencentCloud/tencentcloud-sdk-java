...
public class GetPlatformEventTemplateResponse extends AbstractModel {
    ...
    */
     ...
     */
    public GetPlatformEventTemplateResponse(GetPlatformEventTemplateResponse source) {
        if (source.EventTemplate != null) {
            this.EventTemplate = new String(source.EventTemplate);
        }
