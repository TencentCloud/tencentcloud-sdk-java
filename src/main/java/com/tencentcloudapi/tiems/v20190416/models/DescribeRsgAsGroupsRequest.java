...
public class DescribeRsgAsGroupsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeRsgAsGroupsRequest() {
    }
     ...
     */
    public DescribeRsgAsGroupsRequest(DescribeRsgAsGroupsRequest source) {
