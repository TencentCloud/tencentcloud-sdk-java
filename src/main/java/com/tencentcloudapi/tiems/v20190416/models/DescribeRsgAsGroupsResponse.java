...
public class DescribeRsgAsGroupsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeRsgAsGroupsResponse() {
    }
     ...
     */
    public DescribeRsgAsGroupsResponse(DescribeRsgAsGroupsResponse source) {
        if (source.RsgAsGroupSet != null) {
            this.RsgAsGroupSet = new RsgAsGroup[source.RsgAsGroupSet.length];
            for (int i = 0; i < source.RsgAsGroupSet.length; i++) {
                this.RsgAsGroupSet[i] = new RsgAsGroup(source.RsgAsGroupSet[i]);
            }
        }
