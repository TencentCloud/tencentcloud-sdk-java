...
public class CreateServiceConfigResponse extends AbstractModel{
    ...
    */
    ...
    public CreateServiceConfigResponse() {
    }
     ...
     */
    public CreateServiceConfigResponse(CreateServiceConfigResponse source) {
        if (source.ServiceConfig != null) {
            this.ServiceConfig = new Config(source.ServiceConfig);
        }
