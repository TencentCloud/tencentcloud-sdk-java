...
public class CancelEncryptTaskRequest extends AbstractModel{
    ...
    */
    ...
    public CancelEncryptTaskRequest() {
    }
     ...
     */
    public CancelEncryptTaskRequest(CancelEncryptTaskRequest source) {
