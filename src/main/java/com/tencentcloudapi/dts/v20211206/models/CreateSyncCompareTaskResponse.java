...
public class CreateSyncCompareTaskResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    /**
     * Get 数据对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
注意：此字段可能返回 null，表示取不到有效值。 
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set 数据对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public CreateSyncCompareTaskResponse() {
    }
     ...
     */
    public CreateSyncCompareTaskResponse(CreateSyncCompareTaskResponse source) {
