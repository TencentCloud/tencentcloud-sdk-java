...
public class ModifySyncCompareTaskRequest extends AbstractModel {
    ...
    */
    ...
    public ModifySyncCompareTaskRequest() {
    }
     ...
     */
    public ModifySyncCompareTaskRequest(ModifySyncCompareTaskRequest source) {
