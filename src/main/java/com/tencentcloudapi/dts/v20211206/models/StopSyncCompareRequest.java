...
public class StopSyncCompareRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9 
    ...
    /**
     * Set 对比任务 ID，形如：sync-8yv4w2i1-cmp-37skmii9
    ...
    /**
     * Get 是否强制停止。如果填true，迁移任务增量阶段会跳过一致性校验产生的binlog，达到快速恢复任务的效果 
    ...
    /**
     * Set 是否强制停止。如果填true，迁移任务增量阶段会跳过一致性校验产生的binlog，达到快速恢复任务的效果
     ...
     */
    public StopSyncCompareRequest(StopSyncCompareRequest source) {
