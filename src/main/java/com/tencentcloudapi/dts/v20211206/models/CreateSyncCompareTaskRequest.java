...
public class CreateSyncCompareTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 对比对象，当ObjectMode值为custom时，此项需要填写 
    ...
    /**
     * Set 对比对象，当ObjectMode值为custom时，此项需要填写
    ...
    public CreateSyncCompareTaskRequest() {
    }
     ...
     */
    public CreateSyncCompareTaskRequest(CreateSyncCompareTaskRequest source) {
