...
public class DeleteSyncCompareTaskRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteSyncCompareTaskRequest() {
    }
     ...
     */
    public DeleteSyncCompareTaskRequest(DeleteSyncCompareTaskRequest source) {
