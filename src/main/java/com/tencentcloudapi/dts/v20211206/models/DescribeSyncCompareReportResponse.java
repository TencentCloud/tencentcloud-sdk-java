...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    @Expose
    private IncCompareAbstractInfo IncAbstract;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeSyncCompareReportResponse() {
    }
     ...
     */
    public DescribeSyncCompareReportResponse(DescribeSyncCompareReportResponse source) {
        ...
        if (source.IncAbstract != null) {
            this.IncAbstract = new IncCompareAbstractInfo(source.IncAbstract);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamObj(map, prefix + "IncAbstract.", this.IncAbstract);
