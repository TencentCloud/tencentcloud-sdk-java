...
public class IsolateMemoryPlusSpaceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>指定需要放入回收站的 Memory 实例 ID 列表。</p> 
    ...
    /**
     * Set <p>指定需要放入回收站的 Memory 实例 ID 列表。</p>
    ...
    public IsolateMemoryPlusSpaceRequest() {
    }
     ...
     */
    public IsolateMemoryPlusSpaceRequest(IsolateMemoryPlusSpaceRequest source) {
