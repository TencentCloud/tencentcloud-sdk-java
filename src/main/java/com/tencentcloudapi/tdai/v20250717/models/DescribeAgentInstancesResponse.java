...
public class DescribeAgentInstancesResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeAgentInstancesResponse() {
    }
     ...
     */
    public DescribeAgentInstancesResponse(DescribeAgentInstancesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Items != null) {
            this.Items = new AgentInstance[source.Items.length];
