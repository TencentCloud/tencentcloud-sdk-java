...
public class IsolateAgentInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public IsolateAgentInstanceRequest() {
    }
     ...
     */
    public IsolateAgentInstanceRequest(IsolateAgentInstanceRequest source) {
