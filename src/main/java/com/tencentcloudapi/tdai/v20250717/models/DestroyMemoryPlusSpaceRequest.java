...
public class DestroyMemoryPlusSpaceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>指定需要销毁的 Memory 实例 ID 列表。</p> 
    ...
    /**
     * Set <p>指定需要销毁的 Memory 实例 ID 列表。</p>
    ...
    public DestroyMemoryPlusSpaceRequest() {
    }
     ...
     */
    public DestroyMemoryPlusSpaceRequest(DestroyMemoryPlusSpaceRequest source) {
