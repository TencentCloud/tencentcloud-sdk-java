...
public class DescribeAgentInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAgentInstanceRequest() {
    }
     ...
     */
    public DescribeAgentInstanceRequest(DescribeAgentInstanceRequest source) {
