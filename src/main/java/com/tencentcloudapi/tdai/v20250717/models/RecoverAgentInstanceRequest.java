...
public class RecoverAgentInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public RecoverAgentInstanceRequest() {
    }
     ...
     */
    public RecoverAgentInstanceRequest(RecoverAgentInstanceRequest source) {
