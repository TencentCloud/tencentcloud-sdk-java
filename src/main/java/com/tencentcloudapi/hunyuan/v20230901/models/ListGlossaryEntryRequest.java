...
public class ListGlossaryEntryRequest extends AbstractModel {
    ...
    */
    ...
    public ListGlossaryEntryRequest() {
    }
     ...
     */
    public ListGlossaryEntryRequest(ListGlossaryEntryRequest source) {
