...
public class CreateGlossaryEntryRequest extends AbstractModel {
    ...
    */
    ...
    @Expose
    private GlossaryEntryCreateItem [] Entries;
    ...
    /**
     * Get 术语条目列表，单次请求限制100个 
     * @return Entries 术语条目列表，单次请求限制100个
     */
    public GlossaryEntryCreateItem [] getEntries() {
        return this.Entries;
    }

    /**
     * Set 术语条目列表，单次请求限制100个
     * @param Entries 术语条目列表，单次请求限制100个
     */
    public void setEntries(GlossaryEntryCreateItem [] Entries) {
     ...
     */
    public CreateGlossaryEntryRequest(CreateGlossaryEntryRequest source) {
        if (source.GlossaryId != null) {
            this.GlossaryId = new String(source.GlossaryId);
        }
        if (source.Entries != null) {
            this.Entries = new GlossaryEntryCreateItem[source.Entries.length];
            for (int i = 0; i < source.Entries.length; i++) {
                this.Entries[i] = new GlossaryEntryCreateItem(source.Entries[i]);
            }
        }
    }
