...
public class GetThreadMessageResponse extends SSEResponseModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public GetThreadMessageResponse() {
    }
     ...
     */
    public GetThreadMessageResponse(GetThreadMessageResponse source) {
        if (source.ID != null) {
