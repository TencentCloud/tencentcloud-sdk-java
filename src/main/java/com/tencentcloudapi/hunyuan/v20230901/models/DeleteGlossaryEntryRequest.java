...
public class DeleteGlossaryEntryRequest extends AbstractModel {
    ...
    */
    ...
    @Expose
    private GlossaryEntryDeleteItem [] Entries;
     ...
     */
    public GlossaryEntryDeleteItem [] getEntries() {
        return this.Entries;
    }
     ...
     */
    public void setEntries(GlossaryEntryDeleteItem [] Entries) {
     ...
     */
    public DeleteGlossaryEntryRequest(DeleteGlossaryEntryRequest source) {
        if (source.GlossaryId != null) {
            this.GlossaryId = new String(source.GlossaryId);
        }
        if (source.Entries != null) {
            this.Entries = new GlossaryEntryDeleteItem[source.Entries.length];
            for (int i = 0; i < source.Entries.length; i++) {
                this.Entries[i] = new GlossaryEntryDeleteItem(source.Entries[i]);
            }
        }
    }
