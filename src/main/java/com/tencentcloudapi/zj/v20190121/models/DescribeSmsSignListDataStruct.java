...
public class DescribeSmsSignListDataStruct extends AbstractModel{
...
-1：表示审核未通过或审核失败。
    ...
    public DescribeSmsSignListDataStruct() {
    }
     ...
     */
    public DescribeSmsSignListDataStruct(DescribeSmsSignListDataStruct source) {
