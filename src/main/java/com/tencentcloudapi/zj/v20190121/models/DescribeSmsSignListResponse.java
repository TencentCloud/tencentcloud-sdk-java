...
public class DescribeSmsSignListResponse extends AbstractModel{
    ...
    */
     ...
     * @param Data 返回数据
     */
    public void setData(DescribeSmsSignListDataStruct [] Data) {
        this.Data = Data;
    }
    ...
    public DescribeSmsSignListResponse(DescribeSmsSignListResponse source) {
        if (source.Data != null) {
            this.Data = new DescribeSmsSignListDataStruct[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new DescribeSmsSignListDataStruct(source.Data[i]);
            }
        }
