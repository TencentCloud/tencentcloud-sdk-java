...
public class GetCrowdPackListResponse extends AbstractModel{
    ...
    */
     ...
     * @param Data 人群包信息列表
     */
    public void setData(SmsGetCrowdPackListResponse Data) {
        this.Data = Data;
    }
     ...
     */
    public GetCrowdPackListResponse(GetCrowdPackListResponse source) {
        if (source.Data != null) {
            this.Data = new SmsGetCrowdPackListResponse(source.Data);
        }
