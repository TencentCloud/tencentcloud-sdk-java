...
public class DescribeDeviceGroupsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeDeviceGroupsResponse() {
    }
     ...
     */
    public DescribeDeviceGroupsResponse(DescribeDeviceGroupsResponse source) {
