...
public class DescribeSmpnMrlRequest extends AbstractModel{
    ...
    */
     ...
     */
    public void setRequestData(MRLRequest RequestData) {
     ...
     */
    public DescribeSmpnMrlRequest(DescribeSmpnMrlRequest source) {
        if (source.RequestData != null) {
            this.RequestData = new MRLRequest(source.RequestData);
        }
