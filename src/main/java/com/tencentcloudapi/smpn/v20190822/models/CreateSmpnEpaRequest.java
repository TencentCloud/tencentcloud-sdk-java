...
public class CreateSmpnEpaRequest extends AbstractModel{
    ...
    */
     ...
     */
    public void setRequestData(EPARequest RequestData) {
     ...
     */
    public CreateSmpnEpaRequest(CreateSmpnEpaRequest source) {
        if (source.RequestData != null) {
            this.RequestData = new EPARequest(source.RequestData);
        }
