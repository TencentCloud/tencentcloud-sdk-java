...
public class DescribeEventEscapeImageListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeEventEscapeImageListResponse(DescribeEventEscapeImageListResponse source) {
        if (source.List != null) {
            this.List = new EventEscapeImageInfo[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new EventEscapeImageInfo(source.List[i]);
            }
        }
