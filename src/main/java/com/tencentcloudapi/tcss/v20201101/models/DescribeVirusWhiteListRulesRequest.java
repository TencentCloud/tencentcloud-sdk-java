...
public class DescribeVirusWhiteListRulesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>排序方向，ASC/DESC，默认DESC</p>
     * @param Order <p>排序方向，ASC/DESC，默认DESC</p>
     */
    ...
    /**
     * Get <p>排序字段，支持 InsertTime/UpdateTime</p> 
    ...
    /**
     * Set <p>排序字段，支持 InsertTime/UpdateTime</p>
     * @param By <p>排序字段，支持 InsertTime/UpdateTime</p>
     */
