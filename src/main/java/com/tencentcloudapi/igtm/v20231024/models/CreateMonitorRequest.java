...
public class CreateMonitorRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 探测协议，可选值 PING TCP HTTP HTTPS 
    ...
    /**
     * Set 探测协议，可选值 PING TCP HTTP HTTPS
    ...
    /**
     * Get 失败比例，取值为 20 30 40 50 60 70 80 100，默认值50 
    ...
    /**
     * Set 失败比例，取值为 20 30 40 50 60 70 80 100，默认值50
    ...
    /**
     * Get PING 包数目，当CheckProtocol=ping时必填，可选值有20 50 100 
    ...
    /**
     * Set PING 包数目，当CheckProtocol=ping时必填，可选值有20 50 100
    ...
    /**
     * Get 丢包率告警阈值，当CheckProtocol=ping时必填取值为10 30 50 80 90 100 
    ...
    /**
     * Set 丢包率告警阈值，当CheckProtocol=ping时必填取值为10 30 50 80 90 100
