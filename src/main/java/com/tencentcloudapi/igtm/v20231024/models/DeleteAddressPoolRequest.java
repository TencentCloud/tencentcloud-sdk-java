...
public class DeleteAddressPoolRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteAddressPoolRequest() {
    }
     ...
     */
    public DeleteAddressPoolRequest(DeleteAddressPoolRequest source) {
