...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private MonitorDetail [] MonitorDataSet;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeMonitorsResponse(DescribeMonitorsResponse source) {
        if (source.MonitorDataSet != null) {
            this.MonitorDataSet = new MonitorDetail[source.MonitorDataSet.length];
            for (int i = 0; i < source.MonitorDataSet.length; i++) {
                this.MonitorDataSet[i] = new MonitorDetail(source.MonitorDataSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "MonitorDataSet.", this.MonitorDataSet);
