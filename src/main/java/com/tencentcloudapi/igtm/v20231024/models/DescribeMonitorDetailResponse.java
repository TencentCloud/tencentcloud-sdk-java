...
public class DescribeMonitorDetailResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeMonitorDetailResponse() {
    }
     ...
     */
    public DescribeMonitorDetailResponse(DescribeMonitorDetailResponse source) {
        if (source.MonitorDetail != null) {
            this.MonitorDetail = new MonitorDetail(source.MonitorDetail);
        }
