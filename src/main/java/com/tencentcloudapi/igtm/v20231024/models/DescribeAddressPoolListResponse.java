...
public class DescribeAddressPoolListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeAddressPoolListResponse() {
    }
     ...
     */
    public DescribeAddressPoolListResponse(DescribeAddressPoolListResponse source) {
        if (source.AddressPoolSet != null) {
            this.AddressPoolSet = new AddressPool[source.AddressPoolSet.length];
            for (int i = 0; i < source.AddressPoolSet.length; i++) {
                this.AddressPoolSet[i] = new AddressPool(source.AddressPoolSet[i]);
            }
        }
