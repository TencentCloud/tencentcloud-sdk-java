...
public class DescribeStrategyListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeStrategyListResponse() {
    }
     ...
     */
    public DescribeStrategyListResponse(DescribeStrategyListResponse source) {
        if (source.StrategySet != null) {
            this.StrategySet = new Strategy[source.StrategySet.length];
            for (int i = 0; i < source.StrategySet.length; i++) {
                this.StrategySet[i] = new Strategy(source.StrategySet[i]);
            }
        }
