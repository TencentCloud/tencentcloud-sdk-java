...
public class ChangeVoiceResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>结果音频的base64编码，默认mp3格式</p> 
     * @return AudioData <p>结果音频的base64编码，默认mp3格式</p>
     */
    ...
    /**
     * Get <p>结果音频url，有效期24小时</p> 
     * @return AudioUrl <p>结果音频url，有效期24小时</p>
     */
