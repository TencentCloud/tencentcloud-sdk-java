...
public class CreateAigcImageTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>模型名称。当前支持的模型列表：Hunyuan，Qwen，Vidu，Kling。</p> 
    ...
    /**
     * Set <p>模型名称。当前支持的模型列表：Hunyuan，Qwen，Vidu，Kling。</p>
     * @param ModelName <p>模型名称。当前支持的模型列表：Hunyuan，Qwen，Vidu，Kling。</p>
     */
