...
public class AiAnalysisTaskGenericInput extends AbstractModel {
    ...
    */
    ...
    public AiAnalysisTaskGenericInput() {
    }
     ...
     */
    public AiAnalysisTaskGenericInput(AiAnalysisTaskGenericInput source) {
