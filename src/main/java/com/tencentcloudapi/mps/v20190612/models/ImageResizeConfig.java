...
public class ImageResizeConfig extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get 缩放倍率，可以为小数，当Mode为percent时使用。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set 缩放倍率，可以为小数，当Mode为percent时使用。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public ImageResizeConfig(ImageResizeConfig source) {
