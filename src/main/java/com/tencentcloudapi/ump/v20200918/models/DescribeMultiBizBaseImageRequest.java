...
public class DescribeMultiBizBaseImageRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeMultiBizBaseImageRequest() {
    }
     ...
     */
    public DescribeMultiBizBaseImageRequest(DescribeMultiBizBaseImageRequest source) {
