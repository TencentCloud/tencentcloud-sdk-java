...
public class CreateCaptureResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public CreateCaptureResponse(CreateCaptureResponse source) {
        if (source.RspData != null) {
            this.RspData = new String(source.RspData);
        }
