...
public class SubmitOneByOneClassTaskResponse  extends AbstractModel{
    ...
    */
    ...
    /**
     * 获取图像任务直接返回结果，包括：FaceAttr、 FaceExpression、 FaceIdentify、 FaceInfo、 FacePose、TimeInfo
    ...
    /**
     * 设置图像任务直接返回结果，包括：FaceAttr、 FaceExpression、 FaceIdentify、 FaceInfo、 FacePose、TimeInfo
