...
public class SubmitTraditionalClassTaskResponse  extends AbstractModel{
    ...
    */
    ...
    /**
     * 获取图像任务直接返回结果，包括： ActionInfo、FaceAttr、 FaceExpression、 FaceIdentify、 FaceInfo、 FacePose、 TimeInfo
    ...
    /**
     * 设置图像任务直接返回结果，包括： ActionInfo、FaceAttr、 FaceExpression、 FaceIdentify、 FaceInfo、 FacePose、 TimeInfo
