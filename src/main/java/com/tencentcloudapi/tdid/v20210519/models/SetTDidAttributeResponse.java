...
public class SetTDidAttributeResponse extends AbstractModel {
    ...
    */
    ...
    public SetTDidAttributeResponse() {
    }
     ...
     */
    public SetTDidAttributeResponse(SetTDidAttributeResponse source) {
