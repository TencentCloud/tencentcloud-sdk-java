...
public class CreateTDidByHostResponse extends AbstractModel {
    ...
    */
    ...
    public CreateTDidByHostResponse() {
    }
     ...
     */
    public CreateTDidByHostResponse(CreateTDidByHostResponse source) {
        if (source.Did != null) {
