...
public class ListenerCcThresholdConfig extends AbstractModel {
    ...
    */
    ...
    public ListenerCcThresholdConfig() {
    }
     ...
     */
    public ListenerCcThresholdConfig(ListenerCcThresholdConfig source) {
