...
public class ProtectThresholdRelationNew extends AbstractModel {
...
1(开启)
    ...
    */
    ...
    @Expose
    private ListenerCcThresholdConfig [] ListenerCcThresholdList;
...
1(开启)
     ...
     */
    public ListenerCcThresholdConfig [] getListenerCcThresholdList() {
     ...
     */
    public void setListenerCcThresholdList(ListenerCcThresholdConfig [] ListenerCcThresholdList) {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public ProtectThresholdRelationNew() {
    }
     ...
     */
    public ProtectThresholdRelationNew(ProtectThresholdRelationNew source) {
        ...
        if (source.ListenerCcThresholdList != null) {
            this.ListenerCcThresholdList = new ListenerCcThresholdConfig[source.ListenerCcThresholdList.length];
            for (int i = 0; i < source.ListenerCcThresholdList.length; i++) {
                this.ListenerCcThresholdList[i] = new ListenerCcThresholdConfig(source.ListenerCcThresholdList[i]);
            }
        }
