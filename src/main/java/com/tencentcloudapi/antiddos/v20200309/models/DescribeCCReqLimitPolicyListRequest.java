...
public class DescribeCCReqLimitPolicyListRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 大禹子产品代号（bgp-multip表示高防包，bgpip表示高防IP） 
     * @return Business 大禹子产品代号（bgp-multip表示高防包，bgpip表示高防IP）
     */
    ...
    /**
     * Set 大禹子产品代号（bgp-multip表示高防包，bgpip表示高防IP）
    ...
    public DescribeCCReqLimitPolicyListRequest() {
    }
     ...
     */
    public DescribeCCReqLimitPolicyListRequest(DescribeCCReqLimitPolicyListRequest source) {
