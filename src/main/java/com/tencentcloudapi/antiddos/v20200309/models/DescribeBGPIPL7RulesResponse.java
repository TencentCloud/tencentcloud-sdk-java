...
public class DescribeBGPIPL7RulesResponse extends AbstractModel {
    ...
    */
     ...
     * @param Rules 转发规则列表
     */
    public void setRules(BGPIPL7RuleEntry [] Rules) {
        this.Rules = Rules;
    }
     ...
     */
    public DescribeBGPIPL7RulesResponse(DescribeBGPIPL7RulesResponse source) {
        if (source.Rules != null) {
            this.Rules = new BGPIPL7RuleEntry[source.Rules.length];
            for (int i = 0; i < source.Rules.length; i++) {
                this.Rules[i] = new BGPIPL7RuleEntry(source.Rules[i]);
            }
        }
