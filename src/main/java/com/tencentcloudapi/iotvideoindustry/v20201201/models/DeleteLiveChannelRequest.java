...
public class DeleteLiveChannelRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteLiveChannelRequest() {
    }
     ...
     */
    public DeleteLiveChannelRequest(DeleteLiveChannelRequest source) {
