...
默认接口请求频率限制：5次/秒。
     ...
     * @return CropEnhanceImageOCRResponse
     * @throws TencentCloudSDKException
     */
    public CropEnhanceImageOCRResponse CropEnhanceImageOCR(CropEnhanceImageOCRRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CropEnhanceImageOCR", CropEnhanceImageOCRResponse.class);
    }
...
默认接口请求并发限制：10张/分钟。
     ...
     * @throws TencentCloudSDKException
     */
    public DescribeQuestionMarkAgentJobResponse DescribeQuestionMarkAgentJob(DescribeQuestionMarkAgentJobRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeQuestionMarkAgentJob", DescribeQuestionMarkAgentJobResponse.class);
    }
...
默认接口请求频率限制：5次/秒。
     ...
     * @return EraseHandwrittenImageOCRResponse
     * @throws TencentCloudSDKException
     */
    public EraseHandwrittenImageOCRResponse EraseHandwrittenImageOCR(EraseHandwrittenImageOCRRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "EraseHandwrittenImageOCR", EraseHandwrittenImageOCRResponse.class);
    }
...
默认接口请求频率限制：5次/秒。
     ...
     * @return ExtractDocAgentResponse
     * @throws TencentCloudSDKException
     */
    public ExtractDocAgentResponse ExtractDocAgent(ExtractDocAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ExtractDocAgent", ExtractDocAgentResponse.class);
    }
...
默认接口请求频率限制：5 并发。
     ...
     * @return MultimodalDocParseResponse
     * @throws TencentCloudSDKException
     */
    public MultimodalDocParseResponse MultimodalDocParse(MultimodalDocParseRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "MultimodalDocParse", MultimodalDocParseResponse.class);
    }
...
按周更新企业信息变更情况，如遇到未及时更新的情况，可联系在线客服转产品团队进行人工处理。
     ...
     * @return VerifyGeneralCardWarnResponse
     * @throws TencentCloudSDKException
     */
    public VerifyGeneralCardWarnResponse VerifyGeneralCardWarn(VerifyGeneralCardWarnRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "VerifyGeneralCardWarn", VerifyGeneralCardWarnResponse.class);
    }
