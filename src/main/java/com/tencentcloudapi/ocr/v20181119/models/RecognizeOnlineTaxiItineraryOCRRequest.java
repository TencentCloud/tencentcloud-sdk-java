...
public class RecognizeOnlineTaxiItineraryOCRRequest extends AbstractModel{
...
非腾讯云存储的 Url 速度和稳定性可能受一定影响。
    ...
    public RecognizeOnlineTaxiItineraryOCRRequest() {
    }
     ...
     */
    public RecognizeOnlineTaxiItineraryOCRRequest(RecognizeOnlineTaxiItineraryOCRRequest source) {
