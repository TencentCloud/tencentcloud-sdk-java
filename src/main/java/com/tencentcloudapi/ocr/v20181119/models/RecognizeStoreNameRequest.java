...
public class RecognizeStoreNameRequest extends AbstractModel {
    ...
    */
    ...
    public RecognizeStoreNameRequest() {
    }
     ...
     */
    public RecognizeStoreNameRequest(RecognizeStoreNameRequest source) {
