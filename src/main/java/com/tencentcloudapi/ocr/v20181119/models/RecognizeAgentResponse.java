...
public class RecognizeAgentResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>返回内容。详见ListInfo。</p> 
     * @return Response <p>返回内容。详见ListInfo。</p>
     */
    public ListInfo [] getResponse() {
        return this.Response;
    }

    /**
     * Set <p>返回内容。详见ListInfo。</p>
     * @param Response <p>返回内容。详见ListInfo。</p>
     */
    public void setResponse(ListInfo [] Response) {
     ...
     */
    public RecognizeAgentResponse(RecognizeAgentResponse source) {
        if (source.Response != null) {
            this.Response = new ListInfo[source.Response.length];
            for (int i = 0; i < source.Response.length; i++) {
                this.Response[i] = new ListInfo(source.Response[i]);
            }
        }
