...
public class RecognizeFormulaOCRRequest extends AbstractModel {
    ...
    */
    ...
    public RecognizeFormulaOCRRequest() {
    }
     ...
     */
    public RecognizeFormulaOCRRequest(RecognizeFormulaOCRRequest source) {
