...
public class RideHailingTransportLicenseOCRRequest extends AbstractModel{
...
建议图片存储于腾讯云，可保障更高的下载速度和稳定性。
    ...
    public RideHailingTransportLicenseOCRRequest() {
    }
     ...
     */
    public RideHailingTransportLicenseOCRRequest(RideHailingTransportLicenseOCRRequest source) {
