...
public class InvoiceGeneralOCRResponse extends AbstractModel{
    ...
    */
     ...
     */
    public InvoiceGeneralOCRResponse(InvoiceGeneralOCRResponse source) {
        if (source.InvoiceGeneralInfos != null) {
            this.InvoiceGeneralInfos = new InvoiceGeneralInfo[source.InvoiceGeneralInfos.length];
            for (int i = 0; i < source.InvoiceGeneralInfos.length; i++) {
                this.InvoiceGeneralInfos[i] = new InvoiceGeneralInfo(source.InvoiceGeneralInfos[i]);
            }
        }
