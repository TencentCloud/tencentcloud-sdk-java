...
public class QuestionSplitOCRResponse extends AbstractModel {
    ...
    */
    ...
    public QuestionSplitOCRResponse() {
    }
     ...
     */
    public QuestionSplitOCRResponse(QuestionSplitOCRResponse source) {
