...
public class QuestionSplitLayoutOCRRequest extends AbstractModel {
...
API默认false, demo默认使用的是true
    ...
    public QuestionSplitLayoutOCRRequest() {
    }
     ...
     */
    public QuestionSplitLayoutOCRRequest(QuestionSplitLayoutOCRRequest source) {
