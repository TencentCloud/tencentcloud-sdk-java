...
Config = {"Name":true,"Address":true}
    ...
    /**
     * Get 用于入参是文本的场景，Address表示经营地址。Address为可选项，填写后会返回Address的校验结果。 
    ...
    /**
     * Set 用于入参是文本的场景，Address表示经营地址。Address为可选项，填写后会返回Address的校验结果。
     ...
     */
    public VerifyBasicBizLicenseRequest(VerifyBasicBizLicenseRequest source) {
