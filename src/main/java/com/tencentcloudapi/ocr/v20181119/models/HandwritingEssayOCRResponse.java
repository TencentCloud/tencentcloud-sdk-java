...
public class HandwritingEssayOCRResponse extends AbstractModel {
    ...
    */
    ...
    public HandwritingEssayOCRResponse() {
    }
     ...
     */
    public HandwritingEssayOCRResponse(HandwritingEssayOCRResponse source) {
