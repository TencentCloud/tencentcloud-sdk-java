...
public class ElectronicTollSummaryList extends AbstractModel {
    ...
    */
    ...
    public ElectronicTollSummaryList() {
    }
     ...
     */
    public ElectronicTollSummaryList(ElectronicTollSummaryList source) {
