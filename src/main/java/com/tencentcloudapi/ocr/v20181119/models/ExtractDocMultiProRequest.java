...
public class ExtractDocMultiProRequest extends AbstractModel {
...
默认：DispatchWeightNote
    ...
    public ExtractDocMultiProRequest() {
    }
     ...
     */
    public ExtractDocMultiProRequest(ExtractDocMultiProRequest source) {
