...
public class VehicleRegCertOCRResponse extends AbstractModel{
    ...
    */
    ...
    public VehicleRegCertOCRResponse() {
    }
     ...
     */
    public VehicleRegCertOCRResponse(VehicleRegCertOCRResponse source) {
        if (source.VehicleRegCertInfos != null) {
            this.VehicleRegCertInfos = new VehicleRegCertInfo[source.VehicleRegCertInfos.length];
            for (int i = 0; i < source.VehicleRegCertInfos.length; i++) {
                this.VehicleRegCertInfos[i] = new VehicleRegCertInfo(source.VehicleRegCertInfos[i]);
            }
        }
