...
public class QuestionSplitLayoutOCRResponse extends AbstractModel {
    ...
    */
    ...
    public QuestionSplitLayoutOCRResponse() {
    }
     ...
     */
    public QuestionSplitLayoutOCRResponse(QuestionSplitLayoutOCRResponse source) {
