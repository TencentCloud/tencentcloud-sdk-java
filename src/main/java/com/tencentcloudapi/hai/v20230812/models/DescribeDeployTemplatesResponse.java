...
public class DescribeDeployTemplatesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TemplateDetail [] TemplateSet;
    ...
    */
     ...
     */
    public TemplateDetail [] getTemplateSet() {
     ...
     */
    public void setTemplateSet(TemplateDetail [] TemplateSet) {
    ...
    public DescribeDeployTemplatesResponse() {
    }
     ...
     */
    public DescribeDeployTemplatesResponse(DescribeDeployTemplatesResponse source) {
        if (source.TemplateSet != null) {
            this.TemplateSet = new TemplateDetail[source.TemplateSet.length];
            for (int i = 0; i < source.TemplateSet.length; i++) {
                this.TemplateSet[i] = new TemplateDetail(source.TemplateSet[i]);
            }
        }
