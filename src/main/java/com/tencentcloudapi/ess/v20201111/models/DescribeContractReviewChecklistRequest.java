...
public class DescribeContractReviewChecklistRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>需要获取的合同风险审查清单ID</p> 
     * @return ChecklistId <p>需要获取的合同风险审查清单ID</p>
     */
    ...
    public DescribeContractReviewChecklistRequest() {
    }
     ...
     */
    public DescribeContractReviewChecklistRequest(DescribeContractReviewChecklistRequest source) {
