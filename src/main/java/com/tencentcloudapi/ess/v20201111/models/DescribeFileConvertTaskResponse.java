...
public class DescribeFileConvertTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/companyApis/startFlows/CreateFlowByFiles">用PDF文件创建签署流程</a></p> 
    ...
    /**
     * Set <p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/companyApis/startFlows/CreateFlowByFiles">用PDF文件创建签署流程</a></p>
