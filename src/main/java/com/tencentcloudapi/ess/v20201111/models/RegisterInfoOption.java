...
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
    */
    @SerializedName("UnifiedSocialCreditCodeSame")
    @Expose
    private Boolean UnifiedSocialCreditCodeSame;
...
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
     */
    public Boolean getUnifiedSocialCreditCodeSame() {
        return this.UnifiedSocialCreditCodeSame;
    }
...
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
     */
    public void setUnifiedSocialCreditCodeSame(Boolean UnifiedSocialCreditCodeSame) {
        this.UnifiedSocialCreditCodeSame = UnifiedSocialCreditCodeSame;
    }
    ...
    public RegisterInfoOption(RegisterInfoOption source) {
        ...
        if (source.UnifiedSocialCreditCodeSame != null) {
            this.UnifiedSocialCreditCodeSame = new Boolean(source.UnifiedSocialCreditCodeSame);
        }
    }
