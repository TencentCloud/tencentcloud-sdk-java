...
public class OperateSealsRequest extends AbstractModel {
...
<ul><li>2：停用印章</li></ul>
    ...
    /**
     * Get 需要操作的印章ID，数组形式，印章ID可从【web控制台->印章 】获取。 
    ...
    /**
     * Set 需要操作的印章ID，数组形式，印章ID可从【web控制台->印章 】获取。
     ...
     */
    public OperateSealsRequest(OperateSealsRequest source) {
