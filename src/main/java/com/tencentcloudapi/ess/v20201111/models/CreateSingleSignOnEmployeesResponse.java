...
public class CreateSingleSignOnEmployeesResponse extends AbstractModel {
...
2-全部失败
    ...
    */
    ...
    /**
     * Get 导入员工返回的错误信息，信息数组的顺序跟导入的保持一致 
    ...
    /**
     * Set 导入员工返回的错误信息，信息数组的顺序跟导入的保持一致
...
2-全部失败
    ...
    public CreateSingleSignOnEmployeesResponse() {
    }
     ...
     */
    public CreateSingleSignOnEmployeesResponse(CreateSingleSignOnEmployeesResponse source) {
