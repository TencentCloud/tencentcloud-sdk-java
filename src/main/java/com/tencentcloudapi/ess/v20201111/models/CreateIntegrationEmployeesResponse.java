...
public class CreateIntegrationEmployeesResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private CreateStaffResult CreateEmployeeResult;
    ...
    */
    ...
    public CreateIntegrationEmployeesResponse() {
    }
     ...
     */
    public CreateIntegrationEmployeesResponse(CreateIntegrationEmployeesResponse source) {
        if (source.CreateEmployeeResult != null) {
            this.CreateEmployeeResult = new CreateStaffResult(source.CreateEmployeeResult);
        }
