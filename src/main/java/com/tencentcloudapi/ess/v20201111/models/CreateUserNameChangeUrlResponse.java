...
public class CreateUserNameChangeUrlResponse extends AbstractModel {
...
`注：` <font color="red">生成的链路后面不能再增加参数，防止出错重复参数覆盖原有的参数</font>
    ...
    public CreateUserNameChangeUrlResponse() {
    }
     ...
     */
    public CreateUserNameChangeUrlResponse(CreateUserNameChangeUrlResponse source) {
