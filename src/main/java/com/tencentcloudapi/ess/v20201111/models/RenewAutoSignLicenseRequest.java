...
public class RenewAutoSignLicenseRequest extends AbstractModel {
...
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
    ...
    public RenewAutoSignLicenseRequest() {
    }
     ...
     */
    public RenewAutoSignLicenseRequest(RenewAutoSignLicenseRequest source) {
