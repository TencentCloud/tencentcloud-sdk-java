...
- 撤销后可以看合同PDF内容的人员： 发起方的超管， 发起方自己，发起方撤销合同的操作人员，已经签署合同、已经填写合同、邀请填写已经补充信息的参与人员， 其他参与人员看不到合同的内容。
     ...
     * @return CancelOrganizationFlowsResponse
     * @throws TencentCloudSDKException
     */
    public CancelOrganizationFlowsResponse CancelOrganizationFlows(CancelOrganizationFlowsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CancelOrganizationFlows", CancelOrganizationFlowsResponse.class);
    }
...
2. 代认证企业，此企业是由[创建企业认证链接](https://qian.tencent.com/developers/companyApis/organizations/CreateOrganizationAuthUrl)创建的
     ...
     * @return CreateBatchAdminChangeInvitationsResponse
     * @throws TencentCloudSDKException
     */
    public CreateBatchAdminChangeInvitationsResponse CreateBatchAdminChangeInvitations(CreateBatchAdminChangeInvitationsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateBatchAdminChangeInvitations", CreateBatchAdminChangeInvitationsResponse.class);
    }
...
此链接包含多条超管变更流程，使用该链接可以批量的对企业进行超管变更。
     ...
     * @return CreateBatchAdminChangeInvitationsUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateBatchAdminChangeInvitationsUrlResponse CreateBatchAdminChangeInvitationsUrl(CreateBatchAdminChangeInvitationsUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateBatchAdminChangeInvitationsUrl", CreateBatchAdminChangeInvitationsUrlResponse.class);
    }
...
2. 仅支持5份PDF文件批量发起（一份PDF对应一个审查任务）
     ...
     * @throws TencentCloudSDKException
     */
    public CreateBatchContractReviewTaskResponse CreateBatchContractReviewTask(CreateBatchContractReviewTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateBatchContractReviewTask", CreateBatchContractReviewTaskResponse.class);
    }
...
此链接包含多条认证流程，使用该链接可以批量的对企业进行认证。
     ...
     * @return CreateBatchOrganizationAuthorizationUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateBatchOrganizationAuthorizationUrlResponse CreateBatchOrganizationAuthorizationUrl(CreateBatchOrganizationAuthorizationUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateBatchOrganizationAuthorizationUrl", CreateBatchOrganizationAuthorizationUrlResponse.class);
    }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/c68047feddbc106e261870687b6ab89d.jpg)
     ...
     * @return CreateContractDiffTaskWebUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateContractDiffTaskWebUrlResponse CreateContractDiffTaskWebUrl(CreateContractDiffTaskWebUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateContractDiffTaskWebUrl", CreateContractDiffTaskWebUrlResponse.class);
    }
...
2. 如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开
     ...
     * @return CreateContractReviewWebUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateContractReviewWebUrlResponse CreateContractReviewWebUrl(CreateContractReviewWebUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateContractReviewWebUrl", CreateContractReviewWebUrlResponse.class);
    }
...
2. 仅支持返回小程序链接
     ...
     * @return CreateEmployeeChangeUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateEmployeeChangeUrlResponse CreateEmployeeChangeUrl(CreateEmployeeChangeUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateEmployeeChangeUrl", CreateEmployeeChangeUrlResponse.class);
    }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
     ...
     * @return CreateFileConvertTaskResponse
     * @throws TencentCloudSDKException
     */
    public CreateFileConvertTaskResponse CreateFileConvertTask(CreateFileConvertTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateFileConvertTask", CreateFileConvertTaskResponse.class);
    }
...
注：`合同催办是白名单功能，请联系客户经理申请开白后使用`
     ...
     * @return CreateFlowGroupRemindsResponse
     * @throws TencentCloudSDKException
     */
    public CreateFlowGroupRemindsResponse CreateFlowGroupReminds(CreateFlowGroupRemindsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateFlowGroupReminds", CreateFlowGroupRemindsResponse.class);
    }
...
| 腾讯电子签Demo | wx371151823f6f3edf | gh_39a5d3de69fa |
     ...
     * @return CreateMiniAppPrepareFlowResponse
     * @throws TencentCloudSDKException
     */
    public CreateMiniAppPrepareFlowResponse CreateMiniAppPrepareFlow(CreateMiniAppPrepareFlowRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateMiniAppPrepareFlow", CreateMiniAppPrepareFlowResponse.class);
    }
...
1. 重新上传超管授权书，必须是审核失败的情况下才能重新上传,可以通过回调[!企业认证审核结果回调](https://qian.tencent.com/developers/company/callback_types_staffs#%E5%8D%81%E5%85%AD-%E6%8E%88%E6%9D%83%E4%B9%A6%E8%AE%A4%E8%AF%81%E5%AE%A1%E6%A0%B8%E7%BB%93%E6%9E%9C%E5%9B%9E%E8%B0%83)得到授权书是否审核失败的结果。
     ...
     * @throws TencentCloudSDKException
     */
    public CreateModifyAdminAuthorizationUrlResponse CreateModifyAdminAuthorizationUrl(CreateModifyAdminAuthorizationUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateModifyAdminAuthorizationUrl", CreateModifyAdminAuthorizationUrlResponse.class);
    }
...
<b>注</b>：此接口需要 <font  color="red"><b>购买单独的实名套餐包</b></font>方可调用，如有需求请联系对接人员评估
     ...
     * @return CreateOrganizationAuthUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateOrganizationAuthUrlResponse CreateOrganizationAuthUrl(CreateOrganizationAuthUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateOrganizationAuthUrl", CreateOrganizationAuthUrlResponse.class);
    }
...
- 返回的FlowGroupId 为临时id，只有在页面内成功发起后FlowGroupId才会有效。
     ...
     * @return CreatePrepareFlowGroupResponse
     * @throws TencentCloudSDKException
     */
    public CreatePrepareFlowGroupResponse CreatePrepareFlowGroup(CreatePrepareFlowGroupRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreatePrepareFlowGroup", CreatePrepareFlowGroupResponse.class);
    }
...
```
     ...
     * @return CreateRequestWithEncryptionResponse
     * @throws TencentCloudSDKException
     */
    public CreateRequestWithEncryptionResponse CreateRequestWithEncryption(CreateRequestWithEncryptionRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateRequestWithEncryption", CreateRequestWithEncryptionResponse.class);
    }
...
注： 调用此接口需要购买<font color="red"><b>单独的实名套餐包</b></font>。使用前请联系对接的客户经理沟通。
     ...
     * @return CreateUserNameChangeUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateUserNameChangeUrlResponse CreateUserNameChangeUrl(CreateUserNameChangeUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateUserNameChangeUrl", CreateUserNameChangeUrlResponse.class);
    }
...
注： 调用此接口需要购买<font color="red"><b>单独的实名套餐包</b></font>。使用前请联系对接的客户经理沟通。
     ...
     * @return CreateUserVerifyUrlResponse
     * @throws TencentCloudSDKException
     */
    public CreateUserVerifyUrlResponse CreateUserVerifyUrl(CreateUserVerifyUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateUserVerifyUrl", CreateUserVerifyUrlResponse.class);
    }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/5e69f6e11859972d466900040f68c105.png)
     ...
     * @throws TencentCloudSDKException
     */
    public DescribeBatchOrganizationRegistrationTasksResponse DescribeBatchOrganizationRegistrationTasks(DescribeBatchOrganizationRegistrationTasksRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeBatchOrganizationRegistrationTasks", DescribeBatchOrganizationRegistrationTasksResponse.class);
    }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/c68047feddbc106e261870687b6ab89d.jpg)
     ...
     * @return DescribeContractDiffTaskWebUrlResponse
     * @throws TencentCloudSDKException
     */
    public DescribeContractDiffTaskWebUrlResponse DescribeContractDiffTaskWebUrl(DescribeContractDiffTaskWebUrlRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeContractDiffTaskWebUrl", DescribeContractDiffTaskWebUrlResponse.class);
    }
...
注意:  `如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开`
     ...
     * @return DescribeContractReviewWebUrlResponse
     * @throws TencentCloudSDKException
     */
...
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
     ...
     * @return DescribeFileConvertTaskResponse
     * @throws TencentCloudSDKException
     */
    public DescribeFileConvertTaskResponse DescribeFileConvertTask(DescribeFileConvertTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeFileConvertTask", DescribeFileConvertTaskResponse.class);
    }
...
**注意：该接口需要开通白名单，请联系客户经理开通后使用。**
     ...
     * @return DescribeSignFaceVideoResponse
     * @throws TencentCloudSDKException
     */
    public DescribeSignFaceVideoResponse DescribeSignFaceVideo(DescribeSignFaceVideoRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeSignFaceVideo", DescribeSignFaceVideoResponse.class);
    }
...
- 调用此接口需要购买单独的实名套餐包。<font color="red">使用前请联系对接的客户经理沟通</font>。
     ...
     * @return DescribeUserVerifyStatusResponse
     * @throws TencentCloudSDKException
     */
    public DescribeUserVerifyStatusResponse DescribeUserVerifyStatus(DescribeUserVerifyStatusRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeUserVerifyStatus", DescribeUserVerifyStatusResponse.class);
    }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/e5ef298c41f999b656f6b620c8b3d888.png)
     ...
     * @return OperateFlowRemarksResponse
     * @throws TencentCloudSDKException
     */
    public OperateFlowRemarksResponse OperateFlowRemarks(OperateFlowRemarksRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "OperateFlowRemarks", OperateFlowRemarksResponse.class);
    }
...
此操作将复制一个完全一样的模板，仅支持修改模板名称，若要修改其他模板内容，需到腾讯电子签控制台操作。
     ...
     * @throws TencentCloudSDKException
     */
    public OperateTemplateResponse OperateTemplate(OperateTemplateRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "OperateTemplate", OperateTemplateResponse.class);
    }
