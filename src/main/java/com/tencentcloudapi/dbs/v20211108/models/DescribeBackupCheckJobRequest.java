...
public class DescribeBackupCheckJobRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBackupCheckJobRequest() {
    }
     ...
     */
    public DescribeBackupCheckJobRequest(DescribeBackupCheckJobRequest source) {
