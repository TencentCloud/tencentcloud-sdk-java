...
public class StartBackupCheckJobRequest extends AbstractModel {
    ...
    */
    ...
    public StartBackupCheckJobRequest() {
    }
     ...
     */
    public StartBackupCheckJobRequest(StartBackupCheckJobRequest source) {
