...
public class DescribeFleetAttributesRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeFleetAttributesRequest() {
    }
     ...
     */
    public DescribeFleetAttributesRequest(DescribeFleetAttributesRequest source) {
