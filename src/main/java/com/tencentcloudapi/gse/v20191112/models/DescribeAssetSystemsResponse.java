...
public class DescribeAssetSystemsResponse extends AbstractModel{

    /**
    * 生成包支持的操作系统类型列表
    */
    @SerializedName("AssetSupportSys")
    @Expose
    private AssetSupportSys [] AssetSupportSys;
    ...
    */
     ...
     */
    public AssetSupportSys [] getAssetSupportSys() {
        return this.AssetSupportSys;
    }
     ...
     */
    public void setAssetSupportSys(AssetSupportSys [] AssetSupportSys) {
        this.AssetSupportSys = AssetSupportSys;
    }
