...
public class DescribeDevicesResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeDevicesResponse(DescribeDevicesResponse source) {
        ...
        if (source.DeviceInfoSet != null) {
            this.DeviceInfoSet = new DeviceInfo[source.DeviceInfoSet.length];
            for (int i = 0; i < source.DeviceInfoSet.length; i++) {
                this.DeviceInfoSet[i] = new DeviceInfo(source.DeviceInfoSet[i]);
            }
        }
