...
public class DescribeTaskOperationLogResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeTaskOperationLogResponse() {
    }
     ...
     */
    public DescribeTaskOperationLogResponse(DescribeTaskOperationLogResponse source) {
        if (source.TaskOperationLogSet != null) {
            this.TaskOperationLogSet = new TaskOperationLog[source.TaskOperationLogSet.length];
            for (int i = 0; i < source.TaskOperationLogSet.length; i++) {
                this.TaskOperationLogSet[i] = new TaskOperationLog(source.TaskOperationLogSet[i]);
            }
        }
