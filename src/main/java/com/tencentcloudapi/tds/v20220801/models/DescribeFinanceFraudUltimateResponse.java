...
public class DescribeFinanceFraudUltimateResponse extends AbstractModel {
    ...
    * <p>场景风险信息</p>
    */
    @SerializedName("SceneRiskInfos")
    @Expose
    private RiskInfo [] SceneRiskInfos;

    /**
    * <p>建议等级。1-极差，2-较差，3-中等，4-良好，5-优秀</p>
    */
    @SerializedName("SuggestionLevel")
    @Expose
    ...
    */
     ...
     */
    public RiskInfo [] getSceneRiskInfos() {
        return this.SceneRiskInfos;
    }
     ...
     */
    public void setSceneRiskInfos(RiskInfo [] SceneRiskInfos) {
        this.SceneRiskInfos = SceneRiskInfos;
    }

    /**
     * Get <p>建议等级。1-极差，2-较差，3-中等，4-良好，5-优秀</p> 
     * @return SuggestionLevel <p>建议等级。1-极差，2-较差，3-中等，4-良好，5-优秀</p>
     */
    public Long getSuggestionLevel() {
        return this.SuggestionLevel;
    }

    /**
     * Set <p>建议等级。1-极差，2-较差，3-中等，4-良好，5-优秀</p>
     * @param SuggestionLevel <p>建议等级。1-极差，2-较差，3-中等，4-良好，5-优秀</p>
     */
    public void setSuggestionLevel(Long SuggestionLevel) {
    ...
    public DescribeFinanceFraudUltimateResponse() {
    }
     ...
     */
    public DescribeFinanceFraudUltimateResponse(DescribeFinanceFraudUltimateResponse source) {
        ...
        if (source.SceneRiskInfos != null) {
            this.SceneRiskInfos = new RiskInfo[source.SceneRiskInfos.length];
            for (int i = 0; i < source.SceneRiskInfos.length; i++) {
                this.SceneRiskInfos[i] = new RiskInfo(source.SceneRiskInfos[i]);
            }
        }
