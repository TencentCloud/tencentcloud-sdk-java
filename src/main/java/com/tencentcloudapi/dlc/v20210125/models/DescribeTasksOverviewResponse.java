...
public class DescribeTasksOverviewResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTasksOverviewResponse() {
    }
     ...
     */
    public DescribeTasksOverviewResponse(DescribeTasksOverviewResponse source) {
