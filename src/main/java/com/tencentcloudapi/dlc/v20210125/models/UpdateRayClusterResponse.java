...
public class UpdateRayClusterResponse extends AbstractModel {
    ...
    */
    ...
    public UpdateRayClusterResponse() {
    }
     ...
     */
    public UpdateRayClusterResponse(UpdateRayClusterResponse source) {
        if (source.Id != null) {
