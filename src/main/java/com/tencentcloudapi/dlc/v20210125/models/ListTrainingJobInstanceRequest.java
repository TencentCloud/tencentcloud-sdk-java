...
public class ListTrainingJobInstanceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>每页数量（默认 10）</p> 
     * @return PageSize <p>每页数量（默认 10）</p>
     */
    ...
    /**
     * Get <p>过滤条件列表，每项含 Name、Operator、Values</p> 
     * @return Filters <p>过滤条件列表，每项含 Name、Operator、Values</p>
     */
    ...
    /**
     * Set <p>过滤条件列表，每项含 Name、Operator、Values</p>
     * @param Filters <p>过滤条件列表，每项含 Name、Operator、Values</p>
     */
    ...
    /**
     * Get <p>排序字段列表，每项含 Field、Order（ASC/DESC）</p> 
     * @return SortFields <p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
     */
    ...
    /**
     * Set <p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
     * @param SortFields <p>排序字段列表，每项含 Field、Order（ASC/DESC）</p>
     */
    ...
    public ListTrainingJobInstanceRequest() {
    }
     ...
     */
    public ListTrainingJobInstanceRequest(ListTrainingJobInstanceRequest source) {
        if (source.Page != null) {
