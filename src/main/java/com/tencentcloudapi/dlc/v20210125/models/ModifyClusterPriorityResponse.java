...
public class ModifyClusterPriorityResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyClusterPriorityResponse() {
    }
     ...
     */
    public ModifyClusterPriorityResponse(ModifyClusterPriorityResponse source) {
        if (source.Id != null) {
