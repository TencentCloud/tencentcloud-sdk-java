...
public class ListTrainingJobSpecRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>当前页码，从 1 开始（默认 1）</p>
     * @param Page <p>当前页码，从 1 开始（默认 1）</p>
     */
    ...
    /**
     * Set <p>每页数量（默认 200，最大 200）</p>
     * @param PageSize <p>每页数量（默认 200，最大 200）</p>
     */
    ...
    /**
     * Get <p>过滤条件列表，每项含 Name、Operator、Values。</p><p>提交模式过滤：LAB / CUSTOM_CODE / POST_TRAINING。示例：{&quot;Name&quot;:&quot;kind&quot;,&quot;Operator&quot;:&quot;EQ&quot;,&quot;Values&quot;:[&quot;LAB&quot;]}</p> 
    ...
    /**
     * Set <p>过滤条件列表，每项含 Name、Operator、Values。</p><p>提交模式过滤：LAB / CUSTOM_CODE / POST_TRAINING。示例：{&quot;Name&quot;:&quot;kind&quot;,&quot;Operator&quot;:&quot;EQ&quot;,&quot;Values&quot;:[&quot;LAB&quot;]}</p>
     * @param Filters <p>过滤条件列表，每项含 Name、Operator、Values。</p><p>提交模式过滤：LAB / CUSTOM_CODE / POST_TRAINING。示例：{&quot;Name&quot;:&quot;kind&quot;,&quot;Operator&quot;:&quot;EQ&quot;,&quot;Values&quot;:[&quot;LAB&quot;]}</p>
     */
    ...
    /**
     * Get <p>排序字段列表，每项含 Field、Order（ASC/DESC）。默认按 updateTime DESC</p> 
    ...
    /**
     * Set <p>排序字段列表，每项含 Field、Order（ASC/DESC）。默认按 updateTime DESC</p>
     * @param SortFields <p>排序字段列表，每项含 Field、Order（ASC/DESC）。默认按 updateTime DESC</p>
     */
    public void setSortFields(SortField [] SortFields) {
        this.SortFields = SortFields;
    }

    public ListTrainingJobSpecRequest() {
    }
     ...
     */
    public ListTrainingJobSpecRequest(ListTrainingJobSpecRequest source) {
        if (source.Page != null) {
