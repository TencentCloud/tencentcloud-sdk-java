...
public class DescribeTaskDetailResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TaskFullRespInfo TaskDetail;
    ...
    */
     ...
     */
    public TaskFullRespInfo getTaskDetail() {
     ...
     */
    public void setTaskDetail(TaskFullRespInfo TaskDetail) {
    ...
    public DescribeTaskDetailResponse(DescribeTaskDetailResponse source) {
        if (source.TaskDetail != null) {
            this.TaskDetail = new TaskFullRespInfo(source.TaskDetail);
        }
