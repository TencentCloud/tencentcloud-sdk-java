...
public class DescribeSaleRegionsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeSaleRegionsResponse() {
    }
     ...
     */
    public DescribeSaleRegionsResponse(DescribeSaleRegionsResponse source) {
