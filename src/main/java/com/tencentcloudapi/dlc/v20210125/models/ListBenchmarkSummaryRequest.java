...
public class ListBenchmarkSummaryRequest extends AbstractModel {
    ...
    */
    ...
    public ListBenchmarkSummaryRequest() {
    }
     ...
     */
    public ListBenchmarkSummaryRequest(ListBenchmarkSummaryRequest source) {
        if (source.Page != null) {
