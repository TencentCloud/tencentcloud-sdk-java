...
public class DescribeModelEnginesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeModelEnginesRequest() {
    }
     ...
     */
    public DescribeModelEnginesRequest(DescribeModelEnginesRequest source) {
