...
public class GetRayClusterPodsRequest extends AbstractModel {
    ...
    */
    ...
    public GetRayClusterPodsRequest() {
    }
     ...
     */
    public GetRayClusterPodsRequest(GetRayClusterPodsRequest source) {
        if (source.Id != null) {
