...
public class GetRayJobEventResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private RayJobEventItem [] Events;
    ...
    */
     ...
     */
    public RayJobEventItem [] getEvents() {
        return this.Events;
    }
     ...
     */
    public void setEvents(RayJobEventItem [] Events) {
        this.Events = Events;
    }
     ...
     */
    public GetRayJobEventResponse(GetRayJobEventResponse source) {
        ...
        if (source.Events != null) {
            this.Events = new RayJobEventItem[source.Events.length];
            for (int i = 0; i < source.Events.length; i++) {
                this.Events[i] = new RayJobEventItem(source.Events[i]);
            }
        }
