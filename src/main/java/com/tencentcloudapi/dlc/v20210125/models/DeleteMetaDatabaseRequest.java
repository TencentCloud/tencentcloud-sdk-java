...
public class DeleteMetaDatabaseRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteMetaDatabaseRequest() {
    }
     ...
     */
    public DeleteMetaDatabaseRequest(DeleteMetaDatabaseRequest source) {
