...
public class DescribeDMSPartitionsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeDMSPartitionsResponse() {
    }
     ...
     */
    public DescribeDMSPartitionsResponse(DescribeDMSPartitionsResponse source) {
