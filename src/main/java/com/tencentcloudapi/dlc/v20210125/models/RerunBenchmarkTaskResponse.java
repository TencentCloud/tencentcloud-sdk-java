...
public class RerunBenchmarkTaskResponse extends AbstractModel {
    ...
    */
    ...
    public RerunBenchmarkTaskResponse() {
    }
     ...
     */
    public RerunBenchmarkTaskResponse(RerunBenchmarkTaskResponse source) {
