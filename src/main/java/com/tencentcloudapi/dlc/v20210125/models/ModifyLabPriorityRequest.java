...
public class ModifyLabPriorityRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyLabPriorityRequest() {
    }
     ...
     */
    public ModifyLabPriorityRequest(ModifyLabPriorityRequest source) {
        if (source.Id != null) {
