...
public class RestartDeploymentResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set <p>最小副本数（自动伸缩时使用）</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param MinReplicas <p>最小副本数（自动伸缩时使用）</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set <p>最大副本数（自动伸缩时使用）</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param MaxReplicas <p>最大副本数（自动伸缩时使用）</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public RestartDeploymentResponse() {
    }
     ...
     */
    public RestartDeploymentResponse(RestartDeploymentResponse source) {
