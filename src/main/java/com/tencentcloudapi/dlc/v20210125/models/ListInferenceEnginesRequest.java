...
public class ListInferenceEnginesRequest extends AbstractModel {
    ...
    */
    ...
    public ListInferenceEnginesRequest() {
    }
     ...
     */
    public ListInferenceEnginesRequest(ListInferenceEnginesRequest source) {
        if (source.Page != null) {
