...
public class DescribeTaskListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TaskFullRespInfo [] TaskList;
    ...
    */
     ...
     */
    public TaskFullRespInfo [] getTaskList() {
     ...
     */
    public void setTaskList(TaskFullRespInfo [] TaskList) {
    ...
    public DescribeTaskListResponse(DescribeTaskListResponse source) {
        if (source.TaskList != null) {
            this.TaskList = new TaskFullRespInfo[source.TaskList.length];
            for (int i = 0; i < source.TaskList.length; i++) {
                this.TaskList[i] = new TaskFullRespInfo(source.TaskList[i]);
            }
        }
