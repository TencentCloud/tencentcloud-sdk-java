...
public class ListExampleTagsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setItems(ExampleTag [] Items) {
        this.Items = Items;
    }
    ...
    public ListExampleTagsResponse() {
    }
     ...
     */
    public ListExampleTagsResponse(ListExampleTagsResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new ExampleTag[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new ExampleTag(source.Items[i]);
            }
        }
