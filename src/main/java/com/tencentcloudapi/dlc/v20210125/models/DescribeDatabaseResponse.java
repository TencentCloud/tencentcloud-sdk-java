...
public class DescribeDatabaseResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DatabaseResponseInfo DatabaseInfo;
    ...
    */
     ...
     */
    public DatabaseResponseInfo getDatabaseInfo() {
     ...
     */
    public void setDatabaseInfo(DatabaseResponseInfo DatabaseInfo) {
    ...
    public DescribeDatabaseResponse(DescribeDatabaseResponse source) {
        if (source.DatabaseInfo != null) {
            this.DatabaseInfo = new DatabaseResponseInfo(source.DatabaseInfo);
        }
