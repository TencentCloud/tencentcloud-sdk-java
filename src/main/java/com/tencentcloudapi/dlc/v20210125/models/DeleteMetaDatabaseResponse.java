...
public class DeleteMetaDatabaseResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteMetaDatabaseResponse() {
    }
     ...
     */
    public DeleteMetaDatabaseResponse(DeleteMetaDatabaseResponse source) {
