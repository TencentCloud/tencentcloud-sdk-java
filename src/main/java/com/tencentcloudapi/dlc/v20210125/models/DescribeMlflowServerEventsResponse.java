...
public class DescribeMlflowServerEventsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p> 
    ...
    /**
     * Set <p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
     * @param StartTime <p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
     */
    ...
    /**
     * Get <p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p> 
    ...
    /**
     * Set <p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>
     * @param EndTime <p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>
     */
    ...
    public DescribeMlflowServerEventsResponse() {
    }
     ...
     */
    public DescribeMlflowServerEventsResponse(DescribeMlflowServerEventsResponse source) {
