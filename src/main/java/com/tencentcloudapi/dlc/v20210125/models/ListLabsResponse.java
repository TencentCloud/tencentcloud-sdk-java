...
public class ListLabsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setItems(LabResponse [] Items) {
        this.Items = Items;
    }
     ...
     */
    public ListLabsResponse(ListLabsResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new LabResponse[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new LabResponse(source.Items[i]);
            }
        }
