...
public class UpdateClusterGroupRequest extends AbstractModel {
    ...
    */
    ...
    public UpdateClusterGroupRequest() {
    }
     ...
     */
    public UpdateClusterGroupRequest(UpdateClusterGroupRequest source) {
        if (source.Id != null) {
