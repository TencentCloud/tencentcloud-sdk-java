...
public class UpdateResourceConfigResponse extends AbstractModel {
    ...
    */
    ...
    public UpdateResourceConfigResponse() {
    }
     ...
     */
    public UpdateResourceConfigResponse(UpdateResourceConfigResponse source) {
        if (source.Id != null) {
