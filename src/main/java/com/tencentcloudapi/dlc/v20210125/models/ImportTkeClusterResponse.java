...
public class ImportTkeClusterResponse extends AbstractModel {
    ...
    */
    ...
    public ImportTkeClusterResponse() {
    }
     ...
     */
    public ImportTkeClusterResponse(ImportTkeClusterResponse source) {
