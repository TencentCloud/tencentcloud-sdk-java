...
public class GetExampleDetailResponse extends AbstractModel {
    ...
    */
    ...
    public GetExampleDetailResponse() {
    }
     ...
     */
    public GetExampleDetailResponse(GetExampleDetailResponse source) {
        if (source.Id != null) {
