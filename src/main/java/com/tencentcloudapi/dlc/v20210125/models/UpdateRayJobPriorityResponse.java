...
public class UpdateRayJobPriorityResponse extends AbstractModel {
    ...
    */
    ...
    public UpdateRayJobPriorityResponse() {
    }
     ...
     */
    public UpdateRayJobPriorityResponse(UpdateRayJobPriorityResponse source) {
        if (source.Id != null) {
