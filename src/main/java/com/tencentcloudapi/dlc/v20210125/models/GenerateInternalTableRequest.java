...
public class GenerateInternalTableRequest extends AbstractModel {
    ...
    */
    ...
    public GenerateInternalTableRequest() {
    }
     ...
     */
    public GenerateInternalTableRequest(GenerateInternalTableRequest source) {
