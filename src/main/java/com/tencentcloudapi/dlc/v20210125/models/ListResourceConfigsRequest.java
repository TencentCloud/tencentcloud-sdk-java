...
public class ListResourceConfigsRequest extends AbstractModel {
    ...
    */
    ...
    public ListResourceConfigsRequest() {
    }
     ...
     */
    public ListResourceConfigsRequest(ListResourceConfigsRequest source) {
        if (source.Page != null) {
