...
public class DescribeEngineNetworksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 过滤条件可选，engine-network-id--引擎网络ID，engine-network-state--引擎网络状态 
    ...
    /**
     * Set 过滤条件可选，engine-network-id--引擎网络ID，engine-network-state--引擎网络状态
    ...
    public DescribeEngineNetworksRequest() {
    }
     ...
     */
    public DescribeEngineNetworksRequest(DescribeEngineNetworksRequest source) {
