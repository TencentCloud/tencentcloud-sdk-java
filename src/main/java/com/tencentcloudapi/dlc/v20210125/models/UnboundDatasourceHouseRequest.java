...
public class UnboundDatasourceHouseRequest extends AbstractModel {
    ...
    */
    ...
    public UnboundDatasourceHouseRequest() {
    }
     ...
     */
    public UnboundDatasourceHouseRequest(UnboundDatasourceHouseRequest source) {
