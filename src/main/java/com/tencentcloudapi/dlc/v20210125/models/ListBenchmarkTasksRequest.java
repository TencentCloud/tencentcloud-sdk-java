...
public class ListBenchmarkTasksRequest extends AbstractModel {
    ...
    */
    ...
    public ListBenchmarkTasksRequest() {
    }
     ...
     */
    public ListBenchmarkTasksRequest(ListBenchmarkTasksRequest source) {
