...
public class GetRayJobPodsRequest extends AbstractModel {
    ...
    */
     ...
     */
    public GetRayJobPodsRequest(GetRayJobPodsRequest source) {
        if (source.Id != null) {
