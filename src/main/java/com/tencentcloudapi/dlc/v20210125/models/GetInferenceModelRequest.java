...
public class GetInferenceModelRequest extends AbstractModel {
    ...
    */
    ...
    public GetInferenceModelRequest() {
    }
     ...
     */
    public GetInferenceModelRequest(GetInferenceModelRequest source) {
