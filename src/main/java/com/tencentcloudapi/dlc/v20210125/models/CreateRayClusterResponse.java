...
public class CreateRayClusterResponse extends AbstractModel {
    ...
    */
    ...
    public CreateRayClusterResponse() {
    }
     ...
     */
    public CreateRayClusterResponse(CreateRayClusterResponse source) {
        if (source.Id != null) {
