...
public class DescribePartitionDetailResponse extends AbstractModel {
    ...
    */
    ...
    public DescribePartitionDetailResponse() {
    }
     ...
     */
    public DescribePartitionDetailResponse(DescribePartitionDetailResponse source) {
        if (source.PartitionDetail != null) {
            this.PartitionDetail = new PartitionDetail(source.PartitionDetail);
        }
