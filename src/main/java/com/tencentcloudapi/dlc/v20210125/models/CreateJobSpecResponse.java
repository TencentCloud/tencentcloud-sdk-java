...
public class CreateJobSpecResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul> 
    ...
    /**
     * Set <p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
     ...
     */
    public CreateJobSpecResponse(CreateJobSpecResponse source) {
        if (source.Id != null) {
