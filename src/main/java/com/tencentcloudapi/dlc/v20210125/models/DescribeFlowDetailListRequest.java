...
public class DescribeFlowDetailListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeFlowDetailListRequest() {
    }
     ...
     */
    public DescribeFlowDetailListRequest(DescribeFlowDetailListRequest source) {
