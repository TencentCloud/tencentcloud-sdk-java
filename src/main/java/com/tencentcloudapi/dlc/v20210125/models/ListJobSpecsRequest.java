...
public class ListJobSpecsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>创建时间范围 - 开始时间（时间戳（毫秒））</p><p>单位：ms</p> 
    ...
    /**
     * Set <p>创建时间范围 - 开始时间（时间戳（毫秒））</p><p>单位：ms</p>
    ...
    /**
     * Get <p>创建时间范围 - 结束时间（时间戳（毫秒））</p><p>单位：ms</p> 
    ...
    /**
     * Set <p>创建时间范围 - 结束时间（时间戳（毫秒））</p><p>单位：ms</p>
     ...
     */
    public ListJobSpecsRequest(ListJobSpecsRequest source) {
        if (source.Page != null) {
