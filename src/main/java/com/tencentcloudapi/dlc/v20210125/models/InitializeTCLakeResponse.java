...
public class InitializeTCLakeResponse extends AbstractModel {
    ...
    */
    ...
    public InitializeTCLakeResponse() {
    }
     ...
     */
    public InitializeTCLakeResponse(InitializeTCLakeResponse source) {
