...
public class DescribeUDFPolicyResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeUDFPolicyResponse() {
    }
     ...
     */
    public DescribeUDFPolicyResponse(DescribeUDFPolicyResponse source) {
