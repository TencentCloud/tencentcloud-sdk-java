...
public class DeleteScriptResponse extends AbstractModel{
    ...
    * 删除的脚本数量
    */
    @SerializedName("ScriptsAffected")
    @Expose
    ...
    */
     ...
     */
    public void setScriptsAffected(Long ScriptsAffected) {
        this.ScriptsAffected = ScriptsAffected;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "ScriptsAffected", this.ScriptsAffected);
