...
public class GetInferenceServiceResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("GpuResourceSummary")
    @Expose
    private GpuSummaryItem [] GpuResourceSummary;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。 
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set <p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。 
     * @return GpuResourceSummary <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public GpuSummaryItem [] getGpuResourceSummary() {
        return this.GpuResourceSummary;
    }

    /**
     * Set <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param GpuResourceSummary <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setGpuResourceSummary(GpuSummaryItem [] GpuResourceSummary) {
        this.GpuResourceSummary = GpuResourceSummary;
    }
    ...
    public GetInferenceServiceResponse() {
    }
     ...
     */
    public GetInferenceServiceResponse(GetInferenceServiceResponse source) {
        ...
        if (source.GpuResourceSummary != null) {
            this.GpuResourceSummary = new GpuSummaryItem[source.GpuResourceSummary.length];
            for (int i = 0; i < source.GpuResourceSummary.length; i++) {
                this.GpuResourceSummary[i] = new GpuSummaryItem(source.GpuResourceSummary[i]);
            }
        }
