...
public class GetInferenceModelResponse extends AbstractModel {
    ...
    */
    ...
    public GetInferenceModelResponse() {
    }
     ...
     */
    public GetInferenceModelResponse(GetInferenceModelResponse source) {
