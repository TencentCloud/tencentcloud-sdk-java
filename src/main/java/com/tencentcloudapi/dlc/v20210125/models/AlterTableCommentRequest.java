...
public class AlterTableCommentRequest extends AbstractModel {
    ...
    */
    ...
    public AlterTableCommentRequest() {
    }
     ...
     */
    public AlterTableCommentRequest(AlterTableCommentRequest source) {
