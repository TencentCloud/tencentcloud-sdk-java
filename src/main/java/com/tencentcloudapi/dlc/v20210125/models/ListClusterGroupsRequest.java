...
public class ListClusterGroupsRequest extends AbstractModel {
    ...
    */
    ...
    public ListClusterGroupsRequest() {
    }
     ...
     */
    public ListClusterGroupsRequest(ListClusterGroupsRequest source) {
        if (source.Page != null) {
