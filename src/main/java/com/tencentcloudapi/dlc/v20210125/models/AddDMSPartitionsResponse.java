...
public class AddDMSPartitionsResponse extends AbstractModel{
    ...
    */
    ...
    public AddDMSPartitionsResponse() {
    }
     ...
     */
    public AddDMSPartitionsResponse(AddDMSPartitionsResponse source) {
