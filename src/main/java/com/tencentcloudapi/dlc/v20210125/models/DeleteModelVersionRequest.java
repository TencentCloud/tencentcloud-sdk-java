...
public class DeleteModelVersionRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>要删除的版本号（如 v1, v2）</p>
     * @param ModelVersion <p>要删除的版本号（如 v1, v2）</p>
     */
     ...
     */
    public DeleteModelVersionRequest(DeleteModelVersionRequest source) {
