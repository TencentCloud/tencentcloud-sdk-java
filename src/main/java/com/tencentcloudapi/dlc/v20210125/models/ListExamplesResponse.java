...
public class ListExamplesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>案例管理列表</p> 
     * @return Items <p>案例管理列表</p>
     */
    public ExampleEntity [] getItems() {
        return this.Items;
    }
     ...
     */
    public void setItems(ExampleEntity [] Items) {
        this.Items = Items;
    }
     ...
     */
    public ListExamplesResponse(ListExamplesResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new ExampleEntity[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new ExampleEntity(source.Items[i]);
            }
        }
