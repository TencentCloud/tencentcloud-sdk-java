...
public class ModifySparkAppForTDLCRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>任务资源配置是否继承集群配置模板：0（默认）不继承、1：继承</p> 
    ...
    /**
     * Set <p>任务资源配置是否继承集群配置模板：0（默认）不继承、1：继承</p>
    ...
    public ModifySparkAppForTDLCRequest() {
    }
     ...
     */
    public ModifySparkAppForTDLCRequest(ModifySparkAppForTDLCRequest source) {
