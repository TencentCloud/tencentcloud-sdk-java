...
public class CreateUserVpcConnectionResponse extends AbstractModel {
    ...
    */
    ...
    public CreateUserVpcConnectionResponse() {
    }
     ...
     */
    public CreateUserVpcConnectionResponse(CreateUserVpcConnectionResponse source) {
