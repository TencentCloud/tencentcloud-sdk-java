...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    @SerializedName("ApiKeyBindMessage")
    @Expose
    private String ApiKeyBindMessage;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Get <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p> 
     * @return ApiKeyBindMessage <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
     */
    public String getApiKeyBindMessage() {
        return this.ApiKeyBindMessage;
    }

    /**
     * Set <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
     * @param ApiKeyBindMessage <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
     */
    public void setApiKeyBindMessage(String ApiKeyBindMessage) {
        this.ApiKeyBindMessage = ApiKeyBindMessage;
    }
    ...
    public CreateInferenceServiceResponse(CreateInferenceServiceResponse source) {
        ...
        if (source.ApiKeyBindMessage != null) {
            this.ApiKeyBindMessage = new String(source.ApiKeyBindMessage);
        }
