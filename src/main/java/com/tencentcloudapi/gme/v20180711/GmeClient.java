...
查询年龄语音识别任务结果，请求频率10次/秒。该接口目前通过白名单开放试用，如有需求，请提交工单申请。
     ...
     * @return DescribeAuditResultExternalResponse
     * @throws TencentCloudSDKException
     */
    public DescribeAuditResultExternalResponse DescribeAuditResultExternal(DescribeAuditResultExternalRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeAuditResultExternal", DescribeAuditResultExternalResponse.class);
    }
