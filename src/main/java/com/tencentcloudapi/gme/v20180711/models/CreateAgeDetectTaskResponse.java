...
public class CreateAgeDetectTaskResponse extends AbstractModel{
    ...
    */
    ...
    public CreateAgeDetectTaskResponse() {
    }
     ...
     */
    public CreateAgeDetectTaskResponse(CreateAgeDetectTaskResponse source) {
