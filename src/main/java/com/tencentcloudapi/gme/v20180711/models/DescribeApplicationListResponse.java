...
public class DescribeApplicationListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeApplicationListResponse(DescribeApplicationListResponse source) {
        if (source.ApplicationList != null) {
            this.ApplicationList = new ApplicationList[source.ApplicationList.length];
            for (int i = 0; i < source.ApplicationList.length; i++) {
                this.ApplicationList[i] = new ApplicationList(source.ApplicationList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "ApplicationList.", this.ApplicationList);
