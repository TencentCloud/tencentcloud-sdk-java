...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribePublicApplicationsResponse() {
    }
     ...
     */
    public DescribePublicApplicationsResponse(DescribePublicApplicationsResponse source) {
        if (source.Applications != null) {
            this.Applications = new PublicApplication[source.Applications.length];
            for (int i = 0; i < source.Applications.length; i++) {
                this.Applications[i] = new PublicApplication(source.Applications[i]);
            }
        }
