...
public class DescribeApplicationVersionsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeApplicationVersionsResponse() {
    }
     ...
     */
    public DescribeApplicationVersionsResponse(DescribeApplicationVersionsResponse source) {
        if (source.ApplicationVersions != null) {
            this.ApplicationVersions = new ApplicationVersion[source.ApplicationVersions.length];
            for (int i = 0; i < source.ApplicationVersions.length; i++) {
                this.ApplicationVersions[i] = new ApplicationVersion(source.ApplicationVersions[i]);
            }
        }
