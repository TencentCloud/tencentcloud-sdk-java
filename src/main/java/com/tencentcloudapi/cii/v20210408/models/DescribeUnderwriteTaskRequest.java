...
public class DescribeUnderwriteTaskRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeUnderwriteTaskRequest() {
    }
     ...
     */
    public DescribeUnderwriteTaskRequest(DescribeUnderwriteTaskRequest source) {
