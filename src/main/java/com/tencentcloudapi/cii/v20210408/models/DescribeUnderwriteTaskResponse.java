...
public class DescribeUnderwriteTaskResponse extends AbstractModel{
...
2：结果生成失败
    ...
    */
    ...
    @Expose
    private UnderwriteOutput [] UnderwriteResults;
...
2：结果生成失败
     ...
     */
    public UnderwriteOutput [] getUnderwriteResults() {
     ...
     */
    public void setUnderwriteResults(UnderwriteOutput [] UnderwriteResults) {
    ...
    public DescribeUnderwriteTaskResponse() {
    }
     ...
     */
    public DescribeUnderwriteTaskResponse(DescribeUnderwriteTaskResponse source) {
        if (source.Uin != null) {
        ...
        if (source.UnderwriteResults != null) {
            this.UnderwriteResults = new UnderwriteOutput[source.UnderwriteResults.length];
            for (int i = 0; i < source.UnderwriteResults.length; i++) {
                this.UnderwriteResults[i] = new UnderwriteOutput(source.UnderwriteResults[i]);
            }
        }
