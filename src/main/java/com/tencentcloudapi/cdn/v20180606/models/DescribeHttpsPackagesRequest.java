...
public class DescribeHttpsPackagesRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeHttpsPackagesRequest() {
    }
     ...
     */
    public DescribeHttpsPackagesRequest(DescribeHttpsPackagesRequest source) {
