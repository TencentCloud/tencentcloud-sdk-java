...
public class ModifyCustomizeTemplatesPartByIdRequest extends AbstractModel{
    ...
    * 自定义模板Patched参数
    */
    @SerializedName("UserDefinedTemplatePatchedParams")
    @Expose
    private UserDefinedTemplatePatchedParams UserDefinedTemplatePatchedParams;
    ...
    public UserDefinedTemplatePatchedParams getUserDefinedTemplatePatchedParams() {
        return this.UserDefinedTemplatePatchedParams;
    }
    ...
    public void setUserDefinedTemplatePatchedParams(UserDefinedTemplatePatchedParams UserDefinedTemplatePatchedParams) {
        this.UserDefinedTemplatePatchedParams = UserDefinedTemplatePatchedParams;
    }
    ...
    public ModifyCustomizeTemplatesPartByIdRequest(ModifyCustomizeTemplatesPartByIdRequest source) {
        ...
        if (source.UserDefinedTemplatePatchedParams != null) {
            this.UserDefinedTemplatePatchedParams = new UserDefinedTemplatePatchedParams(source.UserDefinedTemplatePatchedParams);
        }
    }
