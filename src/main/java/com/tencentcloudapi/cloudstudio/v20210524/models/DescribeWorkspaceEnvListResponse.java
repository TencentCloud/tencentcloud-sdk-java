...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setData(ImageUserDTO [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeWorkspaceEnvListResponse(DescribeWorkspaceEnvListResponse source) {
        if (source.Data != null) {
            this.Data = new ImageUserDTO[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new ImageUserDTO(source.Data[i]);
            }
        }
