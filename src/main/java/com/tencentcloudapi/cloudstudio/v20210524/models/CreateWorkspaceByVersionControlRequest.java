...
public class CreateWorkspaceByVersionControlRequest extends AbstractModel{
    ...
    */
     ...
     */
    public CreateWorkspaceByVersionControlRequest(CreateWorkspaceByVersionControlRequest source) {
        if (source.WorkspaceDTO != null) {
            this.WorkspaceDTO = new WorkspaceDTO(source.WorkspaceDTO);
        }
