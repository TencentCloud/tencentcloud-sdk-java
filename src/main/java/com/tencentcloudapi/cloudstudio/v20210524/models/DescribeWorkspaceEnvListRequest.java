...
public class DescribeWorkspaceEnvListRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeWorkspaceEnvListRequest() {
    }
     ...
     */
    public DescribeWorkspaceEnvListRequest(DescribeWorkspaceEnvListRequest source) {
