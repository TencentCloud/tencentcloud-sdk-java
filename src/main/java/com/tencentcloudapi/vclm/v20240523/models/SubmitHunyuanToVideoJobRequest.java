...
public class SubmitHunyuanToVideoJobRequest extends AbstractModel {
...
单边分辨率不超过5000，不小于50，长宽限制1:4 ~ 4:1
 ...
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
    ...
    */
    ...
    /**
     * Get 视频内容的描述，中文正向提示词。最多支持200个 utf-8 字符（首尾空格不计入字符数）。 示例值：一只猫在草原上奔跑，写实风格 
    ...
    /**
     * Set 视频内容的描述，中文正向提示词。最多支持200个 utf-8 字符（首尾空格不计入字符数）。 示例值：一只猫在草原上奔跑，写实风格
...
单边分辨率不超过5000，不小于50，长宽限制1:4 ~ 4:1
    ...
    /**
     * Get 为生成视频添加标识的开关，默认为1，0 需前往 控制台 申请开启显示标识自主完成方可生效。
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。 
 ...
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
    ...
    /**
     * Set 为生成视频添加标识的开关，默认为1，0 需前往 控制台 申请开启显示标识自主完成方可生效。
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
 ...
 1：添加标识； 0：不添加标识； 其他数值：默认按1处理。
    ...
    public SubmitHunyuanToVideoJobRequest() {
    }
     ...
     */
    public SubmitHunyuanToVideoJobRequest(SubmitHunyuanToVideoJobRequest source) {
