...
public class DescribeHumanActorJobResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeHumanActorJobResponse() {
    }
     ...
     */
    public DescribeHumanActorJobResponse(DescribeHumanActorJobResponse source) {
