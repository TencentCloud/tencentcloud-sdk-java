...
public class DeleteAigcElementResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteAigcElementResponse() {
    }
     ...
     */
    public DeleteAigcElementResponse(DeleteAigcElementResponse source) {
