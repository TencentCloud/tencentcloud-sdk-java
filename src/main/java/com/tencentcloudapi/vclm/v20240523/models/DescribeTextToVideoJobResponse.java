...
public class DescribeTextToVideoJobResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTextToVideoJobResponse() {
    }
     ...
     */
    public DescribeTextToVideoJobResponse(DescribeTextToVideoJobResponse source) {
