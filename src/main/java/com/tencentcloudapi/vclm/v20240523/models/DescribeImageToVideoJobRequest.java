...
public class DescribeImageToVideoJobRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeImageToVideoJobRequest() {
    }
     ...
     */
    public DescribeImageToVideoJobRequest(DescribeImageToVideoJobRequest source) {
