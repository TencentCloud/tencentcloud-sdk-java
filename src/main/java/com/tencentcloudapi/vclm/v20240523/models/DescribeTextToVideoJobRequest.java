...
public class DescribeTextToVideoJobRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeTextToVideoJobRequest() {
    }
     ...
     */
    public DescribeTextToVideoJobRequest(DescribeTextToVideoJobRequest source) {
