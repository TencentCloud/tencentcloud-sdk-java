...
public class CheckAnimateImageJobResponse extends AbstractModel {
    ...
    */
    ...
    public CheckAnimateImageJobResponse() {
    }
     ...
     */
    public CheckAnimateImageJobResponse(CheckAnimateImageJobResponse source) {
