...
public class DescribeVideoEditJobResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeVideoEditJobResponse() {
    }
     ...
     */
    public DescribeVideoEditJobResponse(DescribeVideoEditJobResponse source) {
