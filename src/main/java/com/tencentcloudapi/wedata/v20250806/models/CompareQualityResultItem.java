...
public class CompareQualityResultItem extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QualityThresholdValue [] Values;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QualityThresholdValue [] getValues() {
        return this.Values;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setValues(QualityThresholdValue [] Values) {
        this.Values = Values;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public CompareQualityResultItem() {
    }
     ...
     */
    public CompareQualityResultItem(CompareQualityResultItem source) {
        ...
        if (source.Values != null) {
            this.Values = new QualityThresholdValue[source.Values.length];
            for (int i = 0; i < source.Values.length; i++) {
                this.Values[i] = new QualityThresholdValue(source.Values[i]);
            }
        }
