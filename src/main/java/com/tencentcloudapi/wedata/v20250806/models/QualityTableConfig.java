...
public class QualityTableConfig extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QualityFieldConfig [] FieldConfig;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QualityFieldConfig [] getFieldConfig() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setFieldConfig(QualityFieldConfig [] FieldConfig) {
        this.FieldConfig = FieldConfig;
    }

    public QualityTableConfig() {
    }
     ...
     */
    public QualityTableConfig(QualityTableConfig source) {
        ...
        if (source.FieldConfig != null) {
            this.FieldConfig = new QualityFieldConfig[source.FieldConfig.length];
            for (int i = 0; i < source.FieldConfig.length; i++) {
                this.FieldConfig[i] = new QualityFieldConfig(source.FieldConfig[i]);
            }
        }
    }
