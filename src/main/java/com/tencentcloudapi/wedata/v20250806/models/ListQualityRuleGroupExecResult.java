...
public class ListQualityRuleGroupExecResult extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QualityRuleExecResult [] RuleExecResultVOList;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("BizCatalogName")
    @Expose
    private String BizCatalogName;

    /**
    * 类目id
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("BizCatalogId")
    @Expose
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QualityRuleExecResult [] getRuleExecResultVOList() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setRuleExecResultVOList(QualityRuleExecResult [] RuleExecResultVOList) {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * Get 类目名
注意：此字段可能返回 null，表示取不到有效值。 
     * @return BizCatalogName 类目名
注意：此字段可能返回 null，表示取不到有效值。
     */
    public String getBizCatalogName() {
        return this.BizCatalogName;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setBizCatalogName(String BizCatalogName) {
        this.BizCatalogName = BizCatalogName;
    }

    /**
     * Get 类目id
注意：此字段可能返回 null，表示取不到有效值。 
     * @return BizCatalogId 类目id
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public ListQualityRuleGroupExecResult() {
    }
     ...
     */
    public ListQualityRuleGroupExecResult(ListQualityRuleGroupExecResult source) {
        ...
        if (source.RuleExecResultVOList != null) {
            this.RuleExecResultVOList = new QualityRuleExecResult[source.RuleExecResultVOList.length];
            for (int i = 0; i < source.RuleExecResultVOList.length; i++) {
                this.RuleExecResultVOList[i] = new QualityRuleExecResult(source.RuleExecResultVOList[i]);
            }
        }
        ...
        if (source.BizCatalogName != null) {
            this.BizCatalogName = new String(source.BizCatalogName);
        }
        if (source.BizCatalogId != null) {
            this.BizCatalogId = new String(source.BizCatalogId);
        }
