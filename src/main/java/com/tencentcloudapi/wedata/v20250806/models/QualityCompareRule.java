...
public class QualityCompareRule extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QualityCompareRuleItem [] Items;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QualityCompareRuleItem [] getItems() {
        return this.Items;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setItems(QualityCompareRuleItem [] Items) {
        this.Items = Items;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public QualityCompareRule(QualityCompareRule source) {
        if (source.Items != null) {
            this.Items = new QualityCompareRuleItem[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new QualityCompareRuleItem(source.Items[i]);
            }
        }
