...
public class QualityFieldConfig extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QualityColumnValueConfig ValueConfig;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QualityColumnValueConfig getValueConfig() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setValueConfig(QualityColumnValueConfig ValueConfig) {
        this.ValueConfig = ValueConfig;
    }

    public QualityFieldConfig() {
    }
     ...
     */
    public QualityFieldConfig(QualityFieldConfig source) {
        ...
        if (source.ValueConfig != null) {
            this.ValueConfig = new QualityColumnValueConfig(source.ValueConfig);
        }
    }
