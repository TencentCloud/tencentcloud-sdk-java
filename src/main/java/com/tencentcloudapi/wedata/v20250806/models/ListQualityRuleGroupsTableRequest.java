...
public class ListQualityRuleGroupsTableRequest extends AbstractModel {
...
2 - 降序（DESC）
    ...
    public ListQualityRuleGroupsTableRequest() {
    }
     ...
     */
    public ListQualityRuleGroupsTableRequest(ListQualityRuleGroupsTableRequest source) {
