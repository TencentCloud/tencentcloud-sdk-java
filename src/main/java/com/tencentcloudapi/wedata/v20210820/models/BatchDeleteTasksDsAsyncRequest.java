...
public class BatchDeleteTasksDsAsyncRequest extends AbstractModel {
...
false: 不删除任务引用的脚本
    ...
    public BatchDeleteTasksDsAsyncRequest() {
    }
     ...
     */
    public BatchDeleteTasksDsAsyncRequest(BatchDeleteTasksDsAsyncRequest source) {
