...
public class SubmitPythonTaskResponse extends AbstractModel {
    ...
    */
    ...
    public SubmitPythonTaskResponse() {
    }
     ...
     */
    public SubmitPythonTaskResponse(SubmitPythonTaskResponse source) {
