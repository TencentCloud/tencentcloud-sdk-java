...
public class DescribeManualTriggerRecordPageResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("Data")
    @Expose
    private ManualTriggerRecordOpsDtoPage Data;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeManualTriggerRecordPageResponse() {
    }
     ...
     */
    public DescribeManualTriggerRecordPageResponse(DescribeManualTriggerRecordPageResponse source) {
        if (source.RequestFromSource != null) {
            this.RequestFromSource = new String(source.RequestFromSource);
        }
        if (source.Data != null) {
            this.Data = new ManualTriggerRecordOpsDtoPage(source.Data);
        }
