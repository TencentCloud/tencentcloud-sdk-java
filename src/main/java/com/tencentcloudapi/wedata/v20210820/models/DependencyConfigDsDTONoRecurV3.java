...
public class DependencyConfigDsDTONoRecurV3 extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskDsDTONoRecurV3 ParentTask;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskDsDTONoRecurV3 SonTask;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskDsDTONoRecurV3 getParentTask() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setParentTask(TaskDsDTONoRecurV3 ParentTask) {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskDsDTONoRecurV3 getSonTask() {
        return this.SonTask;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setSonTask(TaskDsDTONoRecurV3 SonTask) {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DependencyConfigDsDTONoRecurV3() {
    }
     ...
     */
    public DependencyConfigDsDTONoRecurV3(DependencyConfigDsDTONoRecurV3 source) {
        if (source.ParentTask != null) {
            this.ParentTask = new TaskDsDTONoRecurV3(source.ParentTask);
        }
        if (source.SonTask != null) {
            this.SonTask = new TaskDsDTONoRecurV3(source.SonTask);
        }
