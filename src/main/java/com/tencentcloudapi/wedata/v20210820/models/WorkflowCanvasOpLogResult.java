...
public class WorkflowCanvasOpLogResult extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private WorkflowCanvasOplog [] Items;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public WorkflowCanvasOplog [] getItems() {
        return this.Items;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setItems(WorkflowCanvasOplog [] Items) {
        this.Items = Items;
    }

    public WorkflowCanvasOpLogResult() {
    }
     ...
     */
    public WorkflowCanvasOpLogResult(WorkflowCanvasOpLogResult source) {
        ...
        if (source.Items != null) {
            this.Items = new WorkflowCanvasOplog[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new WorkflowCanvasOplog(source.Items[i]);
            }
        }
    }
