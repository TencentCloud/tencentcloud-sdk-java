...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeDataSourceWithoutInfoResponse(DescribeDataSourceWithoutInfoResponse source) {
        if (source.Data != null) {
            this.Data = new DataSourceInfo[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new DataSourceInfo(source.Data[i]);
            }
        }
