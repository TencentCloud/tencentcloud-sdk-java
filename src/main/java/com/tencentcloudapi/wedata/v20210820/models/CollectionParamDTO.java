...
public class CollectionParamDTO extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private ParameterInfoDsDto [] Items;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public ParameterInfoDsDto [] getItems() {
        return this.Items;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setItems(ParameterInfoDsDto [] Items) {
        this.Items = Items;
    }

    public CollectionParamDTO() {
    }
     ...
     */
    public CollectionParamDTO(CollectionParamDTO source) {
        ...
        if (source.Items != null) {
            this.Items = new ParameterInfoDsDto[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new ParameterInfoDsDto(source.Items[i]);
            }
        }
    }
