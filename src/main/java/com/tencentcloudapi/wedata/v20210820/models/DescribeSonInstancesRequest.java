...
public class DescribeSonInstancesRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeSonInstancesRequest() {
    }
     ...
     */
    public DescribeSonInstancesRequest(DescribeSonInstancesRequest source) {
