...
public class DownloadSqlResultResponse extends AbstractModel {
    ...
    */
    ...
    public DownloadSqlResultResponse() {
    }
     ...
     */
    public DownloadSqlResultResponse(DownloadSqlResultResponse source) {
