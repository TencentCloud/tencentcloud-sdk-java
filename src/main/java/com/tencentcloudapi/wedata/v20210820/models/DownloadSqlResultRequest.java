...
public class DownloadSqlResultRequest extends AbstractModel {
    ...
    */
    ...
    public DownloadSqlResultRequest() {
    }
     ...
     */
    public DownloadSqlResultRequest(DownloadSqlResultRequest source) {
