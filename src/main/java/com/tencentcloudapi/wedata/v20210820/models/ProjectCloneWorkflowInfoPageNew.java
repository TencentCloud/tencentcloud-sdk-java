...
public class ProjectCloneWorkflowInfoPageNew extends AbstractModel {
    ...
    */
    ...
    @Expose
    private ProjectCloneWorkflowInfo [] Items;
     ...
     */
    public ProjectCloneWorkflowInfo [] getItems() {
        return this.Items;
    }
     ...
     */
    public void setItems(ProjectCloneWorkflowInfo [] Items) {
        this.Items = Items;
    }

    public ProjectCloneWorkflowInfoPageNew() {
    }
     ...
     */
    public ProjectCloneWorkflowInfoPageNew(ProjectCloneWorkflowInfoPageNew source) {
        ...
        if (source.Items != null) {
            this.Items = new ProjectCloneWorkflowInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new ProjectCloneWorkflowInfo(source.Items[i]);
            }
        }
    }
