...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("TaskEventPublisher")
    @Expose
    private EventPublisherDTO [] TaskEventPublisher;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("TaskCycleLinkInfo")
    @Expose
    private TaskCycleLinkDTO [] TaskCycleLinkInfo;

    /**
    * 事件监听信息
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("TaskEventListener")
    @Expose
    private EventListenerDTO [] TaskEventListener;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public EventPublisherDTO [] getTaskEventPublisher() {
        return this.TaskEventPublisher;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTaskEventPublisher(EventPublisherDTO [] TaskEventPublisher) {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskCycleLinkDTO [] getTaskCycleLinkInfo() {
        return this.TaskCycleLinkInfo;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTaskCycleLinkInfo(TaskCycleLinkDTO [] TaskCycleLinkInfo) {
        this.TaskCycleLinkInfo = TaskCycleLinkInfo;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public EventListenerDTO [] getTaskEventListener() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTaskEventListener(EventListenerDTO [] TaskEventListener) {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public TaskVersionDsDTO(TaskVersionDsDTO source) {
        ...
        if (source.TaskEventPublisher != null) {
            this.TaskEventPublisher = new EventPublisherDTO[source.TaskEventPublisher.length];
            for (int i = 0; i < source.TaskEventPublisher.length; i++) {
                this.TaskEventPublisher[i] = new EventPublisherDTO(source.TaskEventPublisher[i]);
            }
        }
        ...
        if (source.TaskCycleLinkInfo != null) {
            this.TaskCycleLinkInfo = new TaskCycleLinkDTO[source.TaskCycleLinkInfo.length];
            for (int i = 0; i < source.TaskCycleLinkInfo.length; i++) {
                this.TaskCycleLinkInfo[i] = new TaskCycleLinkDTO(source.TaskCycleLinkInfo[i]);
            }
        }
        if (source.TaskEventListener != null) {
            this.TaskEventListener = new EventListenerDTO[source.TaskEventListener.length];
            for (int i = 0; i < source.TaskEventListener.length; i++) {
                this.TaskEventListener[i] = new EventListenerDTO(source.TaskEventListener[i]);
            }
        }
