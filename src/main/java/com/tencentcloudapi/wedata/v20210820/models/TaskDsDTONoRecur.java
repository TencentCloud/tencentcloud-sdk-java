...
public class TaskDsDTONoRecur extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private String [] DependencyConfigList;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public String [] getDependencyConfigList() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setDependencyConfigList(String [] DependencyConfigList) {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public TaskDsDTONoRecur(TaskDsDTONoRecur source) {
        ...
        if (source.DependencyConfigList != null) {
            this.DependencyConfigList = new String[source.DependencyConfigList.length];
            for (int i = 0; i < source.DependencyConfigList.length; i++) {
                this.DependencyConfigList[i] = new String(source.DependencyConfigList[i]);
            }
        }
