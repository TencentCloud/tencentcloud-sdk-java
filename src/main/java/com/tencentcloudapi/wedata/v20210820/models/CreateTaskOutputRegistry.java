...
public class CreateTaskOutputRegistry extends AbstractModel {
    ...
    */
    ...
    public CreateTaskOutputRegistry() {
    }
     ...
     */
    public CreateTaskOutputRegistry(CreateTaskOutputRegistry source) {
