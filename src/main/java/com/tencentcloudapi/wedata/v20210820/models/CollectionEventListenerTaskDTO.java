...
public class CollectionEventListenerTaskDTO extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private EventListenerTaskInfo [] Items;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public EventListenerTaskInfo [] getItems() {
        return this.Items;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setItems(EventListenerTaskInfo [] Items) {
        this.Items = Items;
    }

    public CollectionEventListenerTaskDTO() {
    }
     ...
     */
    public CollectionEventListenerTaskDTO(CollectionEventListenerTaskDTO source) {
        ...
        if (source.Items != null) {
            this.Items = new EventListenerTaskInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new EventListenerTaskInfo(source.Items[i]);
            }
        }
    }
