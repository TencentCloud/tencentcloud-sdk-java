...
public class DependencyConfigDsDTONoRecur extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskDsDTONoRecur ParentTask;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskDsDTONoRecur SonTask;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskDsDTONoRecur getParentTask() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setParentTask(TaskDsDTONoRecur ParentTask) {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskDsDTONoRecur getSonTask() {
        return this.SonTask;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setSonTask(TaskDsDTONoRecur SonTask) {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setDependencyStrategy(DependencyStrategy DependencyStrategy) {
        this.DependencyStrategy = DependencyStrategy;
    }

    public DependencyConfigDsDTONoRecur() {
    }
     ...
     */
    public DependencyConfigDsDTONoRecur(DependencyConfigDsDTONoRecur source) {
        if (source.ParentTask != null) {
            this.ParentTask = new TaskDsDTONoRecur(source.ParentTask);
        }
        if (source.SonTask != null) {
            this.SonTask = new TaskDsDTONoRecur(source.SonTask);
        }
        ...
        if (source.DependencyStrategy != null) {
            this.DependencyStrategy = new DependencyStrategy(source.DependencyStrategy);
        }
    }
