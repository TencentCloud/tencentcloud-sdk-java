...
public class TaskTypeExtParamVO extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskTypeExtVO TaskTypeExtValue;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskTypeExtVO getTaskTypeExtValue() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTaskTypeExtValue(TaskTypeExtVO TaskTypeExtValue) {
        this.TaskTypeExtValue = TaskTypeExtValue;
    }

    public TaskTypeExtParamVO() {
    }
     ...
     */
    public TaskTypeExtParamVO(TaskTypeExtParamVO source) {
        if (source.TaskTypeExtKey != null) {
            this.TaskTypeExtKey = new String(source.TaskTypeExtKey);
        }
        if (source.TaskTypeExtValue != null) {
            this.TaskTypeExtValue = new TaskTypeExtVO(source.TaskTypeExtValue);
        }
    }
