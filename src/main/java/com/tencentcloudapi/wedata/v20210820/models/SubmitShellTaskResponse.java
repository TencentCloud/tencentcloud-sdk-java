...
public class SubmitShellTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 子任务记录列表，对于shell与python只有一条记录 
     * @return Details 子任务记录列表，对于shell与python只有一条记录
     */
    ...
    /**
     * Set 子任务记录列表，对于shell与python只有一条记录
    ...
    public SubmitShellTaskResponse() {
    }
     ...
     */
    public SubmitShellTaskResponse(SubmitShellTaskResponse source) {
