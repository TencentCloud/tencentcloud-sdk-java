...
public class TaskDsDTOLiteV3 extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private DependencyConfigDsDTONoRecurV3 [] DependencyConfigList;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTasks(TaskDsDTONoRecurV2 [] Tasks) {
        this.Tasks = Tasks;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public DependencyConfigDsDTONoRecurV3 [] getDependencyConfigList() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setDependencyConfigList(DependencyConfigDsDTONoRecurV3 [] DependencyConfigList) {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public TaskDsDTOLiteV3(TaskDsDTOLiteV3 source) {
        ...
        if (source.Tasks != null) {
            this.Tasks = new TaskDsDTONoRecurV2[source.Tasks.length];
            for (int i = 0; i < source.Tasks.length; i++) {
                this.Tasks[i] = new TaskDsDTONoRecurV2(source.Tasks[i]);
            }
        }
        ...
        if (source.DependencyConfigList != null) {
            this.DependencyConfigList = new DependencyConfigDsDTONoRecurV3[source.DependencyConfigList.length];
            for (int i = 0; i < source.DependencyConfigList.length; i++) {
                this.DependencyConfigList[i] = new DependencyConfigDsDTONoRecurV3(source.DependencyConfigList[i]);
            }
        }
