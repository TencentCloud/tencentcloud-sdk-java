...
public class RecycleTaskPageInfo extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public RecycleTaskInfo [] getRows() {
        return this.Rows;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setRows(RecycleTaskInfo [] Rows) {
        this.Rows = Rows;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public RecycleTaskPageInfo(RecycleTaskPageInfo source) {
        ...
        if (source.Rows != null) {
            this.Rows = new RecycleTaskInfo[source.Rows.length];
            for (int i = 0; i < source.Rows.length; i++) {
                this.Rows[i] = new RecycleTaskInfo(source.Rows[i]);
            }
        }
