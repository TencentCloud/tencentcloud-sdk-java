...
public class LineageNodeInfoVO extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private LineageRelationVO Relation;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public LineageRelationVO getRelation() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setRelation(LineageRelationVO Relation) {
