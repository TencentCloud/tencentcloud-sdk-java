...
public class SubmitIntegrationTaskResponse extends AbstractModel {
    ...
    */
    ...
    public SubmitIntegrationTaskResponse() {
    }
     ...
     */
    public SubmitIntegrationTaskResponse(SubmitIntegrationTaskResponse source) {
