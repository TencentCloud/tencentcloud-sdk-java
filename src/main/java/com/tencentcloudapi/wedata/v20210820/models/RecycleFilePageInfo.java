...
public class RecycleFilePageInfo extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("Rows")
    @Expose
    private DeleteUserFileDTO [] Rows;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public DeleteUserFileDTO [] getRows() {
        return this.Rows;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setRows(DeleteUserFileDTO [] Rows) {
        this.Rows = Rows;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public RecycleFilePageInfo(RecycleFilePageInfo source) {
        ...
        if (source.Rows != null) {
            this.Rows = new DeleteUserFileDTO[source.Rows.length];
            for (int i = 0; i < source.Rows.length; i++) {
                this.Rows[i] = new DeleteUserFileDTO(source.Rows[i]);
            }
        }
