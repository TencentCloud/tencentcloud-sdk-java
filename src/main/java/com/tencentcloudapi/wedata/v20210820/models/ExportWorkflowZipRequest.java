...
public class ExportWorkflowZipRequest extends AbstractModel {
    ...
    */
    ...
    public ExportWorkflowZipRequest() {
    }
     ...
     */
    public ExportWorkflowZipRequest(ExportWorkflowZipRequest source) {
