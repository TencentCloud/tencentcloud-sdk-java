...
public class RerunScheduleInstancesRequest extends AbstractModel{
    ...
    */
    ...
    public RerunScheduleInstancesRequest() {
    }
     ...
     */
    public RerunScheduleInstancesRequest(RerunScheduleInstancesRequest source) {
