...
public class TaskDsDTOLite extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TaskDsDTONoRecur [] Tasks;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private DependencyConfigDsDTONoRecur [] DependencyConfigList;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTaskExt(TaskExtVO TaskExt) {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setAlarms(AlarmVO [] Alarms) {
        this.Alarms = Alarms;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TaskDsDTONoRecur [] getTasks() {
        return this.Tasks;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setTasks(TaskDsDTONoRecur [] Tasks) {
        this.Tasks = Tasks;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public DependencyConfigDsDTONoRecur [] getDependencyConfigList() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setDependencyConfigList(DependencyConfigDsDTONoRecur [] DependencyConfigList) {
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public TaskDsDTOLite(TaskDsDTOLite source) {
        ...
        if (source.TaskType != null) {
            this.TaskType = new TaskTypeVO(source.TaskType);
        }
        ...
        if (source.TaskExt != null) {
            this.TaskExt = new TaskExtVO(source.TaskExt);
        }
        ...
        if (source.Alarms != null) {
            this.Alarms = new AlarmVO[source.Alarms.length];
            for (int i = 0; i < source.Alarms.length; i++) {
                this.Alarms[i] = new AlarmVO(source.Alarms[i]);
            }
        }
        ...
        if (source.Tasks != null) {
            this.Tasks = new TaskDsDTONoRecur[source.Tasks.length];
            for (int i = 0; i < source.Tasks.length; i++) {
                this.Tasks[i] = new TaskDsDTONoRecur(source.Tasks[i]);
            }
        }
        ...
        if (source.DependencyConfigList != null) {
            this.DependencyConfigList = new DependencyConfigDsDTONoRecur[source.DependencyConfigList.length];
            for (int i = 0; i < source.DependencyConfigList.length; i++) {
                this.DependencyConfigList[i] = new DependencyConfigDsDTONoRecur(source.DependencyConfigList[i]);
            }
        }
        ...
        if (source.Params != null) {
            this.Params = new Params[source.Params.length];
            for (int i = 0; i < source.Params.length; i++) {
                this.Params[i] = new Params(source.Params[i]);
            }
        }
