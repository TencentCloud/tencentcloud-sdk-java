...
public class DescribeNewSqlTaskResultResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeNewSqlTaskResultResponse() {
    }
     ...
     */
    public DescribeNewSqlTaskResultResponse(DescribeNewSqlTaskResultResponse source) {
        ...
        if (source.FieldList != null) {
            this.FieldList = new String(source.FieldList);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "FieldList", this.FieldList);
