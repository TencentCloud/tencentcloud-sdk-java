...
public class CloneTaskModePageInfoInfo extends AbstractModel {
    ...
    */
    ...
    @Expose
    private CloneTaskModeInfo [] Items;
     ...
     */
    public CloneTaskModeInfo [] getItems() {
        return this.Items;
    }
     ...
     */
    public void setItems(CloneTaskModeInfo [] Items) {
        this.Items = Items;
    }

    public CloneTaskModePageInfoInfo() {
    }
     ...
     */
    public CloneTaskModePageInfoInfo(CloneTaskModePageInfoInfo source) {
        ...
        if (source.Items != null) {
            this.Items = new CloneTaskModeInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new CloneTaskModeInfo(source.Items[i]);
            }
        }
    }
