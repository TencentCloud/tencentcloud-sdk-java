...
public class ModifyTaskScriptDsRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyTaskScriptDsRequest() {
    }
     ...
     */
    public ModifyTaskScriptDsRequest(ModifyTaskScriptDsRequest source) {
