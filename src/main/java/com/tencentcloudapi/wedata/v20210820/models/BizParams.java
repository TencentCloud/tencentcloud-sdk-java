...
注意：此字段可能返回 null，表示取不到有效值。
    */
    @SerializedName("BizStandCode")
    @Expose
    private String BizStandCode;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * Get 标注编码
注意：此字段可能返回 null，表示取不到有效值。 
     * @return BizStandCode 标注编码
注意：此字段可能返回 null，表示取不到有效值。
     */
    public String getBizStandCode() {
        return this.BizStandCode;
    }

    /**
     * Set 标注编码
注意：此字段可能返回 null，表示取不到有效值。
     * @param BizStandCode 标注编码
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setBizStandCode(String BizStandCode) {
        this.BizStandCode = BizStandCode;
    }
    ...
    public BizParams(BizParams source) {
        ...
        if (source.BizStandCode != null) {
            this.BizStandCode = new String(source.BizStandCode);
        }
    }
