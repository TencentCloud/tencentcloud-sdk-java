...
public class UploadKnowledgeDocumentSetResponse extends AbstractModel {
    ...
    */
     ...
     * @param Data 新增文件返回信息
     */
    public void setData(UploadKnowledgeDocumentSetRsp Data) {
        this.Data = Data;
    }
     ...
     */
    public UploadKnowledgeDocumentSetResponse(UploadKnowledgeDocumentSetResponse source) {
        if (source.Data != null) {
            this.Data = new UploadKnowledgeDocumentSetRsp(source.Data);
        }
