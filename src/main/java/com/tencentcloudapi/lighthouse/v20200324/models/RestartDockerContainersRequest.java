...
public class RestartDockerContainersRequest extends AbstractModel{
    ...
    */
    ...
    public RestartDockerContainersRequest() {
    }
     ...
     */
    public RestartDockerContainersRequest(RestartDockerContainersRequest source) {
