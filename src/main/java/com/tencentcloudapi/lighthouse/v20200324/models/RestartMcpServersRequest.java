...
public class RestartMcpServersRequest extends AbstractModel {
    ...
    */
    ...
    public RestartMcpServersRequest() {
    }
     ...
     */
    public RestartMcpServersRequest(RestartMcpServersRequest source) {
