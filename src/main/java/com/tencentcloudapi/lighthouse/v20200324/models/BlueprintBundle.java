...
public class BlueprintBundle extends AbstractModel {
    ...
    * 套餐类型权重。取值越小排序越靠前。
    */
    @SerializedName("BundleTypePriority")
    @Expose
    private Long BundleTypePriority;
    ...
    * 支持人数。
    */
    @SerializedName("SupportSlot")
    @Expose
    private Long SupportSlot;
...
<li> CLOUD_SSD：SSD 云硬盘</li><li> CLOUD_PREMIUM：高性能云硬盘</li>
    ...
    */
    ...
    /**
     * Get 套餐ID。可以通过[DescribeBundles](https://cloud.tencent.com/document/product/1207/47575)接口返回的BundleId获取。 
     * @return BundleId 套餐ID。可以通过[DescribeBundles](https://cloud.tencent.com/document/product/1207/47575)接口返回的BundleId获取。
     */
    ...
    /**
     * Set 套餐ID。可以通过[DescribeBundles](https://cloud.tencent.com/document/product/1207/47575)接口返回的BundleId获取。
    ...
    /**
     * Get 套餐类型权重。取值越小排序越靠前。 
     * @return BundleTypePriority 套餐类型权重。取值越小排序越靠前。
     */
    public Long getBundleTypePriority() {
        return this.BundleTypePriority;
    }

    /**
     * Set 套餐类型权重。取值越小排序越靠前。
     * @param BundleTypePriority 套餐类型权重。取值越小排序越靠前。
     */
    public void setBundleTypePriority(Long BundleTypePriority) {
        this.BundleTypePriority = BundleTypePriority;
    }
    ...
    /**
     * Get 支持人数。 
     * @return SupportSlot 支持人数。
     */
    public Long getSupportSlot() {
        return this.SupportSlot;
    }
     ...
     */
    public void setSupportSlot(Long SupportSlot) {
        this.SupportSlot = SupportSlot;
    }
...
<li> CLOUD_SSD：SSD 云硬盘</li><li> CLOUD_PREMIUM：高性能云硬盘</li>
     ...
     */
    public BlueprintBundle(BlueprintBundle source) {
        ...
        if (source.BundleTypePriority != null) {
            this.BundleTypePriority = new Long(source.BundleTypePriority);
        }
        if (source.BundleDisplayLabel != null) {
            this.BundleDisplayLabel = new String(source.BundleDisplayLabel);
        }
        if (source.SupportSlot != null) {
            this.SupportSlot = new Long(source.SupportSlot);
        }
