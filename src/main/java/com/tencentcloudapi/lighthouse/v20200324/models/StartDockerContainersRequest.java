...
public class StartDockerContainersRequest extends AbstractModel{
    ...
    */
    ...
    public StartDockerContainersRequest() {
    }
     ...
     */
    public StartDockerContainersRequest(StartDockerContainersRequest source) {
