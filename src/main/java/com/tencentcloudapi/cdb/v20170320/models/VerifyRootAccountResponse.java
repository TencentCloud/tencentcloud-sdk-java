...
public class VerifyRootAccountResponse extends AbstractModel{
    ...
    */
    ...
    public VerifyRootAccountResponse() {
    }
     ...
     */
    public VerifyRootAccountResponse(VerifyRootAccountResponse source) {
