...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeDSPAAssessmentRiskSideListResponse() {
    }
     ...
     */
    public DescribeDSPAAssessmentRiskSideListResponse(DescribeDSPAAssessmentRiskSideListResponse source) {
        if (source.RiskSideItmeList != null) {
            this.RiskSideItmeList = new Note[source.RiskSideItmeList.length];
            for (int i = 0; i < source.RiskSideItmeList.length; i++) {
