...
public class DeleteDSPAMetaResourceResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteDSPAMetaResourceResponse() {
    }
     ...
     */
    public DeleteDSPAMetaResourceResponse(DeleteDSPAMetaResourceResponse source) {
