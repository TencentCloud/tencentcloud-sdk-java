...
public class DescribeExportTaskResultRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeExportTaskResultRequest() {
    }
     ...
     */
    public DescribeExportTaskResultRequest(DescribeExportTaskResultRequest source) {
