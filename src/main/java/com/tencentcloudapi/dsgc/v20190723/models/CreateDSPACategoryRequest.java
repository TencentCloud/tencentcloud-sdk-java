...
public class CreateDSPACategoryRequest extends AbstractModel{
    ...
    */
    ...
    public CreateDSPACategoryRequest() {
    }
     ...
     */
    public CreateDSPACategoryRequest(CreateDSPACategoryRequest source) {
