...
public class VerifyDSPACOSRuleResponse extends AbstractModel {
...
Failed 验证失败
    ...
    public VerifyDSPACOSRuleResponse() {
    }
     ...
     */
    public VerifyDSPACOSRuleResponse(VerifyDSPACOSRuleResponse source) {
