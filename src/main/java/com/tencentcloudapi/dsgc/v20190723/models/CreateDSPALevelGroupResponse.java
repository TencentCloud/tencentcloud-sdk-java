...
public class CreateDSPALevelGroupResponse extends AbstractModel {
    ...
    */
    ...
    public CreateDSPALevelGroupResponse() {
    }
     ...
     */
    public CreateDSPALevelGroupResponse(CreateDSPALevelGroupResponse source) {
