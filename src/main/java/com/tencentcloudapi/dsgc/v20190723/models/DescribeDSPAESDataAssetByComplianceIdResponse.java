...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeDSPAESDataAssetByComplianceIdResponse(DescribeDSPAESDataAssetByComplianceIdResponse source) {
        if (source.Stats != null) {
            this.Stats = new ESDataAssetCountDto(source.Stats);
        }
