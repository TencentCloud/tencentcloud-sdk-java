...
public class DescribeDSPADiscoveryTaskTablesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDSPADiscoveryTaskTablesResponse(DescribeDSPADiscoveryTaskTablesResponse source) {
        if (source.Items != null) {
            this.Items = new DSPATableInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new DSPATableInfo(source.Items[i]);
            }
        }
