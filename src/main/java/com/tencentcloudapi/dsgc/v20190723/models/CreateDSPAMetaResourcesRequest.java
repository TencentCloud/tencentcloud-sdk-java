...
public class CreateDSPAMetaResourcesRequest extends AbstractModel {
    ...
    */
     ...
     * @param Items 资源列表。
     */
    public void setItems(DspaUserResourceMeta [] Items) {
        this.Items = Items;
    }
     ...
     */
    public CreateDSPAMetaResourcesRequest(CreateDSPAMetaResourcesRequest source) {
        ...
        if (source.Items != null) {
            this.Items = new DspaUserResourceMeta[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new DspaUserResourceMeta(source.Items[i]);
            }
        }
    }
