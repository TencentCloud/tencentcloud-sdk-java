...
public class RestartDSPAAssessmentTaskRequest extends AbstractModel{
    ...
    */
    ...
    public RestartDSPAAssessmentTaskRequest() {
    }
     ...
     */
    public RestartDSPAAssessmentTaskRequest(RestartDSPAAssessmentTaskRequest source) {
