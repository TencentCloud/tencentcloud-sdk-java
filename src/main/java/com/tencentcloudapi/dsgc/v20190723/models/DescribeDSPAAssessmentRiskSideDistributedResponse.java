...
public class DescribeDSPAAssessmentRiskSideDistributedResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDSPAAssessmentRiskSideDistributedResponse(DescribeDSPAAssessmentRiskSideDistributedResponse source) {
        if (source.RiskSideDistributed != null) {
            this.RiskSideDistributed = new RiskSideDistributed[source.RiskSideDistributed.length];
            for (int i = 0; i < source.RiskSideDistributed.length; i++) {
                this.RiskSideDistributed[i] = new RiskSideDistributed(source.RiskSideDistributed[i]);
            }
        }
