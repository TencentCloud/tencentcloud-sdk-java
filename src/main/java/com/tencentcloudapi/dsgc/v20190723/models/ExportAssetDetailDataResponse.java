...
public class ExportAssetDetailDataResponse extends AbstractModel {
    ...
    */
    ...
    public ExportAssetDetailDataResponse() {
    }
     ...
     */
    public ExportAssetDetailDataResponse(ExportAssetDetailDataResponse source) {
