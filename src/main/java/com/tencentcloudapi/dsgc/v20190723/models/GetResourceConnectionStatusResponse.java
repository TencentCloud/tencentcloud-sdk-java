...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    /**
     * Get 连接状态，success -- 连接成功，failed -- 连接失败 
    ...
    /**
     * Set 连接状态，success -- 连接成功，failed -- 连接失败
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public GetResourceConnectionStatusResponse(GetResourceConnectionStatusResponse source) {
        if (source.ConnectionStatus != null) {
            this.ConnectionStatus = new String(source.ConnectionStatus);
        }
        if (source.ConnectionDesc != null) {
            this.ConnectionDesc = new String(source.ConnectionDesc);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "ConnectionDesc", this.ConnectionDesc);
