...
selfbuilt-db 表示自建数据库
    */
    ...
    /**
     * Get 用于传入的数据源的条件，目前只支持数据库，所以目前表示数据库的名称，最多添加5个数据库，之间通过逗号分隔 
    ...
    /**
     * Set 用于传入的数据源的条件，目前只支持数据库，所以目前表示数据库的名称，最多添加5个数据库，之间通过逗号分隔
...
selfbuilt-db 表示自建数据库
     ...
     */
    public ModifyDSPADiscoveryTaskRequest(ModifyDSPADiscoveryTaskRequest source) {
