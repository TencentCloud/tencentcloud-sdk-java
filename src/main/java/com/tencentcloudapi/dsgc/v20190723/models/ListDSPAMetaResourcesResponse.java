...
public class ListDSPAMetaResourcesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResources(DspaUserResourceMeta [] Resources) {
     ...
     */
    public ListDSPAMetaResourcesResponse(ListDSPAMetaResourcesResponse source) {
        if (source.DspaId != null) {
            this.DspaId = new String(source.DspaId);
        }
        if (source.Resources != null) {
            this.Resources = new DspaUserResourceMeta[source.Resources.length];
            for (int i = 0; i < source.Resources.length; i++) {
                this.Resources[i] = new DspaUserResourceMeta(source.Resources[i]);
            }
        }
