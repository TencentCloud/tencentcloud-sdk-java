...
public class TerminateResourcePoolPacksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 实例资源池ID列表，支持批量销毁。形如：rpp-6rk3550n。每次请求的实例的上限为100。 
    ...
    /**
     * Set 实例资源池ID列表，支持批量销毁。形如：rpp-6rk3550n。每次请求的实例的上限为100。
    ...
    public TerminateResourcePoolPacksRequest() {
    }
     ...
     */
    public TerminateResourcePoolPacksRequest(TerminateResourcePoolPacksRequest source) {
