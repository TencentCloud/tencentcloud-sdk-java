...
public class ExitRescueModeRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 退出救援模式的实例id。可通过 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728) 接口返回值中的`InstanceId`获取。 
    ...
    /**
     * Set 退出救援模式的实例id。可通过 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728) 接口返回值中的`InstanceId`获取。
