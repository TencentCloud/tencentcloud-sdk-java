...
public class DescribeHpcClustersResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeHpcClustersResponse() {
    }
     ...
     */
    public DescribeHpcClustersResponse(DescribeHpcClustersResponse source) {
