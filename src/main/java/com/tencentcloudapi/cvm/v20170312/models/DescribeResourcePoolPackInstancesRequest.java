...
public class DescribeResourcePoolPackInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 实例资源池ID列表。形如：rpp-39kj2fsb。每次请求的实例的上限为100。 
    ...
    /**
     * Set 实例资源池ID列表。形如：rpp-39kj2fsb。每次请求的实例的上限为100。
    ...
    public DescribeResourcePoolPackInstancesRequest() {
    }
     ...
     */
    public DescribeResourcePoolPackInstancesRequest(DescribeResourcePoolPackInstancesRequest source) {
