...
public class DeleteCloudRunServerRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteCloudRunServerRequest() {
    }
     ...
     */
    public DeleteCloudRunServerRequest(DeleteCloudRunServerRequest source) {
