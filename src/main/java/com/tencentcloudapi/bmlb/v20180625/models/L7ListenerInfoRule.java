...
public class L7ListenerInfoRule extends AbstractModel {
    ...
    */
     ...
     */
    public L7ListenerInfoRule(L7ListenerInfoRule source) {
        ...
        if (source.LocationSet != null) {
            this.LocationSet = new L7ListenerInfoLocation[source.LocationSet.length];
            for (int i = 0; i < source.LocationSet.length; i++) {
                this.LocationSet[i] = new L7ListenerInfoLocation(source.LocationSet[i]);
            }
        }
    }
