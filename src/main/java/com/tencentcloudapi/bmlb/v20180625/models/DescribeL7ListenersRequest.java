...
public class DescribeL7ListenersRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 七层监听器实例ID列表，可通过接口DescribeL7Listeners查询。 
    ...
    /**
     * Set 七层监听器实例ID列表，可通过接口DescribeL7Listeners查询。
     ...
     */
    public DescribeL7ListenersRequest(DescribeL7ListenersRequest source) {
