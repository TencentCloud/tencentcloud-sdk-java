...
public class DescribeL7ListenerInfoResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setListenerSet(L7ListenerInfo [] ListenerSet) {
     ...
     */
    public DescribeL7ListenerInfoResponse(DescribeL7ListenerInfoResponse source) {
        if (source.ListenerSet != null) {
            this.ListenerSet = new L7ListenerInfo[source.ListenerSet.length];
            for (int i = 0; i < source.ListenerSet.length; i++) {
                this.ListenerSet[i] = new L7ListenerInfo(source.ListenerSet[i]);
            }
        }
