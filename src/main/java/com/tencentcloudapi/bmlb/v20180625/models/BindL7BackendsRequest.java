...
public class BindL7BackendsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 待绑定的主机信息。可以绑定多个主机端口。目前一个七层转发路径下面最多允许绑定255个主机端口。 
    ...
    /**
     * Set 待绑定的主机信息。可以绑定多个主机端口。目前一个七层转发路径下面最多允许绑定255个主机端口。
     ...
     */
    public BindL7BackendsRequest(BindL7BackendsRequest source) {
        ...
        if (source.BackendSet != null) {
            this.BackendSet = new BindL7Backend[source.BackendSet.length];
            for (int i = 0; i < source.BackendSet.length; i++) {
                this.BackendSet[i] = new BindL7Backend(source.BackendSet[i]);
            }
        }
