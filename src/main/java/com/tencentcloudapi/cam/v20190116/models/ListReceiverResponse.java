...
public class ListReceiverResponse extends AbstractModel {
    ...
    */
     ...
     */
    public ListReceiverResponse(ListReceiverResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Receivers != null) {
            this.Receivers = new Receiver[source.Receivers.length];
            for (int i = 0; i < source.Receivers.length; i++) {
                this.Receivers[i] = new Receiver(source.Receivers[i]);
            }
        }
