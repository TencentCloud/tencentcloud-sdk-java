...
public class DescribeGoodsRecommendResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setDataList(RecGoodsData [] DataList) {
     ...
     */
    public DescribeGoodsRecommendResponse(DescribeGoodsRecommendResponse source) {
        if (source.DataList != null) {
            this.DataList = new RecGoodsData[source.DataList.length];
            for (int i = 0; i < source.DataList.length; i++) {
                this.DataList[i] = new RecGoodsData(source.DataList[i]);
            }
        }
