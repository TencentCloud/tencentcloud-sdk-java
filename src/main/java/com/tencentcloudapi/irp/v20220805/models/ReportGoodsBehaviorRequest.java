...
public class ReportGoodsBehaviorRequest extends AbstractModel{
    ...
    */
     ...
     */
    public void setGoodsBehaviorList(GoodsBehaviorInfo [] GoodsBehaviorList) {
        this.GoodsBehaviorList = GoodsBehaviorList;
    }
     ...
     */
    public ReportGoodsBehaviorRequest(ReportGoodsBehaviorRequest source) {
        if (source.InstanceId != null) {
            this.InstanceId = new String(source.InstanceId);
        }
        if (source.GoodsBehaviorList != null) {
            this.GoodsBehaviorList = new GoodsBehaviorInfo[source.GoodsBehaviorList.length];
            for (int i = 0; i < source.GoodsBehaviorList.length; i++) {
                this.GoodsBehaviorList[i] = new GoodsBehaviorInfo(source.GoodsBehaviorList[i]);
            }
        }
    }
