...
public class GetLLMDiagnosisDrugChatResponse extends SSEResponseModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private LLMDiagnosisDrugData Data;
    ...
    */
     ...
     */
    public LLMDiagnosisDrugData getData() {
        return this.Data;
    }
     ...
     * @param Data <p>返回数据</p>
     */
    public void setData(LLMDiagnosisDrugData Data) {
        this.Data = Data;
    }
    ...
    public GetLLMDiagnosisDrugChatResponse() {
    }
     ...
     */
    public GetLLMDiagnosisDrugChatResponse(GetLLMDiagnosisDrugChatResponse source) {
        if (source.Code != null) {
        ...
        if (source.Data != null) {
            this.Data = new LLMDiagnosisDrugData(source.Data);
        }
