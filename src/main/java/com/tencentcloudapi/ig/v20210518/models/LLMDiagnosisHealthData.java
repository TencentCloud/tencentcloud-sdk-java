...
public class LLMDiagnosisHealthData extends AbstractModel {
    ...
    */
    ...
    @Expose
    private HealthFollowUpQuestion [] FollowUpQuestions;
    ...
    */
    ...
    /**
     * Get <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p> 
     * @return FollowUpQuestions <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
     */
    public HealthFollowUpQuestion [] getFollowUpQuestions() {
        return this.FollowUpQuestions;
    }

    /**
     * Set <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
     * @param FollowUpQuestions <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
     */
    public void setFollowUpQuestions(HealthFollowUpQuestion [] FollowUpQuestions) {
     ...
     */
    public LLMDiagnosisHealthData(LLMDiagnosisHealthData source) {
        ...
        if (source.RiskReminder != null) {
            this.RiskReminder = new String(source.RiskReminder);
        }
        ...
        if (source.FollowUpQuestions != null) {
            this.FollowUpQuestions = new HealthFollowUpQuestion[source.FollowUpQuestions.length];
            for (int i = 0; i < source.FollowUpQuestions.length; i++) {
                this.FollowUpQuestions[i] = new HealthFollowUpQuestion(source.FollowUpQuestions[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "RiskReminder", this.RiskReminder);
        ...
        this.setParamArrayObj(map, prefix + "FollowUpQuestions.", this.FollowUpQuestions);
