...
public class GetLLMReportInterpretationResponse extends SSEResponseModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private LLMReportInterpretationData Data;
    ...
    */
     ...
     */
    public LLMReportInterpretationData getData() {
        return this.Data;
    }
     ...
     * @param Data <p>返回数据</p>
     */
    public void setData(LLMReportInterpretationData Data) {
        this.Data = Data;
    }
    ...
    public GetLLMReportInterpretationResponse() {
    }
     ...
     */
    public GetLLMReportInterpretationResponse(GetLLMReportInterpretationResponse source) {
        if (source.Code != null) {
        ...
        if (source.Data != null) {
            this.Data = new LLMReportInterpretationData(source.Data);
        }
