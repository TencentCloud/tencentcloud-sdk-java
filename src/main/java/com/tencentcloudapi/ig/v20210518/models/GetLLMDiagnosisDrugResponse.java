...
public class GetLLMDiagnosisDrugResponse extends SSEResponseModel {
    ...
    */
    ...
    public GetLLMDiagnosisDrugResponse() {
    }
     ...
     */
    public GetLLMDiagnosisDrugResponse(GetLLMDiagnosisDrugResponse source) {
        if (source.Code != null) {
