...
public class StandardDrugCardInfo extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DrugCardInfo [] DrugInfos;
     ...
     */
    public DrugCardInfo [] getDrugInfos() {
     ...
     */
    public void setDrugInfos(DrugCardInfo [] DrugInfos) {
        this.DrugInfos = DrugInfos;
    }

    public StandardDrugCardInfo() {
    }
     ...
     */
    public StandardDrugCardInfo(StandardDrugCardInfo source) {
        if (source.StandardDrugName != null) {
            this.StandardDrugName = new String(source.StandardDrugName);
        }
        if (source.DrugInfos != null) {
            this.DrugInfos = new DrugCardInfo[source.DrugInfos.length];
            for (int i = 0; i < source.DrugInfos.length; i++) {
                this.DrugInfos[i] = new DrugCardInfo(source.DrugInfos[i]);
            }
        }
    }
