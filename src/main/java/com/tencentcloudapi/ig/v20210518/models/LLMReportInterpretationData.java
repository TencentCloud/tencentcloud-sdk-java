...
public class LLMReportInterpretationData extends AbstractModel {
    ...
    */
    ...
    @Expose
    private ReportFileInfoRsp [] ReportInfos;
    ...
    */
    ...
    /**
     * Get <p>是否支持报告类型，false:否，true:是； 默认返回true，不支持的报告类型返回false</p> 
     * @return IsSupportFile <p>是否支持报告类型，false:否，true:是； 默认返回true，不支持的报告类型返回false</p>
     */
    public Boolean getIsSupportFile() {
        return this.IsSupportFile;
    }

    /**
     * Set <p>是否支持报告类型，false:否，true:是； 默认返回true，不支持的报告类型返回false</p>
     * @param IsSupportFile <p>是否支持报告类型，false:否，true:是； 默认返回true，不支持的报告类型返回false</p>
     */
    public void setIsSupportFile(Boolean IsSupportFile) {
        this.IsSupportFile = IsSupportFile;
    }

    /**
     * Get <p>返回的报告列表，和传入报告文件顺序一致</p> 
     * @return ReportInfos <p>返回的报告列表，和传入报告文件顺序一致</p>
     */
    public ReportFileInfoRsp [] getReportInfos() {
        return this.ReportInfos;
    }

    /**
     * Set <p>返回的报告列表，和传入报告文件顺序一致</p>
     * @param ReportInfos <p>返回的报告列表，和传入报告文件顺序一致</p>
     */
    public void setReportInfos(ReportFileInfoRsp [] ReportInfos) {
    ...
    public LLMReportInterpretationData() {
    }
     ...
     */
    public LLMReportInterpretationData(LLMReportInterpretationData source) {
        ...
        if (source.IsSupportFile != null) {
            this.IsSupportFile = new Boolean(source.IsSupportFile);
        }
        if (source.ReportInfos != null) {
            this.ReportInfos = new ReportFileInfoRsp[source.ReportInfos.length];
            for (int i = 0; i < source.ReportInfos.length; i++) {
                this.ReportInfos[i] = new ReportFileInfoRsp(source.ReportInfos[i]);
            }
        }
