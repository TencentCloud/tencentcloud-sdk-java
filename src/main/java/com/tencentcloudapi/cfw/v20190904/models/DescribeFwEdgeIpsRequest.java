...
public class DescribeFwEdgeIpsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeFwEdgeIpsRequest() {
    }
     ...
     */
    public DescribeFwEdgeIpsRequest(DescribeFwEdgeIpsRequest source) {
