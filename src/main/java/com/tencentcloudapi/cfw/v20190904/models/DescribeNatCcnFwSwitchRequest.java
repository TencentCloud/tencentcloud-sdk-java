...
public class DescribeNatCcnFwSwitchRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeNatCcnFwSwitchRequest() {
    }
     ...
     */
    public DescribeNatCcnFwSwitchRequest(DescribeNatCcnFwSwitchRequest source) {
