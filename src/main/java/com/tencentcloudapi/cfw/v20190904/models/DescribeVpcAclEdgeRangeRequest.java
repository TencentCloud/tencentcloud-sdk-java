...
public class DescribeVpcAclEdgeRangeRequest extends AbstractModel {

    /**
    * 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
    */
    @SerializedName("FromList")
    @Expose
    ...
    */
    ...
    /**
     * Get 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表 
     * @return FromList 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
     */
    ...
    /**
     * Set 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
    ...
    public DescribeVpcAclEdgeRangeRequest() {
    }
     ...
     */
    public DescribeVpcAclEdgeRangeRequest(DescribeVpcAclEdgeRangeRequest source) {
        if (source.FromList != null) {
            this.FromList = new String(source.FromList);
        }
