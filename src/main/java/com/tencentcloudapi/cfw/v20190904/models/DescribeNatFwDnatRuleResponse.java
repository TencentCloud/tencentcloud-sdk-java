...
public class DescribeNatFwDnatRuleResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeNatFwDnatRuleResponse(DescribeNatFwDnatRuleResponse source) {
        if (source.Data != null) {
            this.Data = new DescNatDnatRule[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new DescNatDnatRule(source.Data[i]);
            }
        }
