...
public class DescribeNatFwDnatRuleRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，可不传</p> 
    ...
    /**
     * Set <p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，可不传</p>
    ...
    public DescribeNatFwDnatRuleRequest() {
    }
     ...
     */
    public DescribeNatFwDnatRuleRequest(DescribeNatFwDnatRuleRequest source) {
