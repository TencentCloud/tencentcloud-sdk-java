...
public class CheckClusterVpcFwPreAccessResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>检查项清单，按执行顺序返回。前端据此渲染检查项骨架，描述文案已按请求的 Language 返回对应语言（中文/英文）。检查通过轮询 DescribeClusterVpcFwSwitchs 接口读取 CheckResult 获取每个阶段的通过/失败状态。</p> 
    ...
    /**
     * Set <p>检查项清单，按执行顺序返回。前端据此渲染检查项骨架，描述文案已按请求的 Language 返回对应语言（中文/英文）。检查通过轮询 DescribeClusterVpcFwSwitchs 接口读取 CheckResult 获取每个阶段的通过/失败状态。</p>
    ...
    public CheckClusterVpcFwPreAccessResponse() {
    }
     ...
     */
    public CheckClusterVpcFwPreAccessResponse(CheckClusterVpcFwPreAccessResponse source) {
