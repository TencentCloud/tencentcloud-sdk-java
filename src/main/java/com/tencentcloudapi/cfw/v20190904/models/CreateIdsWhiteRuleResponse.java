...
public class CreateIdsWhiteRuleResponse extends AbstractModel {
...
-1 通用错误，不用处理
    ...
    public CreateIdsWhiteRuleResponse() {
    }
     ...
     */
    public CreateIdsWhiteRuleResponse(CreateIdsWhiteRuleResponse source) {
