...
public class DescribeIpsRuleListNewRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeIpsRuleListNewRequest() {
    }
     ...
     */
    public DescribeIpsRuleListNewRequest(DescribeIpsRuleListNewRequest source) {
