...
public class DescribeVpcFwGroupSwitchRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeVpcFwGroupSwitchRequest() {
    }
     ...
     */
    public DescribeVpcFwGroupSwitchRequest(DescribeVpcFwGroupSwitchRequest source) {
