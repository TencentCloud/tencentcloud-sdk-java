...
public class ModifyClusterNatFwSwitchRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyClusterNatFwSwitchRequest() {
    }
     ...
     */
    public ModifyClusterNatFwSwitchRequest(ModifyClusterNatFwSwitchRequest source) {
