...
public class DescribeCfwAlertsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCfwAlertsResponse() {
    }
     ...
     */
    public DescribeCfwAlertsResponse(DescribeCfwAlertsResponse source) {
        if (source.Data != null) {
