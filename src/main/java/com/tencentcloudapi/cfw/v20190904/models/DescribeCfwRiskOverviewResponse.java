...
public class DescribeCfwRiskOverviewResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCfwRiskOverviewResponse() {
    }
     ...
     */
    public DescribeCfwRiskOverviewResponse(DescribeCfwRiskOverviewResponse source) {
        if (source.Data != null) {
