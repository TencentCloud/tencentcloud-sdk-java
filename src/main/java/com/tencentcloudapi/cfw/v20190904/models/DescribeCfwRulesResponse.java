...
public class DescribeCfwRulesResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCfwRulesResponse() {
    }
     ...
     */
    public DescribeCfwRulesResponse(DescribeCfwRulesResponse source) {
        if (source.Data != null) {
