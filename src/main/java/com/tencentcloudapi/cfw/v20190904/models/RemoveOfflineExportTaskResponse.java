...
public class RemoveOfflineExportTaskResponse extends AbstractModel {
    ...
    */
    ...
    public RemoveOfflineExportTaskResponse() {
    }
     ...
     */
    public RemoveOfflineExportTaskResponse(RemoveOfflineExportTaskResponse source) {
