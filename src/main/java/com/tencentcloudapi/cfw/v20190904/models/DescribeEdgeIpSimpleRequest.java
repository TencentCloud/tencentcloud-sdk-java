...
public class DescribeEdgeIpSimpleRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeEdgeIpSimpleRequest() {
    }
     ...
     */
    public DescribeEdgeIpSimpleRequest(DescribeEdgeIpSimpleRequest source) {
