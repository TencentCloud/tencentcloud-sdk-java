...
public class CfwClient extends AbstractClient{
     ...
     * @throws TencentCloudSDKException
     */
    public CloseClusterNatFwSwitchResponse CloseClusterNatFwSwitch(CloseClusterNatFwSwitchRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CloseClusterNatFwSwitch", CloseClusterNatFwSwitchResponse.class);
    }
     ...
     * @throws TencentCloudSDKException
     */
    public CreateAlertCenterRuleAsyncResponse CreateAlertCenterRuleAsync(CreateAlertCenterRuleAsyncRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateAlertCenterRuleAsync", CreateAlertCenterRuleAsyncResponse.class);
    }
...
2.如果传入实例ID列表为空，则返回CCN关联的所有实例的地域防火墙引流网络部署状态
     ...
     * @return DescribeClusterNatCcnFwSwitchListResponse
     * @throws TencentCloudSDKException
     */
    public DescribeClusterNatCcnFwSwitchListResponse DescribeClusterNatCcnFwSwitchList(DescribeClusterNatCcnFwSwitchListRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeClusterNatCcnFwSwitchList", DescribeClusterNatCcnFwSwitchListResponse.class);
    }
     ...
     * @throws TencentCloudSDKException
     */
    public DescribeNDRAssetIdentificationListResponse DescribeNDRAssetIdentificationList(DescribeNDRAssetIdentificationListRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeNDRAssetIdentificationList", DescribeNDRAssetIdentificationListResponse.class);
    }

    /**
     *DescribeNDRDataLeakOutAlertDetail -- 查询出站数据泄露风险详情
     * @param req DescribeNDRDataLeakOutAlertDetailRequest
     * @return DescribeNDRDataLeakOutAlertDetailResponse
     * @throws TencentCloudSDKException
     */
    public DescribeNDRDataLeakOutAlertDetailResponse DescribeNDRDataLeakOutAlertDetail(DescribeNDRDataLeakOutAlertDetailRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeNDRDataLeakOutAlertDetail", DescribeNDRDataLeakOutAlertDetailResponse.class);
    }
     ...
     * @return DescribeNatCcnFwSwitchResponse
     * @throws TencentCloudSDKException
     */
    public DescribeNatCcnFwSwitchResponse DescribeNatCcnFwSwitch(DescribeNatCcnFwSwitchRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeNatCcnFwSwitch", DescribeNatCcnFwSwitchResponse.class);
    }

    /**
     *查询指定NAT所在地域是否有NAT防火墙引流集群
     * @param req DescribeNatFwClusterRegionStatusRequest
     * @return DescribeNatFwClusterRegionStatusResponse
     * @throws TencentCloudSDKException
     */
    public DescribeNatFwClusterRegionStatusResponse DescribeNatFwClusterRegionStatus(DescribeNatFwClusterRegionStatusRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeNatFwClusterRegionStatus", DescribeNatFwClusterRegionStatusResponse.class);
    }
     ...
     * @throws TencentCloudSDKException
     */
    public DescribeOfflineExportTaskResponse DescribeOfflineExportTask(DescribeOfflineExportTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeOfflineExportTask", DescribeOfflineExportTaskResponse.class);
    }

    /**
     *获取日志离线导出任务文件下载临时凭证
     * @param req DescribeOfflineExportTemporaryCredentialsRequest
     * @return DescribeOfflineExportTemporaryCredentialsResponse
     * @throws TencentCloudSDKException
     */
    public DescribeOfflineExportTemporaryCredentialsResponse DescribeOfflineExportTemporaryCredentials(DescribeOfflineExportTemporaryCredentialsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeOfflineExportTemporaryCredentials", DescribeOfflineExportTemporaryCredentialsResponse.class);
    }
     ...
     * @return ExportLogsOfflineResponse
     * @throws TencentCloudSDKException
     */
    public ExportLogsOfflineResponse ExportLogsOffline(ExportLogsOfflineRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ExportLogsOffline", ExportLogsOfflineResponse.class);
    }
...
批量修改封禁IP、放通IP/域名生效事件
     ...
     * @return ModifyClusterFwBypassResponse
     * @throws TencentCloudSDKException
     */
    public ModifyClusterFwBypassResponse ModifyClusterFwBypass(ModifyClusterFwBypassRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyClusterFwBypass", ModifyClusterFwBypassResponse.class);
    }

    /**
     *修改NAT CCN集群模式防火墙开关配置
     * @param req ModifyClusterNatFwSwitchRequest
     * @return ModifyClusterNatFwSwitchResponse
     * @throws TencentCloudSDKException
     */
    public ModifyClusterNatFwSwitchResponse ModifyClusterNatFwSwitch(ModifyClusterNatFwSwitchRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyClusterNatFwSwitch", ModifyClusterNatFwSwitchResponse.class);
    }
...
VPC间规则需指定EdgeId。Nat边界规则需指定地域Region与Direction。
     ...
     * @throws TencentCloudSDKException
     */
    public ModifyIsolateTableResponse ModifyIsolateTable(ModifyIsolateTableRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyIsolateTable", ModifyIsolateTableResponse.class);
    }
     ...
     * @return OpenClusterNatFwSwitchResponse
     * @throws TencentCloudSDKException
     */
    public OpenClusterNatFwSwitchResponse OpenClusterNatFwSwitch(OpenClusterNatFwSwitchRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "OpenClusterNatFwSwitch", OpenClusterNatFwSwitchResponse.class);
    }
     ...
     * @return RemoveOfflineExportTaskResponse
     * @throws TencentCloudSDKException
     */
    public RemoveOfflineExportTaskResponse RemoveOfflineExportTask(RemoveOfflineExportTaskRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "RemoveOfflineExportTask", RemoveOfflineExportTaskResponse.class);
    }
