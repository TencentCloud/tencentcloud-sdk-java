...
public class VpcClient extends AbstractClient{
     ...
     * @return DescribeNatsEipsInternalResponse
     * @throws TencentCloudSDKException
     */
    public DescribeNatsEipsInternalResponse DescribeNatsEipsInternal(DescribeNatsEipsInternalRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeNatsEipsInternal", DescribeNatsEipsInternalResponse.class);
    }
