...
public class DescribeProductQuotaResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeProductQuotaResponse(DescribeProductQuotaResponse source) {
        if (source.ProductQuotaSet != null) {
            this.ProductQuotaSet = new ProductQuota[source.ProductQuotaSet.length];
            for (int i = 0; i < source.ProductQuotaSet.length; i++) {
                this.ProductQuotaSet[i] = new ProductQuota(source.ProductQuotaSet[i]);
            }
        }
