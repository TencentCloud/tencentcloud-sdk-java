...
public class CheckDefaultSubnetResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 检查结果。true为可以创建默认子网，false为不可以创建默认子网。 
    ...
    /**
     * Set 检查结果。true为可以创建默认子网，false为不可以创建默认子网。
    ...
    public CheckDefaultSubnetResponse() {
    }
     ...
     */
    public CheckDefaultSubnetResponse(CheckDefaultSubnetResponse source) {
