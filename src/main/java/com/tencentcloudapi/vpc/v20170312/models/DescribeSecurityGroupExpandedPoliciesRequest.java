...
public class DescribeSecurityGroupExpandedPoliciesRequest extends AbstractModel {
...
<li>description - String - 协议描述，该过滤条件支持模糊匹配。</li>
    ...
    public DescribeSecurityGroupExpandedPoliciesRequest() {
    }
     ...
     */
    public DescribeSecurityGroupExpandedPoliciesRequest(DescribeSecurityGroupExpandedPoliciesRequest source) {
