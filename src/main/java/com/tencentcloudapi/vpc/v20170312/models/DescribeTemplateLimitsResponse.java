...
public class DescribeTemplateLimitsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeTemplateLimitsResponse(DescribeTemplateLimitsResponse source) {
        if (source.TemplateLimit != null) {
            this.TemplateLimit = new TemplateLimit(source.TemplateLimit);
        }
