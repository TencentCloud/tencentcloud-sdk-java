...
public class DescribeCcnRouteTableInputPolicysResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setPolicySet(CcnRouteTableInputPolicys [] PolicySet) {
     ...
     */
    public DescribeCcnRouteTableInputPolicysResponse(DescribeCcnRouteTableInputPolicysResponse source) {
        if (source.PolicySet != null) {
            this.PolicySet = new CcnRouteTableInputPolicys[source.PolicySet.length];
            for (int i = 0; i < source.PolicySet.length; i++) {
                this.PolicySet[i] = new CcnRouteTableInputPolicys(source.PolicySet[i]);
            }
        }
