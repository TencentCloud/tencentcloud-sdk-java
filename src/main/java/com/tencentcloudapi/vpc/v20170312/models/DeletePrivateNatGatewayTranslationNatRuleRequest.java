...
public class DeletePrivateNatGatewayTranslationNatRuleRequest extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TranslationNatRule [] TranslationNatRules;
    ...
    */
     ...
     */
    public TranslationNatRule [] getTranslationNatRules() {
     ...
     */
    public void setTranslationNatRules(TranslationNatRule [] TranslationNatRules) {
    ...
    public DeletePrivateNatGatewayTranslationNatRuleRequest() {
    }
     ...
     */
    public DeletePrivateNatGatewayTranslationNatRuleRequest(DeletePrivateNatGatewayTranslationNatRuleRequest source) {
        if (source.NatGatewayId != null) {
            this.NatGatewayId = new String(source.NatGatewayId);
        }
        if (source.TranslationNatRules != null) {
            this.TranslationNatRules = new TranslationNatRule[source.TranslationNatRules.length];
            for (int i = 0; i < source.TranslationNatRules.length; i++) {
                this.TranslationNatRules[i] = new TranslationNatRule(source.TranslationNatRules[i]);
            }
        }
