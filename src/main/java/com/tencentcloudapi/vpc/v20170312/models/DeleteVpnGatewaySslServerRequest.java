...
public class DeleteVpnGatewaySslServerRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteVpnGatewaySslServerRequest() {
    }
     ...
     */
    public DeleteVpnGatewaySslServerRequest(DeleteVpnGatewaySslServerRequest source) {
