...
public class DisableVpnGatewaySslClientCertRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。 
    ...
    /**
     * Set SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。
     ...
     */
    public DisableVpnGatewaySslClientCertRequest(DisableVpnGatewaySslClientCertRequest source) {
