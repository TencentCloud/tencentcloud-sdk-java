...
public class CreateHighPriorityRoutesRequest extends AbstractModel {
    ...
    */
    ...
    public CreateHighPriorityRoutesRequest() {
    }
     ...
     */
    public CreateHighPriorityRoutesRequest(CreateHighPriorityRoutesRequest source) {
