...
public class CreateNetworkAclEntriesRequest extends AbstractModel{
    ...
    */
    ...
    public CreateNetworkAclEntriesRequest() {
    }
     ...
     */
    public CreateNetworkAclEntriesRequest(CreateNetworkAclEntriesRequest source) {
