...
public class TranslationNatRule extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 转换规则类型，可选值"NETWORK_LAYER","TRANSPORT_LAYER"。分别对应三层和四层。 
    ...
    /**
     * Set 转换规则类型，可选值"NETWORK_LAYER","TRANSPORT_LAYER"。分别对应三层和四层。
     ...
     */
    public TranslationNatRule(TranslationNatRule source) {
