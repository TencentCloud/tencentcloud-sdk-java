...
public class DescribeAddressTemplateGroupInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get IP地址组实例ID。例如：ipmg-12345678。 
    ...
    /**
     * Set IP地址组实例ID。例如：ipmg-12345678。
    ...
    public DescribeAddressTemplateGroupInstancesRequest() {
    }
     ...
     */
    public DescribeAddressTemplateGroupInstancesRequest(DescribeAddressTemplateGroupInstancesRequest source) {
