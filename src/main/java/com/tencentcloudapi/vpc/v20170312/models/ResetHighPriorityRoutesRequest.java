...
public class ResetHighPriorityRoutesRequest extends AbstractModel {
    ...
    */
    ...
    public ResetHighPriorityRoutesRequest() {
    }
     ...
     */
    public ResetHighPriorityRoutesRequest(ResetHighPriorityRoutesRequest source) {
