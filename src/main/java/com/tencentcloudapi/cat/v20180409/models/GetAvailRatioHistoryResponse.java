...
public class GetAvailRatioHistoryResponse extends AbstractModel{
    ...
    */
    ...
    public GetAvailRatioHistoryResponse() {
    }
     ...
     */
    public GetAvailRatioHistoryResponse(GetAvailRatioHistoryResponse source) {
