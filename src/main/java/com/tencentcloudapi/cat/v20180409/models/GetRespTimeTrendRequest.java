...
public class GetRespTimeTrendRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 可为 Isp, Province 
     * @return Dimentions 可为 Isp, Province
     */
    ...
    /**
     * Get 可为  totalTime, parseTime, connectTime, sendTime, waitTime, receiveTime 
     * @return MetricName 可为  totalTime, parseTime, connectTime, sendTime, waitTime, receiveTime
     */
    ...
    /**
     * Set 可为  totalTime, parseTime, connectTime, sendTime, waitTime, receiveTime
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArraySimple(map, prefix + "Dimentions.", this.Dimentions);
