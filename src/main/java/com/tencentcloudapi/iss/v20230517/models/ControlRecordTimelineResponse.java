...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public ControlRecordTimelineResponse(ControlRecordTimelineResponse source) {
        if (source.Data != null) {
            this.Data = new Timeline[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new Timeline(source.Data[i]);
            }
        }
