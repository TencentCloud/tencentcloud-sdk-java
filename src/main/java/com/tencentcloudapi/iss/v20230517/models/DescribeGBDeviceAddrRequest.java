...
public class DescribeGBDeviceAddrRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeGBDeviceAddrRequest() {
    }
     ...
     */
    public DescribeGBDeviceAddrRequest(DescribeGBDeviceAddrRequest source) {
