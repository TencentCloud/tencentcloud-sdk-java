...
public class DescribeGatewayMonitorRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeGatewayMonitorRequest() {
    }
     ...
     */
    public DescribeGatewayMonitorRequest(DescribeGatewayMonitorRequest source) {
