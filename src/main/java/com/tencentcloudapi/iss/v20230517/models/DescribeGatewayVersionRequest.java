...
public class DescribeGatewayVersionRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeGatewayVersionRequest() {
    }
     ...
     */
    public DescribeGatewayVersionRequest(DescribeGatewayVersionRequest source) {
