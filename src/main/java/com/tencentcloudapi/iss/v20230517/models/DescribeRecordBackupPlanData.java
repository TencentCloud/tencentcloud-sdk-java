...
public class DescribeRecordBackupPlanData extends AbstractModel {
    ...
    */
    ...
    public DescribeRecordBackupPlanData() {
    }
     ...
     */
    public DescribeRecordBackupPlanData(DescribeRecordBackupPlanData source) {
