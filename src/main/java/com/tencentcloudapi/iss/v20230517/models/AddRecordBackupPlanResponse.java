...
public class AddRecordBackupPlanResponse extends AbstractModel{
    ...
    */
     ...
     * @param Data 返回数据
     */
    public void setData(AddRecordBackupPlanData Data) {
        this.Data = Data;
    }
     ...
     */
    public AddRecordBackupPlanResponse(AddRecordBackupPlanResponse source) {
        if (source.Data != null) {
            this.Data = new AddRecordBackupPlanData(source.Data);
        }
