...
public class ChefHatAIResultInfo extends AbstractModel{
    ...
    */
    ...
    public ChefHatAIResultInfo(ChefHatAIResultInfo source) {
        ...
        if (source.ChefHatInfo != null) {
            this.ChefHatInfo = new BaseAIResultInfo[source.ChefHatInfo.length];
            for (int i = 0; i < source.ChefHatInfo.length; i++) {
                this.ChefHatInfo[i] = new BaseAIResultInfo(source.ChefHatInfo[i]);
            }
        }
    }
