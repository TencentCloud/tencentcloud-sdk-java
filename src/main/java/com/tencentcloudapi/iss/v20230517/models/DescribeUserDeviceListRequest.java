...
public class DescribeUserDeviceListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeUserDeviceListRequest() {
    }
     ...
     */
    public DescribeUserDeviceListRequest(DescribeUserDeviceListRequest source) {
