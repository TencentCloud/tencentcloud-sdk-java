...
public class DescribeDeviceChannelRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDeviceChannelRequest() {
    }
     ...
     */
    public DescribeDeviceChannelRequest(DescribeDeviceChannelRequest source) {
