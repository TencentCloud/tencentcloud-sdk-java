...
public class UpdateRecordBackupTemplateModify extends AbstractModel{
    ...
    */
    ...
    public UpdateRecordBackupTemplateModify() {
    }
     ...
     */
    public UpdateRecordBackupTemplateModify(UpdateRecordBackupTemplateModify source) {
