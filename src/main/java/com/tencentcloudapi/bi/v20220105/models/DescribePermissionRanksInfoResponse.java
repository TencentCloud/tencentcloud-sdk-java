...
public class DescribePermissionRanksInfoResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribePermissionRanksInfoResponse() {
    }
     ...
     */
    public DescribePermissionRanksInfoResponse(DescribePermissionRanksInfoResponse source) {
        ...
        if (source.Data != null) {
            this.Data = new RankInfo(source.Data);
        }
