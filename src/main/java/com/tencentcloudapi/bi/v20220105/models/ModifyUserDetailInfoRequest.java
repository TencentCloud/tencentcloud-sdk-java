...
public class ModifyUserDetailInfoRequest extends AbstractModel {
    ...
    */
     ...
     */
    public Long [] getUserGroupIdList() {
     ...
     */
    public void setUserGroupIdList(Long [] UserGroupIdList) {
        this.UserGroupIdList = UserGroupIdList;
    }

    public ModifyUserDetailInfoRequest() {
    }
     ...
     */
    public ModifyUserDetailInfoRequest(ModifyUserDetailInfoRequest source) {
        ...
        if (source.UserGroupIdList != null) {
            this.UserGroupIdList = new Long[source.UserGroupIdList.length];
            for (int i = 0; i < source.UserGroupIdList.length; i++) {
                this.UserGroupIdList[i] = new Long(source.UserGroupIdList[i]);
            }
        }
    }
