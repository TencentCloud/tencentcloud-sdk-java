...
public class DescribeFileSampleRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeFileSampleRequest() {
    }
     ...
     */
    public DescribeFileSampleRequest(DescribeFileSampleRequest source) {
