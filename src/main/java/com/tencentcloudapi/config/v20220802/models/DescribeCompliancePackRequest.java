...
public class DescribeCompliancePackRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCompliancePackRequest() {
    }
     ...
     */
    public DescribeCompliancePackRequest(DescribeCompliancePackRequest source) {
