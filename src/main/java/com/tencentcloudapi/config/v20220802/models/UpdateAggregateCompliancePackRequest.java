...
public class UpdateAggregateCompliancePackRequest extends AbstractModel {
    ...
    */
     ...
     */
    public UpdateAggregateCompliancePackRequest(UpdateAggregateCompliancePackRequest source) {
