...
public class AddCompliancePackResponse extends AbstractModel {
    ...
    */
    ...
    public AddCompliancePackResponse() {
    }
     ...
     */
    public AddCompliancePackResponse(AddCompliancePackResponse source) {
