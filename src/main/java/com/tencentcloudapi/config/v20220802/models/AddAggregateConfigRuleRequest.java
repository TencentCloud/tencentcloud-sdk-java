...
public class AddAggregateConfigRuleRequest extends AbstractModel {
...
3：低风险。
    ...
    public AddAggregateConfigRuleRequest() {
    }
     ...
     */
    public AddAggregateConfigRuleRequest(AddAggregateConfigRuleRequest source) {
