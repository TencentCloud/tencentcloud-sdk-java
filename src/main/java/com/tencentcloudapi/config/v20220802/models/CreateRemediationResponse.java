...
public class CreateRemediationResponse extends AbstractModel {
    ...
    */
    ...
    public CreateRemediationResponse() {
    }
     ...
     */
    public CreateRemediationResponse(CreateRemediationResponse source) {
