...
public class AddCompliancePackRequest extends AbstractModel {
    ...
    */
    ...
    public AddCompliancePackRequest() {
    }
     ...
     */
    public AddCompliancePackRequest(AddCompliancePackRequest source) {
