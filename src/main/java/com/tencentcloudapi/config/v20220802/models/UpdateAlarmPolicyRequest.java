...
public class UpdateAlarmPolicyRequest extends AbstractModel {
    ...
    */
    ...
    public UpdateAlarmPolicyRequest() {
    }
     ...
     */
    public UpdateAlarmPolicyRequest(UpdateAlarmPolicyRequest source) {
