...
public class DescribeDatahubTasksResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private DescribeDatahubTasksRes Result;
    ...
    */
    ...
    public DescribeDatahubTasksResponse() {
    }
     ...
     */
    public DescribeDatahubTasksResponse(DescribeDatahubTasksResponse source) {
        if (source.Result != null) {
            this.Result = new DescribeDatahubTasksRes(source.Result);
        }
