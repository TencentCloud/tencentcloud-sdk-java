...
public class ModifyThrottleRuleResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyThrottleRuleResponse() {
    }
     ...
     */
    public ModifyThrottleRuleResponse(ModifyThrottleRuleResponse source) {
