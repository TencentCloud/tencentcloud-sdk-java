...
public class CreateMetaDataAndOffsetSyncDatahubTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p> 
    ...
    /**
     * Set <p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
    ...
    /**
     * Get <p>同步目标链接</p><p>参数格式：resource-test</p> 
    ...
    /**
     * Set <p>同步目标链接</p><p>参数格式：resource-test</p>
    ...
    /**
     * Get <p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul> 
    ...
    /**
     * Set <p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
    ...
    public CreateMetaDataAndOffsetSyncDatahubTaskRequest() {
    }
     ...
     */
    public CreateMetaDataAndOffsetSyncDatahubTaskRequest(CreateMetaDataAndOffsetSyncDatahubTaskRequest source) {
