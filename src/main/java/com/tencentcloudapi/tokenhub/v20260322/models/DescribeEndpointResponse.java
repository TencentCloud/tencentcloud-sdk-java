...
public class DescribeEndpointResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeEndpointResponse(DescribeEndpointResponse source) {
        if (source.Endpoint != null) {
            this.Endpoint = new EndpointDetail(source.Endpoint);
        }
