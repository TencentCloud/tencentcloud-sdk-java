...
public class ApiKeyDetail extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 绑定类型。取值：all（全部模型和服务）、model_all_endpoint_custom（全部模型+自定义服务）、model_custom_endpoint_all（自定义模型+全部服务）、model_custom_endpoint_custom（自定义模型+自定义服务）。 
    ...
    /**
     * Set 绑定类型。取值：all（全部模型和服务）、model_all_endpoint_custom（全部模型+自定义服务）、model_custom_endpoint_all（自定义模型+全部服务）、model_custom_endpoint_custom（自定义模型+自定义服务）。
    ...
    /**
     * Get IP 白名单列表。支持 IPv4 和 CIDR 格式。空数组表示不限制 IP。 
    ...
    /**
     * Set IP 白名单列表。支持 IPv4 和 CIDR 格式。空数组表示不限制 IP。
