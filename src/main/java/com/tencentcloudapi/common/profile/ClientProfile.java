...
public class ClientProfile {
    ...
    /**
     * Whether to disable region-level domain failover. When false (default), the
     ...
     * switch.
     */
    private boolean disableRegionBreaker = false;
    ...
    /**
     * @return true if region-level domain failover is disabled, false otherwise (default).
     */
    public boolean isDisableRegionBreaker() {
        return this.disableRegionBreaker;
    }

    /**
     * Enable or disable region-level domain failover. See {@link #disableRegionBreaker}.
     *
     * @param disabled true to disable, false to enable (default).
     */
    public void setDisableRegionBreaker(boolean disabled) {
        this.disableRegionBreaker = disabled;
    }
}
