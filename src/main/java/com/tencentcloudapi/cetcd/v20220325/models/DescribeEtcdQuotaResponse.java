...
public class DescribeEtcdQuotaResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeEtcdQuotaResponse() {
    }
     ...
     */
    public DescribeEtcdQuotaResponse(DescribeEtcdQuotaResponse source) {
