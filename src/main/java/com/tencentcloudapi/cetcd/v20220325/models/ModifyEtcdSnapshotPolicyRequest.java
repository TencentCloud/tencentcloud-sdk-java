...
public class ModifyEtcdSnapshotPolicyRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyEtcdSnapshotPolicyRequest() {
    }
     ...
     */
    public ModifyEtcdSnapshotPolicyRequest(ModifyEtcdSnapshotPolicyRequest source) {
