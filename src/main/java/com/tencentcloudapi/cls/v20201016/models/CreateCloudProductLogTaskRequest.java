...
- APIS所有日志类型：gz
    ...
    /**
     * Get 日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填 
    ...
    /**
     * Set 日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
    ...
    /**
     * Get 日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填 
    ...
    /**
     * Set 日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
     ...
     */
    public CreateCloudProductLogTaskRequest(CreateCloudProductLogTaskRequest source) {
