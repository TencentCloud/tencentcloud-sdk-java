...
public class CreateResourceGraphRequest extends AbstractModel {
    ...
    */
    ...
    public CreateResourceGraphRequest() {
    }
     ...
     */
    public CreateResourceGraphRequest(CreateResourceGraphRequest source) {
        if (source.Name != null) {
