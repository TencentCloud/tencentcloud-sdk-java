...
public class DeleteCloudProductLogTaskRequest extends AbstractModel {
...
- APIS所有日志类型：gz
    ...
    public DeleteCloudProductLogTaskRequest() {
    }
     ...
     */
    public DeleteCloudProductLogTaskRequest(DeleteCloudProductLogTaskRequest source) {
