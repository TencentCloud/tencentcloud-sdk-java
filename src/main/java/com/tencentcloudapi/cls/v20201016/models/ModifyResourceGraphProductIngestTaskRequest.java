...
public class ModifyResourceGraphProductIngestTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>eBPF 采集规则（仅 EBPF 产品）</p>
     * @param EBPFCollectRule <p>eBPF 采集规则（仅 EBPF 产品）</p>
     */
    ...
    public ModifyResourceGraphProductIngestTaskRequest() {
    }
     ...
     */
    public ModifyResourceGraphProductIngestTaskRequest(ModifyResourceGraphProductIngestTaskRequest source) {
