...
public class DeleteResourceGraphRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DeleteResourceGraphRequest(DeleteResourceGraphRequest source) {
