...
⚠️注意：通过SSE流式调用此接口时，请务必设置请求域名（Endpoint）为 cls.ai.tencentcloudapi.com (VPC内网环境可配置 cls.ai.internal.tencentcloudapi.com）。
    ...
    /**
     *本接口用于创建Agent应用
     * @param req CreateAgentApplicationRequest
     * @return CreateAgentApplicationResponse
     * @throws TencentCloudSDKException
     */
    public CreateAgentApplicationResponse CreateAgentApplication(CreateAgentApplicationRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateAgentApplication", CreateAgentApplicationResponse.class);
    }
...
- 重建索引时间范围以日志时间为准，日志上传时间与重建索引时间范围有超过1小时的偏差时（例如16:00上传了一条02:00的日志到 CLS，重建00:00～12:00的日志索引）不会被重建且后续无法进行检索。新上报一条日志到已经被重建的日志时间范围时，也不会被重建且后续无法进行检索。
     ...
     * @throws TencentCloudSDKException
     */
    public CreateS3RechargeResponse CreateS3Recharge(CreateS3RechargeRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateS3Recharge", CreateS3RechargeResponse.class);
    }
    ...
    /**
     *本接口用于删除Agent应用
     * @param req DeleteAgentApplicationRequest
     * @return DeleteAgentApplicationResponse
     * @throws TencentCloudSDKException
     */
    public DeleteAgentApplicationResponse DeleteAgentApplication(DeleteAgentApplicationRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DeleteAgentApplication", DeleteAgentApplicationResponse.class);
    }
    ...
    /**
     *本接口用于删除aws导入任务
     * @param req DeleteS3RechargeRequest
     * @return DeleteS3RechargeResponse
     * @throws TencentCloudSDKException
     */
    public DeleteS3RechargeResponse DeleteS3Recharge(DeleteS3RechargeRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DeleteS3Recharge", DeleteS3RechargeResponse.class);
    }
    ...
    /**
     *获取Agent应用列表
     * @param req DescribeAgentApplicationsRequest
     * @return DescribeAgentApplicationsResponse
     * @throws TencentCloudSDKException
     */
    public DescribeAgentApplicationsResponse DescribeAgentApplications(DescribeAgentApplicationsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeAgentApplications", DescribeAgentApplicationsResponse.class);
    }

    /**
     *获取agent对应的采集配置
     * @param req DescribeAgentConfigsRequest
     * @return DescribeAgentConfigsResponse
     * @throws TencentCloudSDKException
     */
    public DescribeAgentConfigsResponse DescribeAgentConfigs(DescribeAgentConfigsRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeAgentConfigs", DescribeAgentConfigsResponse.class);
    }
...
API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * @throws TencentCloudSDKException
     */
    public DescribeS3RechargesResponse DescribeS3Recharges(DescribeS3RechargesRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeS3Recharges", DescribeS3RechargesResponse.class);
    }
...
API 中 Region 填写任意一个地域均可，建议使用广州(ap-guangzhou)
    ...
    /**
     *本接口用于修改Agent应用
     * @param req ModifyAgentApplicationRequest
     * @return ModifyAgentApplicationResponse
     * @throws TencentCloudSDKException
     */
    public ModifyAgentApplicationResponse ModifyAgentApplication(ModifyAgentApplicationRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyAgentApplication", ModifyAgentApplicationResponse.class);
    }
...
注意：修改接口直接覆盖历史数据，改为本次合法入参数据，请谨慎调用此接口。
     ...
     * @throws TencentCloudSDKException
     */
    public ModifyS3RechargeResponse ModifyS3Recharge(ModifyS3RechargeRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyS3Recharge", ModifyS3RechargeResponse.class);
    }
...
2. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
    ...
    /**
     *本接口用于预览aws导入信息
     * @param req SearchS3RechargeInfoRequest
     * @return SearchS3RechargeInfoResponse
     * @throws TencentCloudSDKException
     */
    public SearchS3RechargeInfoResponse SearchS3RechargeInfo(SearchS3RechargeInfoRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "SearchS3RechargeInfo", SearchS3RechargeInfoResponse.class);
    }
