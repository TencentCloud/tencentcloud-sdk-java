...
public class DescribeVpcResourceResponse extends AbstractModel{
    ...
    */
    ...
    public void setVpcResourceSet(VpcResource [] VpcResourceSet) {
        this.VpcResourceSet = VpcResourceSet;
    }
     ...
     */
    public DescribeVpcResourceResponse(DescribeVpcResourceResponse source) {
        if (source.VpcResourceSet != null) {
            this.VpcResourceSet = new VpcResource[source.VpcResourceSet.length];
            for (int i = 0; i < source.VpcResourceSet.length; i++) {
                this.VpcResourceSet[i] = new VpcResource(source.VpcResourceSet[i]);
            }
        }
