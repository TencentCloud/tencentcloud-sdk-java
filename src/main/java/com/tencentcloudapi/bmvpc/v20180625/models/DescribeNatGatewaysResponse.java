...
public class DescribeNatGatewaysResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeNatGatewaysResponse(DescribeNatGatewaysResponse source) {
        if (source.NatGatewayInfoSet != null) {
            this.NatGatewayInfoSet = new NatGatewayInfo[source.NatGatewayInfoSet.length];
            for (int i = 0; i < source.NatGatewayInfoSet.length; i++) {
                this.NatGatewayInfoSet[i] = new NatGatewayInfo(source.NatGatewayInfoSet[i]);
            }
        }
