...
public class ApplyCreditAuditResponse extends AbstractModel{
    ...
    */
    ...
    public ApplyCreditAuditResponse() {
    }
     ...
     */
    public ApplyCreditAuditResponse(ApplyCreditAuditResponse source) {
