...
public class ApplyBlackListRequest extends AbstractModel{
    ...
    */
     ...
     */
    public ApplyBlackListRequest(ApplyBlackListRequest source) {
        ...
        if (source.BlackList != null) {
            this.BlackList = new SingleBlackApply[source.BlackList.length];
            for (int i = 0; i < source.BlackList.length; i++) {
                this.BlackList[i] = new SingleBlackApply(source.BlackList[i]);
            }
        }
