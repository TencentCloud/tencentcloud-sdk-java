...
public class QueryRecordListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setRecordList(RecordInfo [] RecordList) {
     ...
     */
    public QueryRecordListResponse(QueryRecordListResponse source) {
        if (source.RecordList != null) {
            this.RecordList = new RecordInfo[source.RecordList.length];
            for (int i = 0; i < source.RecordList.length; i++) {
                this.RecordList[i] = new RecordInfo(source.RecordList[i]);
            }
        }
