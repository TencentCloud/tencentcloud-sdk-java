...
public class DescribeFlowResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>running表示进行中；success表示成功；paused表示暂停；failed表示失败</p> 
     * @return Status <p>running表示进行中；success表示成功；paused表示暂停；failed表示失败</p>
     */
    ...
    /**
     * Set <p>running表示进行中；success表示成功；paused表示暂停；failed表示失败</p>
