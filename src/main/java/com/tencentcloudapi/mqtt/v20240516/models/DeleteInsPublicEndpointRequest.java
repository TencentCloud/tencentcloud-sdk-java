...
public class DeleteInsPublicEndpointRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteInsPublicEndpointRequest() {
    }
     ...
     */
    public DeleteInsPublicEndpointRequest(DeleteInsPublicEndpointRequest source) {
