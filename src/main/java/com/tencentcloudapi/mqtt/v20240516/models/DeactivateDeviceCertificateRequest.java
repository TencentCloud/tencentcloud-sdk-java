...
public class DeactivateDeviceCertificateRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、设备证书文件中获得。 
    ...
    /**
     * Set 设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、设备证书文件中获得。
    ...
    public DeactivateDeviceCertificateRequest() {
    }
     ...
     */
    public DeactivateDeviceCertificateRequest(DeactivateDeviceCertificateRequest source) {
