...
public class ApplyRegistrationCodeResponse extends AbstractModel {
    ...
    */
    ...
    public ApplyRegistrationCodeResponse() {
    }
     ...
     */
    public ApplyRegistrationCodeResponse(ApplyRegistrationCodeResponse source) {
