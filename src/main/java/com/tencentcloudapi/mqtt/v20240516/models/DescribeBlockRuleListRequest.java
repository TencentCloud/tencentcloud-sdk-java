...
public class DescribeBlockRuleListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBlockRuleListRequest() {
    }
     ...
     */
    public DescribeBlockRuleListRequest(DescribeBlockRuleListRequest source) {
