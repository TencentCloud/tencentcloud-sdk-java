...
public class DescribeInsVPCEndpointsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeInsVPCEndpointsRequest() {
    }
     ...
     */
    public DescribeInsVPCEndpointsRequest(DescribeInsVPCEndpointsRequest source) {
