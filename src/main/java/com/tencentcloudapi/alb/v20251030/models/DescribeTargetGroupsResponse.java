...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    @Expose
    private TargetGroupOutput [] TargetGroups;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public TargetGroupOutput [] getTargetGroups() {
     ...
     */
    public void setTargetGroups(TargetGroupOutput [] TargetGroups) {
    ...
    public DescribeTargetGroupsResponse(DescribeTargetGroupsResponse source) {
        ...
        if (source.TargetGroups != null) {
            this.TargetGroups = new TargetGroupOutput[source.TargetGroups.length];
            for (int i = 0; i < source.TargetGroups.length; i++) {
                this.TargetGroups[i] = new TargetGroupOutput(source.TargetGroups[i]);
            }
        }
