...
public class GetTotalRequestStatisticsResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public GetTotalRequestStatisticsResponse() {
    }
     ...
     */
    public GetTotalRequestStatisticsResponse(GetTotalRequestStatisticsResponse source) {
        if (source.Data != null) {
