...
public class DescribeWorkSpaceUsersRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeWorkSpaceUsersRequest() {
    }
     ...
     */
    public DescribeWorkSpaceUsersRequest(DescribeWorkSpaceUsersRequest source) {
