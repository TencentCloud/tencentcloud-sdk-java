...
public class DescribeResourcesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setResourceSet(ResourceItem [] ResourceSet) {
    ...
    public DescribeResourcesResponse(DescribeResourcesResponse source) {
        if (source.ResourceSet != null) {
            this.ResourceSet = new ResourceItem[source.ResourceSet.length];
            for (int i = 0; i < source.ResourceSet.length; i++) {
                this.ResourceSet[i] = new ResourceItem(source.ResourceSet[i]);
            }
        }
