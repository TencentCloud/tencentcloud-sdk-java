...
public class KnowledgeScope extends AbstractModel {
    ...
    */
     ...
     */
    public LabelRef [] getLabelRefList() {
     ...
     */
    public void setLabelRefList(LabelRef [] LabelRefList) {
     ...
     */
    public KnowledgeScope(KnowledgeScope source) {
        if (source.EffectiveDomain != null) {
            this.EffectiveDomain = new Long(source.EffectiveDomain);
        }
        if (source.LabelRefList != null) {
            this.LabelRefList = new LabelRef[source.LabelRefList.length];
            for (int i = 0; i < source.LabelRefList.length; i++) {
                this.LabelRefList[i] = new LabelRef(source.LabelRefList[i]);
            }
        }
    }
