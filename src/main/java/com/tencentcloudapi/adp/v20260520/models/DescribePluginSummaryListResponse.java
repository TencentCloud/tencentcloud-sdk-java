...
public class DescribePluginSummaryListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribePluginSummaryListResponse() {
    }
     ...
     */
    public DescribePluginSummaryListResponse(DescribePluginSummaryListResponse source) {
        if (source.PluginList != null) {
            this.PluginList = new PluginSummary[source.PluginList.length];
            for (int i = 0; i < source.PluginList.length; i++) {
                this.PluginList[i] = new PluginSummary(source.PluginList[i]);
            }
        }
