...
public class DescribeAppTriggerRunLogListRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeAppTriggerRunLogListRequest(DescribeAppTriggerRunLogListRequest source) {
