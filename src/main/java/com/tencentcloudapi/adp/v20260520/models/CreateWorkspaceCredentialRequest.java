...
public class CreateWorkspaceCredentialRequest extends AbstractModel {
    ...
    */
    ...
    public CreateWorkspaceCredentialRequest() {
    }
     ...
     */
    public CreateWorkspaceCredentialRequest(CreateWorkspaceCredentialRequest source) {
        if (source.Type != null) {
