...
public class CreateChannelRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>渠道规格（场景/类型/名称/备注/配置，必填）</p> 
    ...
    /**
     * Set <p>渠道规格（场景/类型/名称/备注/配置，必填）</p>
     ...
     */
    public CreateChannelRequest(CreateChannelRequest source) {
