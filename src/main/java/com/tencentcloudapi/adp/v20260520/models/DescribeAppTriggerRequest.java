...
public class DescribeAppTriggerRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAppTriggerRequest() {
    }
     ...
     */
    public DescribeAppTriggerRequest(DescribeAppTriggerRequest source) {
