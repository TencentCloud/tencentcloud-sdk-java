...
public class DescribeLabelSummaryListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeLabelSummaryListRequest() {
    }
     ...
     */
    public DescribeLabelSummaryListRequest(DescribeLabelSummaryListRequest source) {
        if (source.KbId != null) {
