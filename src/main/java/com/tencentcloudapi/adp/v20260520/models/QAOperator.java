...
public class QAOperator extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private QAPermission Permission;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public QAPermission getPermission() {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setPermission(QAPermission Permission) {
     ...
     */
    public QAOperator(QAOperator source) {
        if (source.Modifier != null) {
            this.Modifier = new Operator(source.Modifier);
        }
        if (source.Permission != null) {
            this.Permission = new QAPermission(source.Permission);
        }
    }
