...
public class DocQuery extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>查询关键词（名称模糊搜索）</p> 
     * @return Query <p>查询关键词（名称模糊搜索）</p>
     */
    ...
    /**
     * Get <p>查询范围（query 作用的字段）：1=文件名，2=标签或标签值；支持多选，缺省时无效</p> 
     * @return QueryScopeList <p>查询范围（query 作用的字段）：1=文件名，2=标签或标签值；支持多选，缺省时无效</p>
     */
    ...
    /**
     * Set <p>查询范围（query 作用的字段）：1=文件名，2=标签或标签值；支持多选，缺省时无效</p>
     ...
     */
    public DocQuery(DocQuery source) {
