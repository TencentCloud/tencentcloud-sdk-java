...
public class CreateWebSocketTokenRequest extends AbstractModel {
    ...
    */
    ...
    public CreateWebSocketTokenRequest() {
    }
     ...
     */
    public CreateWebSocketTokenRequest(CreateWebSocketTokenRequest source) {
        if (source.Type != null) {
