...
public class CreateQAGenerationTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>待生成 QA 的文档 ID 列表（数量：1~20）</p> 
    ...
    /**
     * Set <p>待生成 QA 的文档 ID 列表（数量：1~20）</p>
    ...
    public CreateQAGenerationTaskRequest() {
    }
     ...
     */
    public CreateQAGenerationTaskRequest(CreateQAGenerationTaskRequest source) {
