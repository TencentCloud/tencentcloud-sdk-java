...
public class ConversationAgentTask extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>任务状态，pending:待执行，processing:处理中，success:已完成，failed:处理失败，stop:已取消</p> 
    ...
    /**
     * Set <p>任务状态，pending:待执行，processing:处理中，success:已完成，failed:处理失败，stop:已取消</p>
     ...
     */
    public ConversationAgentTask(ConversationAgentTask source) {
