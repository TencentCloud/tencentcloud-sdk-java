...
public class CreateQAGenerationTaskResponse extends AbstractModel {
    ...
    */
    ...
    public CreateQAGenerationTaskResponse() {
    }
     ...
     */
    public CreateQAGenerationTaskResponse(CreateQAGenerationTaskResponse source) {
