...
public class DeleteSkillShareResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>是否走审批流（false 表示无需审批已直接执行下架）</p> 
    ...
    /**
     * Set <p>是否走审批流（false 表示无需审批已直接执行下架）</p>
    ...
    public DeleteSkillShareResponse() {
    }
     ...
     */
    public DeleteSkillShareResponse(DeleteSkillShareResponse source) {
