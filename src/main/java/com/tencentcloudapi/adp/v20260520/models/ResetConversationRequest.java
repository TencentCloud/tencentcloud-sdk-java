...
public class ResetConversationRequest extends AbstractModel {
    ...
    */
    ...
    public ResetConversationRequest() {
    }
     ...
     */
    public ResetConversationRequest(ResetConversationRequest source) {
