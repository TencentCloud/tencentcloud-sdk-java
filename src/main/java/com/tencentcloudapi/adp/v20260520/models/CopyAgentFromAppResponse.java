...
public class CopyAgentFromAppResponse extends AbstractModel {
    ...
    */
    ...
    public CopyAgentFromAppResponse() {
    }
     ...
     */
    public CopyAgentFromAppResponse(CopyAgentFromAppResponse source) {
