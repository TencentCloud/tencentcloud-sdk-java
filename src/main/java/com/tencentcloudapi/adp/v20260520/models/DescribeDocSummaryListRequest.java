...
public class DescribeDocSummaryListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>过滤条件（多个 Filter 之间为 AND 关系，同一 Filter 的多个 Values 为 OR 关系）：Status-文档状态,枚举值,精确匹配; CategoryId-分类ID,精确匹配; SourceType-文档来源类型,枚举值,精确匹配; EffectiveDomain-生效作用域,精确匹配; CreateTime-创建时间,Unix秒,BETWEEN 传 [起始秒,结束秒]; UpdateTime-更新时间,Unix秒,BETWEEN 传 [起始秒,结束秒]</p> 
    ...
    /**
     * Set <p>过滤条件（多个 Filter 之间为 AND 关系，同一 Filter 的多个 Values 为 OR 关系）：Status-文档状态,枚举值,精确匹配; CategoryId-分类ID,精确匹配; SourceType-文档来源类型,枚举值,精确匹配; EffectiveDomain-生效作用域,精确匹配; CreateTime-创建时间,Unix秒,BETWEEN 传 [起始秒,结束秒]; UpdateTime-更新时间,Unix秒,BETWEEN 传 [起始秒,结束秒]</p>
    ...
    /**
     * Get <p>查询条件（关键词 + 查询范围）</p> 
     * @return Query <p>查询条件（关键词 + 查询范围）</p>
     */
    public DocQuery getQuery() {
        return this.Query;
    }

    /**
     * Set <p>查询条件（关键词 + 查询范围）</p>
     * @param Query <p>查询条件（关键词 + 查询范围）</p>
     */
    public void setQuery(DocQuery Query) {
        this.Query = Query;
    }
    ...
    public DescribeDocSummaryListRequest() {
    }
     ...
     */
    public DescribeDocSummaryListRequest(DescribeDocSummaryListRequest source) {
        if (source.KbId != null) {
        ...
        if (source.Query != null) {
            this.Query = new DocQuery(source.Query);
        }
