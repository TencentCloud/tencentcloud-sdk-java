...
public class ModifyMsgRecordCategoryRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyMsgRecordCategoryRequest() {
    }
     ...
     */
    public ModifyMsgRecordCategoryRequest(ModifyMsgRecordCategoryRequest source) {
