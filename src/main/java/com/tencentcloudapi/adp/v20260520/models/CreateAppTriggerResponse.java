...
public class CreateAppTriggerResponse extends AbstractModel {
    ...
    */
    ...
    public CreateAppTriggerResponse() {
    }
     ...
     */
    public CreateAppTriggerResponse(CreateAppTriggerResponse source) {
