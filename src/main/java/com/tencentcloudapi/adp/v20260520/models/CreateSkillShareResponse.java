...
public class CreateSkillShareResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>是否走了审批流（false表示无需审批已直接创建共享任务）</p> 
    ...
    /**
     * Set <p>是否走了审批流（false表示无需审批已直接创建共享任务）</p>
    ...
    public CreateSkillShareResponse() {
    }
     ...
     */
    public CreateSkillShareResponse(CreateSkillShareResponse source) {
