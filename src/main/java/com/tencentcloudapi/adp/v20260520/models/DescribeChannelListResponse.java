...
public class DescribeChannelListResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeChannelListResponse() {
    }
     ...
     */
    public DescribeChannelListResponse(DescribeChannelListResponse source) {
        if (source.ChannelList != null) {
            this.ChannelList = new Channel[source.ChannelList.length];
            for (int i = 0; i < source.ChannelList.length; i++) {
                this.ChannelList[i] = new Channel(source.ChannelList[i]);
            }
        }
