...
public class CreateRateLimitV2Request extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 支持API或Domain，如果是基于API，则LimitPaths不能为空，否则LimitPaths为空 
    ...
    /**
     * Set 支持API或Domain，如果是基于API，则LimitPaths不能为空，否则LimitPaths为空
    ...
    public CreateRateLimitV2Request() {
    }
     ...
     */
    public CreateRateLimitV2Request(CreateRateLimitV2Request source) {
