...
public class ModifyWafAutoDenyRulesResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyWafAutoDenyRulesResponse() {
    }
     ...
     */
    public ModifyWafAutoDenyRulesResponse(ModifyWafAutoDenyRulesResponse source) {
