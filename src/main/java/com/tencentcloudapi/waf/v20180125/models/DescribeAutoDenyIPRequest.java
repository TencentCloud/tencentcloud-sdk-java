...
public class DescribeAutoDenyIPRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeAutoDenyIPRequest() {
    }
     ...
     */
    public DescribeAutoDenyIPRequest(DescribeAutoDenyIPRequest source) {
