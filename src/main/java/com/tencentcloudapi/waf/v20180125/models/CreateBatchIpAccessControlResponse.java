...
public class CreateBatchIpAccessControlResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 添加失败的域名列表，如果非空则表示有域名添加失败，整个批量规则添加失败，否则则表示批量规则添加成功。 
    ...
    /**
     * Set 添加失败的域名列表，如果非空则表示有域名添加失败，整个批量规则添加失败，否则则表示批量规则添加成功。
    ...
    public CreateBatchIpAccessControlResponse() {
    }
     ...
     */
    public CreateBatchIpAccessControlResponse(CreateBatchIpAccessControlResponse source) {
