...
public class LLMMonPkg extends AbstractModel {
...
0 手动续费；1自动续费；2 到期不续
     ...
     */
    public void setUseToken(Long UseToken) {
     ...
     */
    public LLMMonPkg(LLMMonPkg source) {
        ...
        if (source.UseToken != null) {
            this.UseToken = new Long(source.UseToken);
        }
