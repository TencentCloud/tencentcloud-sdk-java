...
public class ModifyBatchCustomWhiteRuleRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyBatchCustomWhiteRuleRequest() {
    }
     ...
     */
    public ModifyBatchCustomWhiteRuleRequest(ModifyBatchCustomWhiteRuleRequest source) {
        if (source.ID != null) {
