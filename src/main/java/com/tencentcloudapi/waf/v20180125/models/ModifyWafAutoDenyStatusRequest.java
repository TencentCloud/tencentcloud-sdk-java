...
public class ModifyWafAutoDenyStatusRequest extends AbstractModel{
    ...
    */
    ...
    public ModifyWafAutoDenyStatusRequest() {
    }
     ...
     */
    public ModifyWafAutoDenyStatusRequest(ModifyWafAutoDenyStatusRequest source) {
