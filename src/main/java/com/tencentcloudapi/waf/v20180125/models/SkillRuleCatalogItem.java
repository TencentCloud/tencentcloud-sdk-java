...
public class SkillRuleCatalogItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>规则分类标识（如 static_analysis、ai_analysis）</p> 
     * @return Key <p>规则分类标识（如 static_analysis、ai_analysis）</p>
     */
    ...
    /**
     * Set <p>规则分类标识（如 static_analysis、ai_analysis）</p>
