...
public class DescribeCCAutoStatusResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCCAutoStatusResponse() {
    }
     ...
     */
    public DescribeCCAutoStatusResponse(DescribeCCAutoStatusResponse source) {
        if (source.AutoCCSwitch != null) {
            this.AutoCCSwitch = new Long(source.AutoCCSwitch);
        }
