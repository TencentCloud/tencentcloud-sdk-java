...
public class DescribeShopTrafficInfoRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeShopTrafficInfoRequest() {
    }
     ...
     */
    public DescribeShopTrafficInfoRequest(DescribeShopTrafficInfoRequest source) {
