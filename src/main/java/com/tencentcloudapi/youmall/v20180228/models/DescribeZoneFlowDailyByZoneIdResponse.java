...
public class DescribeZoneFlowDailyByZoneIdResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeZoneFlowDailyByZoneIdResponse() {
    }
     ...
     */
    public DescribeZoneFlowDailyByZoneIdResponse(DescribeZoneFlowDailyByZoneIdResponse source) {
        ...
        if (source.Data != null) {
            this.Data = new ZoneDayFlow[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new ZoneDayFlow(source.Data[i]);
            }
        }
