...
public class DescribeZoneFlowGenderAvrStayTimeByZoneIdResponse extends AbstractModel{
    ...
    */
    @SerializedName("Data")
    @Expose
    private ZoneAgeGroupAvrStayTime [] Data;
    ...
    */
     ...
     */
    public ZoneAgeGroupAvrStayTime [] getData() {
        return this.Data;
    }
    ...
    public DescribeZoneFlowGenderAvrStayTimeByZoneIdResponse(DescribeZoneFlowGenderAvrStayTimeByZoneIdResponse source) {
        ...
        if (source.Data != null) {
            this.Data = new ZoneAgeGroupAvrStayTime[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new ZoneAgeGroupAvrStayTime(source.Data[i]);
            }
        }
