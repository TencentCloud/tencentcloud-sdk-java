...
public class CreateVulsReportResponse extends AbstractModel{
    ...
    */
    ...
    public CreateVulsReportResponse() {
    }
     ...
     */
    public CreateVulsReportResponse(CreateVulsReportResponse source) {
