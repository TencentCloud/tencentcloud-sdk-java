...
public class DescribeDBAutonomyActionsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setActions(AutonomyActionVo [] Actions) {
     ...
     */
    public DescribeDBAutonomyActionsResponse(DescribeDBAutonomyActionsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Actions != null) {
            this.Actions = new AutonomyActionVo[source.Actions.length];
            for (int i = 0; i < source.Actions.length; i++) {
                this.Actions[i] = new AutonomyActionVo(source.Actions[i]);
            }
        }
