...
public class DescribeAlarmTemplateResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setProfileList(AlarmProfileList [] ProfileList) {
     ...
     */
    public DescribeAlarmTemplateResponse(DescribeAlarmTemplateResponse source) {
        if (source.ProfileList != null) {
            this.ProfileList = new AlarmProfileList[source.ProfileList.length];
            for (int i = 0; i < source.ProfileList.length; i++) {
                this.ProfileList[i] = new AlarmProfileList(source.ProfileList[i]);
            }
        }
