...
public class UpdateDatabaseAutonomyStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>开关状态。取值：0（关闭）、1（开启）。</p> 
     * @return Status <p>开关状态。取值：0（关闭）、1（开启）。</p>
     */
    ...
    public UpdateDatabaseAutonomyStatusRequest() {
    }
     ...
     */
    public UpdateDatabaseAutonomyStatusRequest(UpdateDatabaseAutonomyStatusRequest source) {
