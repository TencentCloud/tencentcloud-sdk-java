...
public class DescribeSqlTemplateRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSqlTemplateRequest() {
    }
     ...
     */
    public DescribeSqlTemplateRequest(DescribeSqlTemplateRequest source) {
