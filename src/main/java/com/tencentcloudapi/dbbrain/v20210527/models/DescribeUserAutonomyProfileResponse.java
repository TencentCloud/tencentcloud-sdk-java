...
public class DescribeUserAutonomyProfileResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setProfileInfo(AutonomyUserProfileInfo ProfileInfo) {
     ...
     */
    public DescribeUserAutonomyProfileResponse(DescribeUserAutonomyProfileResponse source) {
        ...
        if (source.ProfileInfo != null) {
            this.ProfileInfo = new AutonomyUserProfileInfo(source.ProfileInfo);
        }
