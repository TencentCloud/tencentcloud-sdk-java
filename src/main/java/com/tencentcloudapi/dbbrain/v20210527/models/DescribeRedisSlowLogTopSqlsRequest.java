...
public class DescribeRedisSlowLogTopSqlsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 服务产品类型，支持值： "redis" - 云数据库 Redis。 
    ...
    /**
     * Set 服务产品类型，支持值： "redis" - 云数据库 Redis。
    ...
    /**
     * Get 排序键，支持ExecTimes,QueryTime,QueryTimeMax,QueryTimeAvg等排序键，默认为QueryTime。 
    ...
    /**
     * Set 排序键，支持ExecTimes,QueryTime,QueryTimeMax,QueryTimeAvg等排序键，默认为QueryTime。
    ...
    public DescribeRedisSlowLogTopSqlsRequest() {
    }
     ...
     */
    public DescribeRedisSlowLogTopSqlsRequest(DescribeRedisSlowLogTopSqlsRequest source) {
