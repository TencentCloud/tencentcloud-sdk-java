...
public class RestoreAndroidInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public RestoreAndroidInstanceRequest() {
    }
     ...
     */
    public RestoreAndroidInstanceRequest(RestoreAndroidInstanceRequest source) {
