...
public class DescribeAndroidInstanceTasksStatusResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeAndroidInstanceTasksStatusResponse(DescribeAndroidInstanceTasksStatusResponse source) {
        if (source.TaskStatusSet != null) {
            this.TaskStatusSet = new AndroidInstanceTaskStatus[source.TaskStatusSet.length];
