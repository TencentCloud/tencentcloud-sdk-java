...
public class StopAndroidInstancesAppRequest extends AbstractModel {
    ...
    */
    ...
    public StopAndroidInstancesAppRequest() {
    }
     ...
     */
    public StopAndroidInstancesAppRequest(StopAndroidInstancesAppRequest source) {
