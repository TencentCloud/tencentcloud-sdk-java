...
public class CreateAndroidAppResponse extends AbstractModel {
    ...
    */
    ...
    public CreateAndroidAppResponse() {
    }
     ...
     */
    public CreateAndroidAppResponse(CreateAndroidAppResponse source) {
