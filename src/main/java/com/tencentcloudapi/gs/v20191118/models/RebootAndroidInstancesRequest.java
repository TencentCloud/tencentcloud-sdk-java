...
public class RebootAndroidInstancesRequest extends AbstractModel {
    ...
    */
    ...
    public RebootAndroidInstancesRequest() {
    }
     ...
     */
    public RebootAndroidInstancesRequest(RebootAndroidInstancesRequest source) {
