...
public class ModifyAndroidInstancesResourcesRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyAndroidInstancesResourcesRequest() {
    }
     ...
     */
    public ModifyAndroidInstancesResourcesRequest(ModifyAndroidInstancesResourcesRequest source) {
        ...
        if (source.MemoryQuota != null) {
            this.MemoryQuota = new Long(source.MemoryQuota);
        }
    }
