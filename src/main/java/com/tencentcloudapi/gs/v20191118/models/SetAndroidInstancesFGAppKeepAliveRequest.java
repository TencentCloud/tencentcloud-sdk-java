...
public class SetAndroidInstancesFGAppKeepAliveRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 操作类型，取值：ENABLE 开启保活、DISABLE 关闭保活。当关闭保活时，PackageName 参数传空即可 
    ...
    /**
     * Set 操作类型，取值：ENABLE 开启保活、DISABLE 关闭保活。当关闭保活时，PackageName 参数传空即可
    ...
    /**
     * Get 应用包名，开启保活时，必须传入 PackageName 
    ...
    /**
     * Set 应用包名，开启保活时，必须传入 PackageName
    ...
    public SetAndroidInstancesFGAppKeepAliveRequest() {
    }
     ...
     */
    public SetAndroidInstancesFGAppKeepAliveRequest(SetAndroidInstancesFGAppKeepAliveRequest source) {
