...
public class ConnectAndroidInstanceResponse extends AbstractModel {
    ...
    */
    ...
    public ConnectAndroidInstanceResponse() {
    }
     ...
     */
    public ConnectAndroidInstanceResponse(ConnectAndroidInstanceResponse source) {
