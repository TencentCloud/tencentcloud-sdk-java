...
public class AndroidInstanceInformation extends AbstractModel {
    ...
    */
    ...
    public AndroidInstanceInformation() {
    }
     ...
     */
    public AndroidInstanceInformation(AndroidInstanceInformation source) {
