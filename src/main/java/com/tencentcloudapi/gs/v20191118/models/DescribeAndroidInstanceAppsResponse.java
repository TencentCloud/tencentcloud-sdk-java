...
public class DescribeAndroidInstanceAppsResponse extends AbstractModel {
    ...
    */
     ...
     * @param Apps 安卓应用列表
     */
    public void setApps(AndroidInstanceAppInfo [] Apps) {
        this.Apps = Apps;
    }
     ...
     */
    public DescribeAndroidInstanceAppsResponse(DescribeAndroidInstanceAppsResponse source) {
        if (source.Apps != null) {
            this.Apps = new AndroidInstanceAppInfo[source.Apps.length];
            for (int i = 0; i < source.Apps.length; i++) {
                this.Apps[i] = new AndroidInstanceAppInfo(source.Apps[i]);
            }
        }
