...
public class ListAIModelVersionsResponse extends AbstractModel {
    ...
    */
    ...
    public ListAIModelVersionsResponse() {
    }
     ...
     */
    public ListAIModelVersionsResponse(ListAIModelVersionsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.VersionList != null) {
            this.VersionList = new VersionList[source.VersionList.length];
            for (int i = 0; i < source.VersionList.length; i++) {
                this.VersionList[i] = new VersionList(source.VersionList[i]);
            }
        }
