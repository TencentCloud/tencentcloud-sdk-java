...
public class DescribeReplicationTasksRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeReplicationTasksRequest() {
    }
     ...
     */
    public DescribeReplicationTasksRequest(DescribeReplicationTasksRequest source) {
