...
public class ListSkillVersionsRequest extends AbstractModel {
    ...
    */
    ...
    public ListSkillVersionsRequest() {
    }
     ...
     */
    public ListSkillVersionsRequest(ListSkillVersionsRequest source) {
