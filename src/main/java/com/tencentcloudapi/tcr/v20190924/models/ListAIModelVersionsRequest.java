...
public class ListAIModelVersionsRequest extends AbstractModel {
    ...
    */
    ...
    public ListAIModelVersionsRequest() {
    }
     ...
     */
    public ListAIModelVersionsRequest(ListAIModelVersionsRequest source) {
