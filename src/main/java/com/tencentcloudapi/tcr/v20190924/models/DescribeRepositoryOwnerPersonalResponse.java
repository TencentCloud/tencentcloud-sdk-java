...
public class DescribeRepositoryOwnerPersonalResponse extends AbstractModel{
    ...
    */
     ...
     * @param Data 仓库信息
     */
    public void setData(RepoInfoResp Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeRepositoryOwnerPersonalResponse(DescribeRepositoryOwnerPersonalResponse source) {
        if (source.Data != null) {
            this.Data = new RepoInfoResp(source.Data);
        }
