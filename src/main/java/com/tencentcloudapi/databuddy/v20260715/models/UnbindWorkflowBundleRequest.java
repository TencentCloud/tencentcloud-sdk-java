...
public class UnbindWorkflowBundleRequest extends AbstractModel {
    ...
    */
    ...
    public UnbindWorkflowBundleRequest() {
    }
     ...
     */
    public UnbindWorkflowBundleRequest(UnbindWorkflowBundleRequest source) {
