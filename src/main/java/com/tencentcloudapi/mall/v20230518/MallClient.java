 ...
 */
package com.tencentcloudapi.mall.v20230518;
...
import com.tencentcloudapi.mall.v20230518.models.*;

public class MallClient extends AbstractClient{
    private static String endpoint = "mall.tencentcloudapi.com";
    private static String service = "mall";
    private static String version = "2023-05-18";
    
    public MallClient(Credential credential, String region) {
        this(credential, region, new ClientProfile());
    }

    public MallClient(Credential credential, String region, ClientProfile profile) {
        super(MallClient.endpoint, MallClient.version, credential, region, profile);
    }
