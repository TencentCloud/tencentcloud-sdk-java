...
public class OverrideCfsRulesResponse extends AbstractModel {
    ...
    */
    ...
    public OverrideCfsRulesResponse() {
    }
     ...
     */
    public OverrideCfsRulesResponse(OverrideCfsRulesResponse source) {
