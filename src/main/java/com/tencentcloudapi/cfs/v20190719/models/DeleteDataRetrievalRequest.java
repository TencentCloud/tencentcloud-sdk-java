...
public class DeleteDataRetrievalRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteDataRetrievalRequest() {
    }
     ...
     */
    public DeleteDataRetrievalRequest(DeleteDataRetrievalRequest source) {
