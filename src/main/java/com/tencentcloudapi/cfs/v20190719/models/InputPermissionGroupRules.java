...
public class InputPermissionGroupRules extends AbstractModel {
    ...
    */
    ...
    public InputPermissionGroupRules() {
    }
     ...
     */
    public InputPermissionGroupRules(InputPermissionGroupRules source) {
