...
public class RunDataRetrievalTaskResponse extends AbstractModel {
    ...
    */
    ...
    public RunDataRetrievalTaskResponse() {
    }
     ...
     */
    public RunDataRetrievalTaskResponse(RunDataRetrievalTaskResponse source) {
