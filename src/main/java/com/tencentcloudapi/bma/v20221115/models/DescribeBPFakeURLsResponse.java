...
public class DescribeBPFakeURLsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setFakeURLs(FakeURLData [] FakeURLs) {
    ...
    public DescribeBPFakeURLsResponse(DescribeBPFakeURLsResponse source) {
        if (source.FakeURLs != null) {
            this.FakeURLs = new FakeURLData[source.FakeURLs.length];
            for (int i = 0; i < source.FakeURLs.length; i++) {
                this.FakeURLs[i] = new FakeURLData(source.FakeURLs[i]);
            }
        }
