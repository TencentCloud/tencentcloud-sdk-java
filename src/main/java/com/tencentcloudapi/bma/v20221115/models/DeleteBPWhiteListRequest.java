...
public class DeleteBPWhiteListRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteBPWhiteListRequest() {
    }
     ...
     */
    public DeleteBPWhiteListRequest(DeleteBPWhiteListRequest source) {
