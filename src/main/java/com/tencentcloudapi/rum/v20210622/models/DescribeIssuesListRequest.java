...
public class DescribeIssuesListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>接口调试专用，对比模式下条件A，当 token 为空时，以这里的 value 作为筛选表单信息</p> 
    ...
    /**
     * Set <p>接口调试专用，对比模式下条件A，当 token 为空时，以这里的 value 作为筛选表单信息</p>
    ...
    /**
     * Get <p>接口调试专用，对比模式下条件B，当 token 为空时，以这里的 value 作为筛选表单信息</p> 
    ...
    /**
     * Set <p>接口调试专用，对比模式下条件B，当 token 为空时，以这里的 value 作为筛选表单信息</p>
    ...
    /**
     * Get <p>问题对比列表模式下，用于标识是按照sort_field字段的A值排序还是B值还是ratio值</p> 
    ...
    /**
     * Set <p>问题对比列表模式下，用于标识是按照sort_field字段的A值排序还是B值还是ratio值</p>
    ...
    /**
     * Get <p>模式：false:问题列表模式，true:对比列表模式</p> 
    ...
    /**
     * Set <p>模式：false:问题列表模式，true:对比列表模式</p>
    ...
    /**
     * Get <p>对比状态 0:所有 1:新增 2：遗留 3:已解决</p> 
    ...
    /**
     * Set <p>对比状态 0:所有 1:新增 2：遗留 3:已解决</p>
