...
public class IotexplorerClient extends AbstractClient{
     ...
     * @return BatchCreateTWeSeeSubscriptionResponse
     * @throws TencentCloudSDKException
     */
    public BatchCreateTWeSeeSubscriptionResponse BatchCreateTWeSeeSubscription(BatchCreateTWeSeeSubscriptionRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "BatchCreateTWeSeeSubscription", BatchCreateTWeSeeSubscriptionResponse.class);
    }
     ...
     * @throws TencentCloudSDKException
     */
    public BatchRenewTWeSeeSubscriptionResponse BatchRenewTWeSeeSubscription(BatchRenewTWeSeeSubscriptionRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "BatchRenewTWeSeeSubscription", BatchRenewTWeSeeSubscriptionResponse.class);
    }
...
- `BindingScope=device` 时，`DeviceName` 必填。
     ...
     * @return BindTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public BindTWeTalkAgentResponse BindTWeTalkAgent(BindTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "BindTWeTalkAgent", BindTWeTalkAgentResponse.class);
    }
...
3. 将设备直接绑定到该家庭（已绑同家庭视为成功，并继续异步下发 `bind_device` 消息）。
     ...
     * @return BindUserDeviceResponse
     * @throws TencentCloudSDKException
     */
    public BindUserDeviceResponse BindUserDevice(BindUserDeviceRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "BindUserDevice", BindUserDeviceResponse.class);
    }
...
> ⚠️ `method` 必须为 `rrpc_sync_reply`，否则会直接 skip。
     ...
     * @return CallDeviceRRPCSyncResponse
     * @throws TencentCloudSDKException
     */
    public CallDeviceRRPCSyncResponse CallDeviceRRPCSync(CallDeviceRRPCSyncRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CallDeviceRRPCSync", CallDeviceRRPCSyncResponse.class);
    }
     ...
     * @return CreateTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public CreateTWeTalkAgentResponse CreateTWeTalkAgent(CreateTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateTWeTalkAgent", CreateTWeTalkAgentResponse.class);
    }
     ...
     * @return CreateTWeTalkProductConfigV2Response
     * @throws TencentCloudSDKException
     */
    public CreateTWeTalkProductConfigV2Response CreateTWeTalkProductConfigV2(CreateTWeTalkProductConfigV2Request req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "CreateTWeTalkProductConfigV2", CreateTWeTalkProductConfigV2Response.class);
    }
     ...
     * @return DeleteTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public DeleteTWeTalkAgentResponse DeleteTWeTalkAgent(DeleteTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DeleteTWeTalkAgent", DeleteTWeTalkAgentResponse.class);
    }
     ...
     * @return DescribeTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public DescribeTWeTalkAgentResponse DescribeTWeTalkAgent(DescribeTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeTWeTalkAgent", DescribeTWeTalkAgentResponse.class);
    }

    /**
     *查询智能体绑定关系
     * @param req DescribeTWeTalkAgentBindingRequest
     * @return DescribeTWeTalkAgentBindingResponse
     * @throws TencentCloudSDKException
     */
    public DescribeTWeTalkAgentBindingResponse DescribeTWeTalkAgentBinding(DescribeTWeTalkAgentBindingRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeTWeTalkAgentBinding", DescribeTWeTalkAgentBindingResponse.class);
    }

    /**
     *分页查询智能体列表
     * @param req DescribeTWeTalkAgentListRequest
     * @return DescribeTWeTalkAgentListResponse
     * @throws TencentCloudSDKException
     */
    public DescribeTWeTalkAgentListResponse DescribeTWeTalkAgentList(DescribeTWeTalkAgentListRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeTWeTalkAgentList", DescribeTWeTalkAgentListResponse.class);
    }
     ...
     * @return DescribeTWeTalkProductConfigV2Response
     * @throws TencentCloudSDKException
     */
    public DescribeTWeTalkProductConfigV2Response DescribeTWeTalkProductConfigV2(DescribeTWeTalkProductConfigV2Request req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "DescribeTWeTalkProductConfigV2", DescribeTWeTalkProductConfigV2Response.class);
    }
...
用于查询视频激活码统计概览
     ...
     * @return GetTWeTalkProductConfigListV2Response
     * @throws TencentCloudSDKException
     */
    public GetTWeTalkProductConfigListV2Response GetTWeTalkProductConfigListV2(GetTWeTalkProductConfigListV2Request req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "GetTWeTalkProductConfigListV2", GetTWeTalkProductConfigListV2Response.class);
    }
     ...
     * @return ModifyTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public ModifyTWeTalkAgentResponse ModifyTWeTalkAgent(ModifyTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyTWeTalkAgent", ModifyTWeTalkAgentResponse.class);
    }
     ...
     * @return ModifyTWeTalkProductConfigV2Response
     * @throws TencentCloudSDKException
     */
    public ModifyTWeTalkProductConfigV2Response ModifyTWeTalkProductConfigV2(ModifyTWeTalkProductConfigV2Request req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "ModifyTWeTalkProductConfigV2", ModifyTWeTalkProductConfigV2Response.class);
    }
...
3. 解除设备与该家庭的绑定关系，异步下发 `delete_device` 消息；解绑路径不校验设备存在性，允许设备已删除时清理残留绑定关系。
     ...
     * @return RevokeBindUserDeviceResponse
     * @throws TencentCloudSDKException
     */
    public RevokeBindUserDeviceResponse RevokeBindUserDevice(RevokeBindUserDeviceRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "RevokeBindUserDevice", RevokeBindUserDeviceResponse.class);
    }
...
4. 写入分享关系（重复分享幂等成功，不修改原 CreateTime）。
     ...
     * @return UnbindTWeTalkAgentResponse
     * @throws TencentCloudSDKException
     */
    public UnbindTWeTalkAgentResponse UnbindTWeTalkAgent(UnbindTWeTalkAgentRequest req) throws TencentCloudSDKException{
        req.setSkipSign(false);
        return this.internalRequest(req, "UnbindTWeTalkAgent", UnbindTWeTalkAgentResponse.class);
    }
