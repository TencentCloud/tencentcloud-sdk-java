...
public class BindTWeTalkAgentRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>设备名称；<code>BindingScope=device</code> 时必填</p> 
     * @return DeviceName <p>设备名称；<code>BindingScope=device</code> 时必填</p>
     */
    ...
    /**
     * Set <p>设备名称；<code>BindingScope=device</code> 时必填</p>
    ...
    /**
     * Get <p>绑定优先级，数值越小优先级越高</p> 
     * @return Priority <p>绑定优先级，数值越小优先级越高</p>
     */
    ...
    public BindTWeTalkAgentRequest() {
    }
     ...
     */
    public BindTWeTalkAgentRequest(BindTWeTalkAgentRequest source) {
