...
public class DescribeDeviceFirmwaresResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDeviceFirmwaresResponse(DescribeDeviceFirmwaresResponse source) {
        if (source.Firmwares != null) {
            this.Firmwares = new DeviceFirmwareInfo[source.Firmwares.length];
            for (int i = 0; i < source.Firmwares.length; i++) {
                this.Firmwares[i] = new DeviceFirmwareInfo(source.Firmwares[i]);
            }
        }
