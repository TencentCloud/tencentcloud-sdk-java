...
public class DescribeTWeSeeCallbackRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeTWeSeeCallbackRequest() {
    }
     ...
     */
    public DescribeTWeSeeCallbackRequest(DescribeTWeSeeCallbackRequest source) {
