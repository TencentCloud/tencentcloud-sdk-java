...
public class SeeObjectSummary extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>TWeSee 直传对象或目录的 COS URI</p> 
    ...
    /**
     * Set <p>TWeSee 直传对象或目录的 COS URI</p>
     ...
     */
    public SeeObjectSummary(SeeObjectSummary source) {
        if (source.Key != null) {
