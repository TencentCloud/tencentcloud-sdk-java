...
public class DirectBindDeviceInFamilyResponse extends AbstractModel{

    /**
    * 返回设备信息
    */
    @SerializedName("AppDeviceInfo")
    @Expose
    ...
    */
    ...
    public DirectBindDeviceInFamilyResponse() {
    }
     ...
     */
    public DirectBindDeviceInFamilyResponse(DirectBindDeviceInFamilyResponse source) {
        if (source.AppDeviceInfo != null) {
            this.AppDeviceInfo = new AppDeviceInfo(source.AppDeviceInfo);
        }
