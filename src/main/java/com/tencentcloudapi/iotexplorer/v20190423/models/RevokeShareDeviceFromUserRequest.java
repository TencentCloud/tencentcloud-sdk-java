...
public class RevokeShareDeviceFromUserRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>被取消分享用户 OpenID（不存在视为已取消，幂等成功）</p> 
     * @return ToOpenID <p>被取消分享用户 OpenID（不存在视为已取消，幂等成功）</p>
     */
    ...
    /**
     * Set <p>被取消分享用户 OpenID（不存在视为已取消，幂等成功）</p>
    ...
    public RevokeShareDeviceFromUserRequest() {
    }
     ...
     */
    public RevokeShareDeviceFromUserRequest(RevokeShareDeviceFromUserRequest source) {
