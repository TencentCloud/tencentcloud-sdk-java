...
public class SeeCreateSubscriptionEntry extends AbstractModel {
...
- `DISABLE_NOTIFY_AND_MANUAL_RENEW`：不通知且手动续费
    ...
    public SeeCreateSubscriptionEntry() {
    }
     ...
     */
    public SeeCreateSubscriptionEntry(SeeCreateSubscriptionEntry source) {
