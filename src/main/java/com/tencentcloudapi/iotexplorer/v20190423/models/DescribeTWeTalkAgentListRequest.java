...
public class DescribeTWeTalkAgentListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeTWeTalkAgentListRequest() {
    }
     ...
     */
    public DescribeTWeTalkAgentListRequest(DescribeTWeTalkAgentListRequest source) {
