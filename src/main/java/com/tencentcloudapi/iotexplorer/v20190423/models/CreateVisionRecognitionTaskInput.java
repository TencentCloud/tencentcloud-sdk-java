...
public class CreateVisionRecognitionTaskInput extends AbstractModel {
...
- `ObjectDetect`：目标检测
    ...
    public CreateVisionRecognitionTaskInput() {
    }
     ...
     */
    public CreateVisionRecognitionTaskInput(CreateVisionRecognitionTaskInput source) {
