...
public class ModifyStudioProductResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyStudioProductResponse() {
    }
     ...
     */
    public ModifyStudioProductResponse(ModifyStudioProductResponse source) {
