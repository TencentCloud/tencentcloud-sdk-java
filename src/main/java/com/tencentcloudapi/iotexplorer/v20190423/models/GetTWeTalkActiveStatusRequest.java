...
public class GetTWeTalkActiveStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 设备列表， 产品ID_设备名称 
     * @return DeviceIds 设备列表， 产品ID_设备名称
     */
    ...
    public GetTWeTalkActiveStatusRequest() {
    }
     ...
     */
    public GetTWeTalkActiveStatusRequest(GetTWeTalkActiveStatusRequest source) {
