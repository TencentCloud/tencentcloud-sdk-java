...
public class SeeTaskPersonInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 该人员在任务中的人脸列表 
     * @return Faces 该人员在任务中的人脸列表
     */
    public SeeTaskFaceInfo [] getFaces() {
        return this.Faces;
    }
     ...
     */
    public void setFaces(SeeTaskFaceInfo [] Faces) {
        this.Faces = Faces;
    }
     ...
     */
    public SeeTaskPersonInfo(SeeTaskPersonInfo source) {
        if (source.Faces != null) {
            this.Faces = new SeeTaskFaceInfo[source.Faces.length];
            for (int i = 0; i < source.Faces.length; i++) {
                this.Faces[i] = new SeeTaskFaceInfo(source.Faces[i]);
            }
        }
