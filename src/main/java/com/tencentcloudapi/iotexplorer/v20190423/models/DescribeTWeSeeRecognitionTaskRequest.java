...
public class DescribeTWeSeeRecognitionTaskRequest extends AbstractModel {
...
若传入该参数，则响应中将包含所有文件的下载 URL
    ...
    public DescribeTWeSeeRecognitionTaskRequest() {
    }
     ...
     */
    public DescribeTWeSeeRecognitionTaskRequest(DescribeTWeSeeRecognitionTaskRequest source) {
