...
public class SeeRenewSubscriptionEntry extends AbstractModel {
...
- `IMG_COMP`：图片理解
    ...
    public SeeRenewSubscriptionEntry() {
    }
     ...
     */
    public SeeRenewSubscriptionEntry(SeeRenewSubscriptionEntry source) {
