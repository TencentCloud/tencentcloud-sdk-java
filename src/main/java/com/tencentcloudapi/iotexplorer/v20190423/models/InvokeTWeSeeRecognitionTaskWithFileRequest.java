...
public class InvokeTWeSeeRecognitionTaskWithFileRequest extends AbstractModel {
...
- `ObjectDetect`：目标检测
    ...
    public InvokeTWeSeeRecognitionTaskWithFileRequest() {
    }
     ...
     */
    public InvokeTWeSeeRecognitionTaskWithFileRequest(InvokeTWeSeeRecognitionTaskWithFileRequest source) {
