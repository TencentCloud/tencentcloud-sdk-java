...
public class CloudStorageEventWithAITasks extends AbstractModel {
    ...
    * 事件关联的云存 AI 任务列表
    */
    @SerializedName("AITasks")
    @Expose
    private CloudStorageAIServiceTask [] AITasks;
     ...
     */
    public CloudStorageAIServiceTask [] getAITasks() {
        return this.AITasks;
    }
     ...
     */
    public void setAITasks(CloudStorageAIServiceTask [] AITasks) {
        this.AITasks = AITasks;
    }

    public CloudStorageEventWithAITasks() {
    }
     ...
     */
    public CloudStorageEventWithAITasks(CloudStorageEventWithAITasks source) {
        ...
        if (source.AITasks != null) {
            this.AITasks = new CloudStorageAIServiceTask[source.AITasks.length];
            for (int i = 0; i < source.AITasks.length; i++) {
                this.AITasks[i] = new CloudStorageAIServiceTask(source.AITasks[i]);
            }
        }
    }
