...
public class SeeComprehensionConfig extends AbstractModel {
    ...
    */
    @SerializedName("InputRotateDegree")
    @Expose
    private Long InputRotateDegree;
    ...
    /**
     * Get <p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p> 
     ...
     */
    public Long getInputRotateDegree() {
        return this.InputRotateDegree;
    }

    /**
     * Set <p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p>
     ...
     */
    public void setInputRotateDegree(Long InputRotateDegree) {
        this.InputRotateDegree = InputRotateDegree;
    }
    ...
    public SeeComprehensionConfig(SeeComprehensionConfig source) {
        ...
        if (source.EnableFaceDetection != null) {
            this.EnableFaceDetection = new Boolean(source.EnableFaceDetection);
        }
        if (source.InputRotateDegree != null) {
            this.InputRotateDegree = new Long(source.InputRotateDegree);
        }
    }
