...
public class CreateCloudStorageAIServiceTaskRequest extends AbstractModel {
...
- `VideoToText`：视频语义理解
    ...
    public CreateCloudStorageAIServiceTaskRequest() {
    }
     ...
     */
    public CreateCloudStorageAIServiceTaskRequest(CreateCloudStorageAIServiceTaskRequest source) {
