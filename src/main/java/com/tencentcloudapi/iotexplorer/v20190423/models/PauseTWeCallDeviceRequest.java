...
public class PauseTWeCallDeviceRequest extends AbstractModel {
    ...
    */
    ...
    public PauseTWeCallDeviceRequest() {
    }
     ...
     */
    public PauseTWeCallDeviceRequest(PauseTWeCallDeviceRequest source) {
