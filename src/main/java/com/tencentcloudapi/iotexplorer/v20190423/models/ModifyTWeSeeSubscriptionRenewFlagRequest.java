...
public class ModifyTWeSeeSubscriptionRenewFlagRequest extends AbstractModel {
...
- `DISABLE_NOTIFY_AND_MANUAL_RENEW`：不通知且手动续费
    ...
    public ModifyTWeSeeSubscriptionRenewFlagRequest() {
    }
     ...
     */
    public ModifyTWeSeeSubscriptionRenewFlagRequest(ModifyTWeSeeSubscriptionRenewFlagRequest source) {
