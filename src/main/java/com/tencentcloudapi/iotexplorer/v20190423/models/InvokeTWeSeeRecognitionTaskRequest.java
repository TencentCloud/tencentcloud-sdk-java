...
public class InvokeTWeSeeRecognitionTaskRequest extends AbstractModel {
...
- `immediate`：立即
     ...
     */
    public InvokeTWeSeeRecognitionTaskRequest(InvokeTWeSeeRecognitionTaskRequest source) {
