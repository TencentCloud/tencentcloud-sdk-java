...
public class SearchStudioProductResponse extends AbstractModel{
    ...
    */
    ...
    public SearchStudioProductResponse() {
    }
     ...
     */
    public SearchStudioProductResponse(SearchStudioProductResponse source) {
