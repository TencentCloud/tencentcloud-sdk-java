...
public class CreateEKSContainerInstancesResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get EKS Container Instance Id集合，格式为eksci-xxx，是容器实例的唯一标识。 
    ...
    /**
     * Set EKS Container Instance Id集合，格式为eksci-xxx，是容器实例的唯一标识。
    ...
    public CreateEKSContainerInstancesResponse() {
    }
     ...
     */
    public CreateEKSContainerInstancesResponse(CreateEKSContainerInstancesResponse source) {
