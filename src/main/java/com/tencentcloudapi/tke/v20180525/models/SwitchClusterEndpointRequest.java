...
public class SwitchClusterEndpointRequest extends AbstractModel {
    ...
    */
    ...
    public SwitchClusterEndpointRequest() {
    }
     ...
     */
    public SwitchClusterEndpointRequest(SwitchClusterEndpointRequest source) {
