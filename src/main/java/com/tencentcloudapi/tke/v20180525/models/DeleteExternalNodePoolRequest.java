...
public class DeleteExternalNodePoolRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteExternalNodePoolRequest() {
    }
     ...
     */
    public DeleteExternalNodePoolRequest(DeleteExternalNodePoolRequest source) {
