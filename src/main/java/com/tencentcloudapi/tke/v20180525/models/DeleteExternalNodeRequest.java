...
public class DeleteExternalNodeRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteExternalNodeRequest() {
    }
     ...
     */
    public DeleteExternalNodeRequest(DeleteExternalNodeRequest source) {
