...
public class ModifyRollOutSequenceRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyRollOutSequenceRequest() {
    }
     ...
     */
    public ModifyRollOutSequenceRequest(ModifyRollOutSequenceRequest source) {
        if (source.ID != null) {
