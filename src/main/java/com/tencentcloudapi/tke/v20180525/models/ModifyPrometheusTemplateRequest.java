...
public class ModifyPrometheusTemplateRequest extends AbstractModel{
    ...
    */
     ...
     * @param Template 修改内容
     */
    public void setTemplate(PrometheusTemplateModify Template) {
     ...
     */
    public ModifyPrometheusTemplateRequest(ModifyPrometheusTemplateRequest source) {
        if (source.TemplateId != null) {
            this.TemplateId = new String(source.TemplateId);
        }
        if (source.Template != null) {
            this.Template = new PrometheusTemplateModify(source.Template);
        }
    }
