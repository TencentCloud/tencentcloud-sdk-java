...
public class DescribeExternalNodePoolsResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private ExternalNodePool [] NodePoolSet;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeExternalNodePoolsResponse() {
    }
     ...
     */
    public DescribeExternalNodePoolsResponse(DescribeExternalNodePoolsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.NodePoolSet != null) {
            this.NodePoolSet = new ExternalNodePool[source.NodePoolSet.length];
            for (int i = 0; i < source.NodePoolSet.length; i++) {
                this.NodePoolSet[i] = new ExternalNodePool(source.NodePoolSet[i]);
            }
        }
