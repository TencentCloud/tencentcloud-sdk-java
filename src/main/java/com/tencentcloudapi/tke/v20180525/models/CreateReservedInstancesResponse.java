...
public class CreateReservedInstancesResponse extends AbstractModel {
    ...
    */
    ...
    public CreateReservedInstancesResponse() {
    }
     ...
     */
    public CreateReservedInstancesResponse(CreateReservedInstancesResponse source) {
