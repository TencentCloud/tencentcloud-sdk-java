...
public class DeleteNotebookInstanceRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteNotebookInstanceRequest() {
    }
     ...
     */
    public DeleteNotebookInstanceRequest(DeleteNotebookInstanceRequest source) {
