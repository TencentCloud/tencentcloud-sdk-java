...
public class UpdateCodeRepositoryResponse extends AbstractModel{
    ...
    */
    ...
    public UpdateCodeRepositoryResponse() {
    }
     ...
     */
    public UpdateCodeRepositoryResponse(UpdateCodeRepositoryResponse source) {
