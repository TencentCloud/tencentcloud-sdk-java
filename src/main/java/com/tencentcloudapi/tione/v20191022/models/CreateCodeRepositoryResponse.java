...
public class CreateCodeRepositoryResponse extends AbstractModel{
    ...
    */
    ...
    public CreateCodeRepositoryResponse() {
    }
     ...
     */
    public CreateCodeRepositoryResponse(CreateCodeRepositoryResponse source) {
