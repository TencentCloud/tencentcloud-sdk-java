...
public class DeleteNotebookLifecycleScriptRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 是否忽略已关联的 notebook 实例强行删除生命周期脚本，默认 false 
    ...
    /**
     * Set 是否忽略已关联的 notebook 实例强行删除生命周期脚本，默认 false
     ...
     */
    public DeleteNotebookLifecycleScriptRequest(DeleteNotebookLifecycleScriptRequest source) {
        ...
        if (source.Forcible != null) {
            this.Forcible = new Boolean(source.Forcible);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "Forcible", this.Forcible);
