...
public class DeleteCodeRepositoryResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteCodeRepositoryResponse() {
    }
     ...
     */
    public DeleteCodeRepositoryResponse(DeleteCodeRepositoryResponse source) {
