...
public class StopModelAccelerateTaskRequest extends AbstractModel{
    ...
    */
    ...
    public StopModelAccelerateTaskRequest() {
    }
     ...
     */
    public StopModelAccelerateTaskRequest(StopModelAccelerateTaskRequest source) {
