...
public class DeleteModelAccelerateTaskRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteModelAccelerateTaskRequest() {
    }
     ...
     */
    public DeleteModelAccelerateTaskRequest(DeleteModelAccelerateTaskRequest source) {
