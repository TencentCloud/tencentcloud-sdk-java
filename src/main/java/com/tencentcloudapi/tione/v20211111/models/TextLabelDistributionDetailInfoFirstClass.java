...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TextLabelDistributionDetailInfoSecondClass [] ChildLabelList;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public TextLabelDistributionDetailInfoFirstClass(TextLabelDistributionDetailInfoFirstClass source) {
        ...
        if (source.ChildLabelList != null) {
            this.ChildLabelList = new TextLabelDistributionDetailInfoSecondClass[source.ChildLabelList.length];
            for (int i = 0; i < source.ChildLabelList.length; i++) {
                this.ChildLabelList[i] = new TextLabelDistributionDetailInfoSecondClass(source.ChildLabelList[i]);
            }
        }
    }
