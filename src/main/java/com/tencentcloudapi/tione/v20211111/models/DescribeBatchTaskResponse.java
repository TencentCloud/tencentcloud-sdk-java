...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private BatchTaskDetail BatchTaskDetail;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public void setBatchTaskDetail(BatchTaskDetail BatchTaskDetail) {
        this.BatchTaskDetail = BatchTaskDetail;
    }
    ...
    public DescribeBatchTaskResponse(DescribeBatchTaskResponse source) {
        if (source.BatchTaskDetail != null) {
            this.BatchTaskDetail = new BatchTaskDetail(source.BatchTaskDetail);
        }
