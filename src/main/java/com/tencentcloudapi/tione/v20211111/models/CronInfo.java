...
public class CronInfo extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public CronInfo(CronInfo source) {
        if (source.CronConfig != null) {
            this.CronConfig = new String(source.CronConfig);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "CronConfig", this.CronConfig);
