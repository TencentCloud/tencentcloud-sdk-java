...
public class DescribeBillingSpecsPriceResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setSpecsPrice(SpecPrice [] SpecsPrice) {
     ...
     */
    public DescribeBillingSpecsPriceResponse(DescribeBillingSpecsPriceResponse source) {
        if (source.SpecsPrice != null) {
            this.SpecsPrice = new SpecPrice[source.SpecsPrice.length];
            for (int i = 0; i < source.SpecsPrice.length; i++) {
                this.SpecsPrice[i] = new SpecPrice(source.SpecsPrice[i]);
            }
        }
