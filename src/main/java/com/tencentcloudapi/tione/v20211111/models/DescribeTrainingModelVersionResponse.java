...
public class DescribeTrainingModelVersionResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setTrainingModelVersion(TrainingModelVersionDTO TrainingModelVersion) {
     ...
     */
    public DescribeTrainingModelVersionResponse(DescribeTrainingModelVersionResponse source) {
        if (source.TrainingModelVersion != null) {
            this.TrainingModelVersion = new TrainingModelVersionDTO(source.TrainingModelVersion);
        }
