...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setChildLabelList(TextLabelDistributionDetailInfoFifthClass [] ChildLabelList) {
     ...
     */
    public TextLabelDistributionDetailInfoFourthClass(TextLabelDistributionDetailInfoFourthClass source) {
        ...
        if (source.ChildLabelList != null) {
            this.ChildLabelList = new TextLabelDistributionDetailInfoFifthClass[source.ChildLabelList.length];
            for (int i = 0; i < source.ChildLabelList.length; i++) {
                this.ChildLabelList[i] = new TextLabelDistributionDetailInfoFifthClass(source.ChildLabelList[i]);
            }
        }
    }
