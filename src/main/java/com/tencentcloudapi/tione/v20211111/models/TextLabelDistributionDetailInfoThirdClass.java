...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setChildLabelList(TextLabelDistributionDetailInfoFourthClass [] ChildLabelList) {
        this.ChildLabelList = ChildLabelList;
    }
     ...
     */
    public TextLabelDistributionDetailInfoThirdClass(TextLabelDistributionDetailInfoThirdClass source) {
        ...
        if (source.ChildLabelList != null) {
            this.ChildLabelList = new TextLabelDistributionDetailInfoFourthClass[source.ChildLabelList.length];
            for (int i = 0; i < source.ChildLabelList.length; i++) {
                this.ChildLabelList[i] = new TextLabelDistributionDetailInfoFourthClass(source.ChildLabelList[i]);
            }
        }
    }
