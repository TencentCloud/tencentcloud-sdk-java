...
public class CreateMountLimitRequest extends AbstractModel {
    ...
    */
    ...
    public CreateMountLimitRequest() {
    }
     ...
     */
    public CreateMountLimitRequest(CreateMountLimitRequest source) {
        if (source.Type != null) {
