...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TextLabelDistributionDetailInfoThirdClass [] ChildLabelList;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TextLabelDistributionDetailInfoThirdClass [] getChildLabelList() {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public TextLabelDistributionDetailInfoSecondClass(TextLabelDistributionDetailInfoSecondClass source) {
        ...
        if (source.ChildLabelList != null) {
            this.ChildLabelList = new TextLabelDistributionDetailInfoThirdClass[source.ChildLabelList.length];
            for (int i = 0; i < source.ChildLabelList.length; i++) {
                this.ChildLabelList[i] = new TextLabelDistributionDetailInfoThirdClass(source.ChildLabelList[i]);
            }
        }
    }
