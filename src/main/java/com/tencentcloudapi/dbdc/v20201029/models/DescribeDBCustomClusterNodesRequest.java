...
public class DescribeDBCustomClusterNodesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>查询筛选条件。支持的条件有：</p><ul><li>node-name：DB Custom 节点名称。</li></ul> 
    ...
    /**
     * Set <p>查询筛选条件。支持的条件有：</p><ul><li>node-name：DB Custom 节点名称。</li></ul>
    ...
    public DescribeDBCustomClusterNodesRequest() {
    }
     ...
     */
    public DescribeDBCustomClusterNodesRequest(DescribeDBCustomClusterNodesRequest source) {
