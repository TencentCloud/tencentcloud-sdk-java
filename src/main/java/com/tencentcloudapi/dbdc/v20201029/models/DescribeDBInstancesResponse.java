...
public class DescribeDBInstancesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setInstances(DBInstanceDetail [] Instances) {
    ...
    public DescribeDBInstancesResponse(DescribeDBInstancesResponse source) {
        if (source.Instances != null) {
            this.Instances = new DBInstanceDetail[source.Instances.length];
            for (int i = 0; i < source.Instances.length; i++) {
                this.Instances[i] = new DBInstanceDetail(source.Instances[i]);
            }
        }
