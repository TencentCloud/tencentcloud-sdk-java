...
public class DescribeDBCustomNodeSecurityGroupsResponse extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    /**
     * Get <p>与节点绑定的安全组id，数组格式，根据内部安全组ID的顺序来确认优先级。</p>
注意：此字段可能返回 null，表示取不到有效值。 
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * Set <p>与节点绑定的安全组id，数组格式，根据内部安全组ID的顺序来确认优先级。</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeDBCustomNodeSecurityGroupsResponse() {
    }
     ...
     */
    public DescribeDBCustomNodeSecurityGroupsResponse(DescribeDBCustomNodeSecurityGroupsResponse source) {
