...
public class RemoveNodesFromDBCustomClusterRequest extends AbstractModel {
    ...
    */
     ...
     */
    public RemoveNodesFromDBCustomClusterRequest(RemoveNodesFromDBCustomClusterRequest source) {
