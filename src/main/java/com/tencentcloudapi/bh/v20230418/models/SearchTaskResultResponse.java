...
public class SearchTaskResultResponse extends AbstractModel {
    ...
    */
     ...
     */
    public SearchTaskResultResponse(SearchTaskResultResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.TaskResult != null) {
            this.TaskResult = new TaskResult[source.TaskResult.length];
            for (int i = 0; i < source.TaskResult.length; i++) {
                this.TaskResult[i] = new TaskResult(source.TaskResult[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "TaskResult.", this.TaskResult);
