...
public class ModifyAssetSyncFlagRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 是否开启资产自动同步，false-不开启，true-开启 
    ...
    /**
     * Set 是否开启资产自动同步，false-不开启，true-开启
    ...
    public ModifyAssetSyncFlagRequest() {
    }
     ...
     */
    public ModifyAssetSyncFlagRequest(ModifyAssetSyncFlagRequest source) {
