...
public class DeleteUserDirectoryRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteUserDirectoryRequest() {
    }
     ...
     */
    public DeleteUserDirectoryRequest(DeleteUserDirectoryRequest source) {
