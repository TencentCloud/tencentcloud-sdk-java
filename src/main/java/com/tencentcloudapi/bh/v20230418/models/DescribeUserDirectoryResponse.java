...
public class DescribeUserDirectoryResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeUserDirectoryResponse() {
    }
     ...
     */
    public DescribeUserDirectoryResponse(DescribeUserDirectoryResponse source) {
        if (source.UserDirSet != null) {
            this.UserDirSet = new UserDirectory[source.UserDirSet.length];
            for (int i = 0; i < source.UserDirSet.length; i++) {
                this.UserDirSet[i] = new UserDirectory(source.UserDirSet[i]);
            }
        }
