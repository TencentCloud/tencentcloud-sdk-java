...
public class DescribeAccessWhiteListRulesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 用户ID集合，非必需，如果使用IdSet参数则忽略Name参数 
    ...
    /**
     * Set 用户ID集合，非必需，如果使用IdSet参数则忽略Name参数
    ...
    public DescribeAccessWhiteListRulesRequest() {
    }
