...
public class ModifyLDAPSettingRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyLDAPSettingRequest() {
    }
     ...
     */
    public ModifyLDAPSettingRequest(ModifyLDAPSettingRequest source) {
