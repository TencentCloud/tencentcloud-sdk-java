...
public class DeleteChangePwdTaskRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteChangePwdTaskRequest() {
    }
     ...
     */
    public DeleteChangePwdTaskRequest(DeleteChangePwdTaskRequest source) {
