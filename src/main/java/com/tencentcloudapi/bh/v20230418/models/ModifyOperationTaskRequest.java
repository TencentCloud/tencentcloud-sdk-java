...
public class ModifyOperationTaskRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyOperationTaskRequest() {
    }
     ...
     */
    public ModifyOperationTaskRequest(ModifyOperationTaskRequest source) {
        if (source.Id != null) {
