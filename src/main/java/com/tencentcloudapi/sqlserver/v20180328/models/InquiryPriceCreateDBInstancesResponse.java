...
public class InquiryPriceCreateDBInstancesResponse  extends AbstractModel{
    ...
    */
    ...
    /**
     * 获取未打折前价格，其值除以100表示多少钱。比如10010表示100.10元
    ...
    /**
     * 设置未打折前价格，其值除以100表示多少钱。比如10010表示100.10元
    ...
    /**
     * 获取实际需要支付的价格，其值除以100表示多少钱。比如10010表示100.10元
    ...
    /**
     * 设置实际需要支付的价格，其值除以100表示多少钱。比如10010表示100.10元
