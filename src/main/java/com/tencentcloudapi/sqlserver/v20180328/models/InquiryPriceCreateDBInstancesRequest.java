...
public class InquiryPriceCreateDBInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>可用区ID。该参数可以通过调用 DescribeZones 接口的返回值中的Zone字段来获取。</p> 
    ...
    /**
     * Set <p>可用区ID。该参数可以通过调用 DescribeZones 接口的返回值中的Zone字段来获取。</p>
    ...
    /**
     * Get <p>计费类型，取值支持 PREPAID，POSTPAID。</p> 
    ...
    /**
     * Set <p>计费类型，取值支持 PREPAID，POSTPAID。</p>
    ...
    /**
     * Get <p>购买时长，单位：月。取值为1到48，默认为1</p> 
    ...
    /**
     * Set <p>购买时长，单位：月。取值为1到48，默认为1</p>
    ...
    /**
     * Get <p>一次性购买的实例数量。取值1-100，默认取值为1</p> 
    ...
    /**
     * Set <p>一次性购买的实例数量。取值1-100，默认取值为1</p>
    ...
    /**
     * Get <p>购买实例的类型 HA-高可用型(包括双机高可用，alwaysOn集群)，RO-只读副本型，SI-单节点型,cvmHA-虚拟机双机高可用,cvmRO-虚拟机只读，MultiHA-多节点，cvmMultiHA-云盘</p> 
    ...
    /**
     * Set <p>购买实例的类型 HA-高可用型(包括双机高可用，alwaysOn集群)，RO-只读副本型，SI-单节点型,cvmHA-虚拟机双机高可用,cvmRO-虚拟机只读，MultiHA-多节点，cvmMultiHA-云盘</p>
    ...
    /**
     * Get <p>购买实例的宿主机类型，PM-物理机, CLOUD_PREMIUM-虚拟机高性能云盘，CLOUD_SSD-虚拟机SSD云盘,<br>CLOUD_HSSD-虚拟机加强型SSD云盘，CLOUD_TSSD-虚拟机极速型SSD云盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p> 
    ...
    /**
     * Set <p>购买实例的宿主机类型，PM-物理机, CLOUD_PREMIUM-虚拟机高性能云盘，CLOUD_SSD-虚拟机SSD云盘,<br>CLOUD_HSSD-虚拟机加强型SSD云盘，CLOUD_TSSD-虚拟机极速型SSD云盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p>
    ...
    /**
     * Get <p>备节点可用区，默认为空。如果是多节点架构时必传，并且备机可用区集合最小为2个，最大不超过5个。</p> 
    ...
    /**
     * Set <p>备节点可用区，默认为空。如果是多节点架构时必传，并且备机可用区集合最小为2个，最大不超过5个。</p>
