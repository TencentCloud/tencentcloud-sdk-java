...
public class DescribeAudioStatResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeAudioStatResponse() {
    }
     ...
     */
    public DescribeAudioStatResponse(DescribeAudioStatResponse source) {
