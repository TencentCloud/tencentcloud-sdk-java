...
public class DescribePodInstancesResponse extends AbstractModel{
    ...
    */
    ...
    public DescribePodInstancesResponse() {
    }
     ...
     */
    public DescribePodInstancesResponse(DescribePodInstancesResponse source) {
        if (source.Result != null) {
            this.Result = new GroupPodResult(source.Result);
        }
