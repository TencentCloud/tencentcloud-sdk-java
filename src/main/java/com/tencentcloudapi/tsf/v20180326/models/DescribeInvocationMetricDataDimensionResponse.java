...
public class DescribeInvocationMetricDataDimensionResponse extends AbstractModel{
    ...
    */
     ...
     * @param Result 维度
     */
    public void setResult(TsfPageDimension Result) {
        this.Result = Result;
    }
     ...
     */
    public DescribeInvocationMetricDataDimensionResponse(DescribeInvocationMetricDataDimensionResponse source) {
        if (source.Result != null) {
            this.Result = new TsfPageDimension(source.Result);
        }
