...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(TsfPageBusinessLogV2 Result) {
        this.Result = Result;
    }
     ...
     */
    public SearchBusinessLogResponse(SearchBusinessLogResponse source) {
        if (source.Result != null) {
            this.Result = new TsfPageBusinessLogV2(source.Result);
        }
