...
public class DescribeImageRepositoryResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeImageRepositoryResponse() {
    }
     ...
     */
    public DescribeImageRepositoryResponse(DescribeImageRepositoryResponse source) {
        if (source.Result != null) {
            this.Result = new ImageRepositoryResult(source.Result);
        }
