...
public class DescribeRepositoryResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     */
    public DescribeRepositoryResponse(DescribeRepositoryResponse source) {
        if (source.Result != null) {
            this.Result = new RepositoryInfo(source.Result);
        }
