...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TsfPageApplication Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public TsfPageApplication getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(TsfPageApplication Result) {
        this.Result = Result;
    }
    ...
    public DescribeApplicationsResponse(DescribeApplicationsResponse source) {
        if (source.Result != null) {
            this.Result = new TsfPageApplication(source.Result);
        }
