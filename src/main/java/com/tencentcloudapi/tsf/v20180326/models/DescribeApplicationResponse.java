...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private ApplicationForPage Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public ApplicationForPage getResult() {
        return this.Result;
    }
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setResult(ApplicationForPage Result) {
        this.Result = Result;
    }
    ...
    public DescribeApplicationResponse(DescribeApplicationResponse source) {
        if (source.Result != null) {
            this.Result = new ApplicationForPage(source.Result);
        }
