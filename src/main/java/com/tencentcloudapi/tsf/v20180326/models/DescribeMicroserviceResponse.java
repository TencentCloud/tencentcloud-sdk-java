...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private TsfPageMsInstance Result;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeMicroserviceResponse() {
    }
     ...
     */
    public DescribeMicroserviceResponse(DescribeMicroserviceResponse source) {
        if (source.Result != null) {
            this.Result = new TsfPageMsInstance(source.Result);
        }
