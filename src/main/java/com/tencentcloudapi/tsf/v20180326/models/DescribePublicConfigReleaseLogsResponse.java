...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribePublicConfigReleaseLogsResponse() {
    }
     ...
     */
    public DescribePublicConfigReleaseLogsResponse(DescribePublicConfigReleaseLogsResponse source) {
        if (source.Result != null) {
            this.Result = new TsfPageConfigReleaseLog(source.Result);
        }
