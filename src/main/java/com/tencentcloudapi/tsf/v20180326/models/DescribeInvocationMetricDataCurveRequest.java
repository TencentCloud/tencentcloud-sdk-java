...
public class DescribeInvocationMetricDataCurveRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 查询时间粒度，单位秒可选值：60、3600、86400 
    ...
    /**
     * Set 查询时间粒度，单位秒可选值：60、3600、86400
    ...
    /**
     * Get 类型。组件监控使用，可选值：SQL 或者 NoSQL 
    ...
    /**
     * Set 类型。组件监控使用，可选值：SQL 或者 NoSQL
    ...
    public DescribeInvocationMetricDataCurveRequest() {
    }
     ...
     */
    public DescribeInvocationMetricDataCurveRequest(DescribeInvocationMetricDataCurveRequest source) {
