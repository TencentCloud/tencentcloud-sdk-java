...
public class DescribeResourcesByDealNameResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResourceIdInfoSet(ResourceIdInfo [] ResourceIdInfoSet) {
        this.ResourceIdInfoSet = ResourceIdInfoSet;
    }
    ...
    public DescribeResourcesByDealNameResponse(DescribeResourcesByDealNameResponse source) {
        if (source.ResourceIdInfoSet != null) {
            this.ResourceIdInfoSet = new ResourceIdInfo[source.ResourceIdInfoSet.length];
            for (int i = 0; i < source.ResourceIdInfoSet.length; i++) {
                this.ResourceIdInfoSet[i] = new ResourceIdInfo(source.ResourceIdInfoSet[i]);
            }
        }
