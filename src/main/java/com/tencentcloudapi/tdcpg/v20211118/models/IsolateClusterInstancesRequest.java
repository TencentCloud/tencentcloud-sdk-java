...
public class IsolateClusterInstancesRequest extends AbstractModel{
    ...
    */
    ...
    public IsolateClusterInstancesRequest() {
    }
     ...
     */
    public IsolateClusterInstancesRequest(IsolateClusterInstancesRequest source) {
