...
public class AIGWLLMHealthCheckSetting extends AbstractModel {
    ...
    */
    ...
    public AIGWLLMHealthCheckSetting() {
    }
     ...
     */
    public AIGWLLMHealthCheckSetting(AIGWLLMHealthCheckSetting source) {
