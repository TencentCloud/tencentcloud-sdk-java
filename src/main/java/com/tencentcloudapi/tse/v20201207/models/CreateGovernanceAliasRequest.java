...
public class CreateGovernanceAliasRequest extends AbstractModel {
    ...
    */
    ...
    public CreateGovernanceAliasRequest() {
    }
     ...
     */
    public CreateGovernanceAliasRequest(CreateGovernanceAliasRequest source) {
