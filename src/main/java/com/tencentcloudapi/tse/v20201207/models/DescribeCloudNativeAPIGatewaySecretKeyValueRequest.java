...
public class DescribeCloudNativeAPIGatewaySecretKeyValueRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeCloudNativeAPIGatewaySecretKeyValueRequest(DescribeCloudNativeAPIGatewaySecretKeyValueRequest source) {
