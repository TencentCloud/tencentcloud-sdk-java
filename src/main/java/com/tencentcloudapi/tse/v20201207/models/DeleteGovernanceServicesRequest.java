...
public class DeleteGovernanceServicesRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteGovernanceServicesRequest() {
    }
     ...
     */
    public DeleteGovernanceServicesRequest(DeleteGovernanceServicesRequest source) {
