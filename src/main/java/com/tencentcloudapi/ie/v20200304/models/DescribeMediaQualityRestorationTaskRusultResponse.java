...
public class DescribeMediaQualityRestorationTaskRusultResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setTaskResult(MediaQualityRestorationTaskResult TaskResult) {
     ...
     */
    public DescribeMediaQualityRestorationTaskRusultResponse(DescribeMediaQualityRestorationTaskRusultResponse source) {
        if (source.TaskResult != null) {
            this.TaskResult = new MediaQualityRestorationTaskResult(source.TaskResult);
        }
