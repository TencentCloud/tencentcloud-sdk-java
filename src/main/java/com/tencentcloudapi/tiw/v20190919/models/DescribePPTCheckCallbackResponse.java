...
public class DescribePPTCheckCallbackResponse extends AbstractModel{
    ...
    */
    ...
    public DescribePPTCheckCallbackResponse() {
    }
     ...
     */
    public DescribePPTCheckCallbackResponse(DescribePPTCheckCallbackResponse source) {
