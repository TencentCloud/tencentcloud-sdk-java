...
public class DescribeWarningCallbackResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 告警事件回调地址，如果未设置回调地址，该字段为空字符串 
    ...
    /**
     * Set 告警事件回调地址，如果未设置回调地址，该字段为空字符串
    ...
    public DescribeWarningCallbackResponse() {
    }
     ...
     */
    public DescribeWarningCallbackResponse(DescribeWarningCallbackResponse source) {
