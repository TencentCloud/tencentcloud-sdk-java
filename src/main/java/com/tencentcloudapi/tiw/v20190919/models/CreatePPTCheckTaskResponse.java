...
public class CreatePPTCheckTaskResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 检测任务的唯一标识Id，用于查询该任务的进度以及检测结果 
    ...
    /**
     * Set 检测任务的唯一标识Id，用于查询该任务的进度以及检测结果
    ...
    public CreatePPTCheckTaskResponse() {
    }
     ...
     */
    public CreatePPTCheckTaskResponse(CreatePPTCheckTaskResponse source) {
