...
public class GetVRSVoiceTypesResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private VoiceTypeListData Data;
    ...
    */
    ...
    public GetVRSVoiceTypesResponse() {
    }
     ...
     */
    public GetVRSVoiceTypesResponse(GetVRSVoiceTypesResponse source) {
        if (source.Data != null) {
            this.Data = new VoiceTypeListData(source.Data);
        }
