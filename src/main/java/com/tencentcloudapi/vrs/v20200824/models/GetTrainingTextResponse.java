...
public class GetTrainingTextResponse extends AbstractModel{
    ...
    */
    ...
    public GetTrainingTextResponse() {
    }
     ...
     */
    public GetTrainingTextResponse(GetTrainingTextResponse source) {
        if (source.Data != null) {
            this.Data = new TrainingTexts(source.Data);
        }
