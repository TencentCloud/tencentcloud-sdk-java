...
public class DescribeVRSTaskStatusResponse extends AbstractModel{
    ...
    */
    @SerializedName("Data")
    @Expose
    private DescribeVRSTaskStatusRespData Data;
    ...
    */
    ...
    public DescribeVRSTaskStatusResponse() {
    }
     ...
     */
    public DescribeVRSTaskStatusResponse(DescribeVRSTaskStatusResponse source) {
        if (source.Data != null) {
            this.Data = new DescribeVRSTaskStatusRespData(source.Data);
        }
