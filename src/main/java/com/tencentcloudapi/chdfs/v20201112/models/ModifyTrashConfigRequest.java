...
public class ModifyTrashConfigRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyTrashConfigRequest() {
    }
     ...
     */
    public ModifyTrashConfigRequest(ModifyTrashConfigRequest source) {
