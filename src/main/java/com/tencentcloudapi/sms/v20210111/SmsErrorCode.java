...
public enum SmsErrorCode {
    ...
    // SignPurpose 字段校验错误，请参照 API 接口说明中对改字段的说明，如有需要请联系 [sms helper](https://cloud.tencent.com/document/product/382/3773#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81)。
    ...
    // 群发请求里既有国内手机号也有国际手机号。请排查是否存在（1）使用国内签名或模板却发送国际手机号；（2）使用国际签名或模板却发送国内手机号；
