...
public class AuthorizedTransferRequest extends AbstractModel{
    ...
    */
    ...
    public AuthorizedTransferRequest() {
    }
     ...
     */
    public AuthorizedTransferRequest(AuthorizedTransferRequest source) {
