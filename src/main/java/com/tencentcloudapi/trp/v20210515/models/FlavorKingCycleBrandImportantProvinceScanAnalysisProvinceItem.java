...
public class FlavorKingCycleBrandImportantProvinceScanAnalysisProvinceItem extends AbstractModel {
    ...
    */
    ...
    @Expose
    private FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem [] Cities;
    ...
    */
     ...
     */
    public FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem [] getCities() {
        return this.Cities;
    }
     ...
     */
    public void setCities(FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem [] Cities) {
        this.Cities = Cities;
    }
    ...
    public FlavorKingCycleBrandImportantProvinceScanAnalysisProvinceItem() {
    }
     ...
     */
    public FlavorKingCycleBrandImportantProvinceScanAnalysisProvinceItem(FlavorKingCycleBrandImportantProvinceScanAnalysisProvinceItem source) {
        ...
        if (source.Cities != null) {
            this.Cities = new FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem[source.Cities.length];
            for (int i = 0; i < source.Cities.length; i++) {
                this.Cities[i] = new FlavorKingCycleBrandImportantProvinceScanAnalysisCityItem(source.Cities[i]);
            }
        }
