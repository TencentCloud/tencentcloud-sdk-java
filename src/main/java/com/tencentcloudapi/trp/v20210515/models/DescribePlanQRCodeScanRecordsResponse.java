...
public class DescribePlanQRCodeScanRecordsResponse extends AbstractModel {
    ...
    */
     ...
     * @param Data 数据
     */
    public void setData(PlanQRCodeRecord [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribePlanQRCodeScanRecordsResponse(DescribePlanQRCodeScanRecordsResponse source) {
        if (source.Ret != null) {
        ...
        if (source.Data != null) {
            this.Data = new PlanQRCodeRecord[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new PlanQRCodeRecord(source.Data[i]);
            }
        }
