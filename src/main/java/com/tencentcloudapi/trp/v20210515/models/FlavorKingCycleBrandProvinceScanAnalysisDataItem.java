...
public class FlavorKingCycleBrandProvinceScanAnalysisDataItem extends AbstractModel {
    ...
    * <p>上周期其他品牌市场份额</p>
    */
    @SerializedName("OtherLastCycleMarketShare")
    @Expose
    private Float OtherLastCycleMarketShare;
    ...
    */
    ...
    /**
     * Get <p>上周期其他品牌市场份额</p> 
     * @return OtherLastCycleMarketShare <p>上周期其他品牌市场份额</p>
     */
    public Float getOtherLastCycleMarketShare() {
        return this.OtherLastCycleMarketShare;
    }
     ...
     */
    public void setOtherLastCycleMarketShare(Float OtherLastCycleMarketShare) {
        this.OtherLastCycleMarketShare = OtherLastCycleMarketShare;
    }
    ...
    /**
     * Get <p>其他平台环比</p> 
     * @return OtherGrowRatio <p>其他平台环比</p>
     */
    ...
    public FlavorKingCycleBrandProvinceScanAnalysisDataItem() {
    }
     ...
     */
    public FlavorKingCycleBrandProvinceScanAnalysisDataItem(FlavorKingCycleBrandProvinceScanAnalysisDataItem source) {
        ...
        if (source.OtherLastCycleMarketShare != null) {
            this.OtherLastCycleMarketShare = new Float(source.OtherLastCycleMarketShare);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "OtherLastCycleMarketShare", this.OtherLastCycleMarketShare);
