...
public class DescribeCustomRuleByIdResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeCustomRuleByIdResponse() {
    }
     ...
     */
    public DescribeCustomRuleByIdResponse(DescribeCustomRuleByIdResponse source) {
        if (source.CustomRule != null) {
            this.CustomRule = new CustomRule(source.CustomRule);
        }
