...
public class DescribeDbauditInstancesRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDbauditInstancesRequest() {
    }
     ...
     */
    public DescribeDbauditInstancesRequest(DescribeDbauditInstancesRequest source) {
        if (source.SearchRegion != null) {
            this.SearchRegion = new String(source.SearchRegion);
        }
