...
public class CreateTtsTaskResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setData(CreateTtsTaskRespData Data) {
        this.Data = Data;
    }
     ...
     */
    public CreateTtsTaskResponse(CreateTtsTaskResponse source) {
        if (source.Data != null) {
            this.Data = new CreateTtsTaskRespData(source.Data);
        }
