...
public class DescribeApplicationListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private ApplicationList Result;
    ...
    */
     ...
     * @return Result 应用列表
     */
    public ApplicationList getResult() {
        return this.Result;
    }
     ...
     * @param Result 应用列表
     */
    public void setResult(ApplicationList Result) {
        this.Result = Result;
    }
    ...
    public DescribeApplicationListResponse(DescribeApplicationListResponse source) {
        if (source.Result != null) {
            this.Result = new ApplicationList(source.Result);
        }
