...
public class DeviceTagRes extends AbstractModel {
    ...
    */
     ...
     * @param Set 设备标签列表
     */
    public void setSet(DeviceTagInfo [] Set) {
        this.Set = Set;
    }
     ...
     */
    public DeviceTagRes(DeviceTagRes source) {
        ...
        if (source.Set != null) {
            this.Set = new DeviceTagInfo[source.Set.length];
            for (int i = 0; i < source.Set.length; i++) {
                this.Set[i] = new DeviceTagInfo(source.Set[i]);
            }
        }
    }
