...
public class ReportAppMessageRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get 属性定义 - KV的json格式,有效字段为x-json:后的字段 
    ...
    /**
     * Set 属性定义 - KV的json格式,有效字段为x-json:后的字段
    ...
    /**
     * Get 事件定义 - KKV的json格式,有效字段为x-json:后的字段 
    ...
    /**
     * Set 事件定义 - KKV的json格式,有效字段为x-json:后的字段
    ...
    /**
     * Get 服务定义 - KKV的json格式,有效字段为x-json:后的字段 
    ...
    /**
     * Set 服务定义 - KKV的json格式,有效字段为x-json:后的字段
    ...
    /**
     * Get 扩展字段2，如：算法上报id，若为json格式，需传x-json:{}，有效字段为x-json:后的字段 
    ...
    /**
     * Set 扩展字段2，如：算法上报id，若为json格式，需传x-json:{}，有效字段为x-json:后的字段
    ...
    /**
     * Get 透传信息，若为json格式，需传x-json:{}，有效字段为x-json:后的字段 
    ...
    /**
     * Set 透传信息，若为json格式，需传x-json:{}，有效字段为x-json:后的字段
     ...
     */
    public ReportAppMessageRequest(ReportAppMessageRequest source) {
