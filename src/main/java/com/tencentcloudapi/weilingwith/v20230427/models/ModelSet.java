...
public class ModelSet extends AbstractModel {
...
注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setSet(ModelInfo [] Set) {
        this.Set = Set;
    }
     ...
     */
    public ModelSet(ModelSet source) {
        ...
        if (source.Set != null) {
            this.Set = new ModelInfo[source.Set.length];
            for (int i = 0; i < source.Set.length; i++) {
                this.Set[i] = new ModelInfo(source.Set[i]);
            }
        }
    }
