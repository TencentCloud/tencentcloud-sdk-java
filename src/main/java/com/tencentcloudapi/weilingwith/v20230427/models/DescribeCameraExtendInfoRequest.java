...
public class DescribeCameraExtendInfoRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCameraExtendInfoRequest() {
    }
     ...
     */
    public DescribeCameraExtendInfoRequest(DescribeCameraExtendInfoRequest source) {
        if (source.WID != null) {
