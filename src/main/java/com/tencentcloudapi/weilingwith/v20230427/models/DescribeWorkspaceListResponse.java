...
public class DescribeWorkspaceListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private WorkspaceInfoList Result;
    ...
    */
     ...
     */
    public WorkspaceInfoList getResult() {
        return this.Result;
    }
     ...
     * @param Result 项目空间列表
     */
    public void setResult(WorkspaceInfoList Result) {
        this.Result = Result;
    }
    ...
    public DescribeWorkspaceListResponse(DescribeWorkspaceListResponse source) {
        if (source.Result != null) {
            this.Result = new WorkspaceInfoList(source.Result);
        }
