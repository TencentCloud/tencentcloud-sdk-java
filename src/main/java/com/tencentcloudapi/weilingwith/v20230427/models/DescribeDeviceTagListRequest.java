...
public class DescribeDeviceTagListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDeviceTagListRequest() {
    }
     ...
     */
    public DescribeDeviceTagListRequest(DescribeDeviceTagListRequest source) {
