...
public class DescribeReduceFaceJobResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeReduceFaceJobResponse() {
    }
     ...
     */
    public DescribeReduceFaceJobResponse(DescribeReduceFaceJobResponse source) {
