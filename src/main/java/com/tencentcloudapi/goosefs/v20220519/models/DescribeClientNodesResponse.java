...
public class DescribeClientNodesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setClientNodes(ClientNodeAttribute [] ClientNodes) {
     ...
     */
    public DescribeClientNodesResponse(DescribeClientNodesResponse source) {
        if (source.ClientNodes != null) {
            this.ClientNodes = new ClientNodeAttribute[source.ClientNodes.length];
            for (int i = 0; i < source.ClientNodes.length; i++) {
                this.ClientNodes[i] = new ClientNodeAttribute(source.ClientNodes[i]);
            }
        }
