...
public class DescribeFileSystemBucketsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setBucketList(MappedBucket [] BucketList) {
     ...
     */
    public DescribeFileSystemBucketsResponse(DescribeFileSystemBucketsResponse source) {
        if (source.BucketList != null) {
            this.BucketList = new MappedBucket[source.BucketList.length];
            for (int i = 0; i < source.BucketList.length; i++) {
                this.BucketList[i] = new MappedBucket(source.BucketList[i]);
            }
        }
