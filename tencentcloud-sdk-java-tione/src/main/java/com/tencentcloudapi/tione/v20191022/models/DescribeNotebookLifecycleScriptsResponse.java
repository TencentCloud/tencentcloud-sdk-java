...
public class DescribeNotebookLifecycleScriptsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Set Notebook生命周期脚本列表
     * @param NotebookLifecycleScriptsSet Notebook生命周期脚本列表
     */
    public void setNotebookLifecycleScriptsSet(NotebookLifecycleScriptsSummary [] NotebookLifecycleScriptsSet) {
        this.NotebookLifecycleScriptsSet = NotebookLifecycleScriptsSet;
    }

    /**
     * Get Notebook生命周期脚本总数量 
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "NotebookLifecycleScriptsSet.", this.NotebookLifecycleScriptsSet);
